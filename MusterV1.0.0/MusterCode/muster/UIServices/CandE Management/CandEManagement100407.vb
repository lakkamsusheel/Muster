...
#Region "UI Support Routines"
    ...
    Private Sub PopulateInspections()
        Try
            ugInspections.DataSource = pFCE.GetInspections
    ...
    Private Sub PopulateEnforcements()
        Try
            ...
            ugEnforcement.DataSource = pOCE.GetEnforcements(0, False)
...
#End If
            ...
            e.Layout.Bands(2).Columns("CCAT").Hidden = True
            ...
            e.Layout.Bands(3).Columns("CCAT").Hidden = True
