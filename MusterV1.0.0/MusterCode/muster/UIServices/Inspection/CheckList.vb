...
'Imports pp = Microsoft.Office.Interop.PowerPoint
Imports pp = PowerPoint
...
#Region "User Defined Variables"
    Private commentDataSet As DataSet = Nothing
    Private WithEvents oInspection As MUSTER.BusinessLogic.pInspection
    Private WithEvents uploadMaster As FacPicFileUpload
    Private WithEvents removeFileButton As FileRemovalButton


    Private WithEvents AddressForm As Address
    Private WithEvents controlCapEntry As CapEntry
    Private WithEvents oTank As MUSTER.BusinessLogic.pTank
    Private WithEvents oPipe As MUSTER.BusinessLogic.pPipe
    Private WithEvents oSketch As MUSTER.BusinessLogic.pInspectionSketch
    ...
    Private bolOwnerIsDesignatedOperator As Boolean = True
    Private bolCapDirty As Boolean = False
    ...
    Friend WithEvents ugOther As Infragistics.Win.UltraWinGrid.UltraGrid
...
#Region "Windows Form Designer generated code "
    ...
    Public Sub New(ByRef oInspec As MUSTER.BusinessLogic.pInspection, Optional ByVal [readOnly] As Boolean = False, Optional ByVal print As Boolean = False, Optional ByVal fromModule As Integer = UIUtilsGen.ModuleID.Inspection)
        ...
        PnlCapValues.Dock = DockStyle.Fill
        ...
        'PIC_PATH = "C:\Users\yaga\Desktop\New folder\FAC PICS- 25NOV\FacPics"
        commentDataSet = pcom.GetComments(, 6, oInspection.FacilityID)
        pcom = Nothing

        _container.pOwn.Retrieve(oInspection.OwnerID, "ALL")

        LoadContacts(ugContacts, oInspection.FacilityID, 6)

        oInspection.Retrieve(oInspection.ID)

        oInspection.RetrieveCheckListInfo(Convert.ToInt32(oInspection.ID), oInspection.FacilityID, oInspection.OwnerID, [readOnly], Me.bolOwnerIsDesignatedOperator, PIC_PATH)

        txtAddress.Tag = oInspection.CheckListMaster.Owner.Facilities.AddressID
        If oInspection.CheckListMaster.AllowsDBCheckListCode Then
            Me.Text = IIf([readOnly], "View", "Edit").ToString + " Fast CheckList for Facility : " + oInspection.CheckListMaster.Owner.Facilities.Name + " (" + oInspection.CheckListMaster.Owner.Facilities.ID.ToString + ")"
        Else
            Me.Text = IIf([readOnly], "View", "Edit").ToString + " Classic CheckList for Facility : " + oInspection.CheckListMaster.Owner.Facilities.Name + " (" + oInspection.CheckListMaster.Owner.Facilities.ID.ToString + ")"
        End If
        ...
        _container.pOwn = oInspection.CheckListMaster.Owner
    ...
    Friend WithEvents txtDesOp As System.Windows.Forms.TextBox
    ...
    Friend WithEvents PnlPics As System.Windows.Forms.Panel
    Friend WithEvents Panel6 As System.Windows.Forms.Panel
    Friend WithEvents Panel8 As System.Windows.Forms.Panel
    Friend WithEvents lblSketch As System.Windows.Forms.Label
    Friend WithEvents pctSketchPad As System.Windows.Forms.PictureBox
    Friend WithEvents btnSavePic As System.Windows.Forms.Button
    Friend WithEvents Panel16 As System.Windows.Forms.Panel
    Friend WithEvents Label5 As System.Windows.Forms.Label
    Friend WithEvents PnlCapValues As System.Windows.Forms.Panel
    Friend WithEvents BtnCapView As System.Windows.Forms.Button
    Friend WithEvents pnlCapEntryView As System.Windows.Forms.Panel
    Friend WithEvents BtnFacpics As System.Windows.Forms.Button
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim UltraDataColumn25 As Infragistics.Win.UltraWinDataSource.UltraDataColumn = New Infragistics.Win.UltraWinDataSource.UltraDataColumn("CL_POSITION")
        Dim UltraDataColumn26 As Infragistics.Win.UltraWinDataSource.UltraDataColumn = New Infragistics.Win.UltraWinDataSource.UltraDataColumn("Line#")
        Dim UltraDataColumn27 As Infragistics.Win.UltraWinDataSource.UltraDataColumn = New Infragistics.Win.UltraWinDataSource.UltraDataColumn("Question")
        Dim UltraDataColumn28 As Infragistics.Win.UltraWinDataSource.UltraDataColumn = New Infragistics.Win.UltraWinDataSource.UltraDataColumn("Citation")
        Dim UltraDataColumn29 As Infragistics.Win.UltraWinDataSource.UltraDataColumn = New Infragistics.Win.UltraWinDataSource.UltraDataColumn("CCAT")
        Dim UltraDataColumn30 As Infragistics.Win.UltraWinDataSource.UltraDataColumn = New Infragistics.Win.UltraWinDataSource.UltraDataColumn("Yes")
        Dim UltraDataColumn31 As Infragistics.Win.UltraWinDataSource.UltraDataColumn = New Infragistics.Win.UltraWinDataSource.UltraDataColumn("N/A")
        Dim UltraDataColumn32 As Infragistics.Win.UltraWinDataSource.UltraDataColumn = New Infragistics.Win.UltraWinDataSource.UltraDataColumn("No")
        ...
        Dim UltraDataColumn34 As Infragistics.Win.UltraWinDataSource.UltraDataColumn = New Infragistics.Win.UltraWinDataSource.UltraDataColumn("INSPECTION_ID")
        Dim UltraDataColumn35 As Infragistics.Win.UltraWinDataSource.UltraDataColumn = New Infragistics.Win.UltraWinDataSource.UltraDataColumn("QUESTION_ID")
        Dim UltraDataColumn36 As Infragistics.Win.UltraWinDataSource.UltraDataColumn = New Infragistics.Win.UltraWinDataSource.UltraDataColumn("SOC")
        Dim UltraDataColumn37 As Infragistics.Win.UltraWinDataSource.UltraDataColumn = New Infragistics.Win.UltraWinDataSource.UltraDataColumn("RESPONSE")
        Dim UltraDataColumn38 As Infragistics.Win.UltraWinDataSource.UltraDataColumn = New Infragistics.Win.UltraWinDataSource.UltraDataColumn("HEADER")
        ...
        Dim UltraDataColumn40 As Infragistics.Win.UltraWinDataSource.UltraDataColumn = New Infragistics.Win.UltraWinDataSource.UltraDataColumn("Citations")
        Dim UltraDataColumn41 As Infragistics.Win.UltraWinDataSource.UltraDataColumn = New Infragistics.Win.UltraWinDataSource.UltraDataColumn("FSOC_LK_PREVENT")
        Dim UltraDataColumn42 As Infragistics.Win.UltraWinDataSource.UltraDataColumn = New Infragistics.Win.UltraWinDataSource.UltraDataColumn("FSOC_LK_PRE_CITATION")
        Dim UltraDataColumn43 As Infragistics.Win.UltraWinDataSource.UltraDataColumn = New Infragistics.Win.UltraWinDataSource.UltraDataColumn("FAC_SOC_LK_DETECTION")
        Dim UltraDataColumn44 As Infragistics.Win.UltraWinDataSource.UltraDataColumn = New Infragistics.Win.UltraWinDataSource.UltraDataColumn("FSOC_LK_DET_CITATION")
        Dim UltraDataColumn45 As Infragistics.Win.UltraWinDataSource.UltraDataColumn = New Infragistics.Win.UltraWinDataSource.UltraDataColumn("FSOC_LK_PRE_LK_DET")
        Dim UltraDataColumn46 As Infragistics.Win.UltraWinDataSource.UltraDataColumn = New Infragistics.Win.UltraWinDataSource.UltraDataColumn("Line Numbers")
        Dim UltraDataColumn47 As Infragistics.Win.UltraWinDataSource.UltraDataColumn = New Infragistics.Win.UltraWinDataSource.UltraDataColumn("FORE_COLOR")
        Dim UltraDataColumn48 As Infragistics.Win.UltraWinDataSource.UltraDataColumn = New Infragistics.Win.UltraWinDataSource.UltraDataColumn("BACK_COLOR")
        ...
        Me.ugOther = New Infragistics.Win.UltraWinGrid.UltraGrid()
        ...
        Me.BtnFacpics = New System.Windows.Forms.Button()
        Me.BtnCapView = New System.Windows.Forms.Button()
        ...
        Me.PnlCapValues = New System.Windows.Forms.Panel()
        Me.pnlCapEntryView = New System.Windows.Forms.Panel()
        Me.Panel16 = New System.Windows.Forms.Panel()
        Me.Label5 = New System.Windows.Forms.Label()
        Me.PnlSketch = New System.Windows.Forms.Panel()
        Me.Panel8 = New System.Windows.Forms.Panel()
        Me.lblSketch = New System.Windows.Forms.Label()
        Me.pctSketchPad = New System.Windows.Forms.PictureBox()
        ...
        CType(Me.ugOther, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.PnlCapValues.SuspendLayout()
        Me.Panel16.SuspendLayout()
        Me.PnlSketch.SuspendLayout()
        Me.Panel8.SuspendLayout()
        CType(Me.pctSketchPad, System.ComponentModel.ISupportInitialize).BeginInit()
        Me.pctSketchPad.SuspendLayout()
        ...
        Me.btnIndvLicFlag.UseVisualStyleBackColor = False
        ...
        Me.btnInsFlag.UseVisualStyleBackColor = False
        ...
        Me.btnCandEFlag.UseVisualStyleBackColor = False
        ...
        Me.btnFinFlag.UseVisualStyleBackColor = False
        ...
        Me.btnLUSFlag.UseVisualStyleBackColor = False
        ...
        Me.btnFirmLicFlag.UseVisualStyleBackColor = False
        ...
        Me.btnCloFlag.UseVisualStyleBackColor = False
        ...
        Me.btnFeeFlag.UseVisualStyleBackColor = False
        ...
        Me.btnFacFlag.UseVisualStyleBackColor = False
        ...
        Me.btnOwnerFlag.UseVisualStyleBackColor = False
        ...
        Me.btnUnsubmit.Size = New System.Drawing.Size(75, 23)
        ...
        Me.btnFlags.Size = New System.Drawing.Size(75, 23)
        ...
        Me.ugOther.DisplayLayout.Appearance = Appearance1
        Me.ugOther.DisplayLayout.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugOther.DisplayLayout.CaptionVisible = Infragistics.Win.DefaultableBoolean.[False]
        Appearance2.BackColor = System.Drawing.SystemColors.ActiveBorder
        Appearance2.BackColor2 = System.Drawing.SystemColors.ControlDark
        Appearance2.BackGradientStyle = Infragistics.Win.GradientStyle.Vertical
        Appearance2.BorderColor = System.Drawing.SystemColors.Window
        Me.ugOther.DisplayLayout.GroupByBox.Appearance = Appearance2
        Appearance3.ForeColor = System.Drawing.SystemColors.GrayText
        Me.ugOther.DisplayLayout.GroupByBox.BandLabelAppearance = Appearance3
        Me.ugOther.DisplayLayout.GroupByBox.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugOther.DisplayLayout.GroupByBox.Hidden = True
        Appearance4.BackColor = System.Drawing.SystemColors.ControlLightLight
        Appearance4.BackColor2 = System.Drawing.SystemColors.Control
        Appearance4.BackGradientStyle = Infragistics.Win.GradientStyle.Horizontal
        Appearance4.ForeColor = System.Drawing.SystemColors.GrayText
        Me.ugOther.DisplayLayout.GroupByBox.PromptAppearance = Appearance4
        Me.ugOther.DisplayLayout.MaxColScrollRegions = 1
        Me.ugOther.DisplayLayout.MaxRowScrollRegions = 1
        Appearance5.BackColor = System.Drawing.SystemColors.Window
        Appearance5.ForeColor = System.Drawing.SystemColors.ControlText
        Me.ugOther.DisplayLayout.Override.ActiveCellAppearance = Appearance5
        'Appearance6.BackColor = System.Drawing.SystemColors.Highlight
        'Appearance6.ForeColor = System.Drawing.SystemColors.HighlightText
        'Me.ugOther.DisplayLayout.Override.ActiveRowAppearance = Appearance6
        Me.ugOther.DisplayLayout.Override.BorderStyleCell = Infragistics.Win.UIElementBorderStyle.Dotted
        Me.ugOther.DisplayLayout.Override.BorderStyleRow = Infragistics.Win.UIElementBorderStyle.Dotted
        Appearance7.BackColor = System.Drawing.SystemColors.Window
        Me.ugOther.DisplayLayout.Override.CardAreaAppearance = Appearance7
        Appearance8.BorderColor = System.Drawing.Color.Silver
        Appearance8.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter
        Me.ugOther.DisplayLayout.Override.CellAppearance = Appearance8
        Me.ugOther.DisplayLayout.Override.CellClickAction = Infragistics.Win.UltraWinGrid.CellClickAction.EditAndSelectText
        Me.ugOther.DisplayLayout.Override.CellPadding = 0
        Appearance9.BackColor = System.Drawing.SystemColors.Control
        Appearance9.BackColor2 = System.Drawing.SystemColors.ControlDark
        Appearance9.BackGradientAlignment = Infragistics.Win.GradientAlignment.Element
        Appearance9.BackGradientStyle = Infragistics.Win.GradientStyle.Horizontal
        Appearance9.BorderColor = System.Drawing.SystemColors.Window
        Me.ugOther.DisplayLayout.Override.GroupByRowAppearance = Appearance9
        Appearance10.TextHAlignAsString = "Left"
        Me.ugOther.DisplayLayout.Override.HeaderAppearance = Appearance10
        Me.ugOther.DisplayLayout.Override.HeaderClickAction = Infragistics.Win.UltraWinGrid.HeaderClickAction.SortMulti
        Me.ugOther.DisplayLayout.Override.HeaderStyle = Infragistics.Win.HeaderStyle.WindowsXPCommand
        Appearance11.BackColor = System.Drawing.SystemColors.Window
        Appearance11.BorderColor = System.Drawing.Color.Silver
        Me.ugOther.DisplayLayout.Override.RowAppearance = Appearance11
        Me.ugOther.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.[False]
        Appearance12.BackColor = System.Drawing.SystemColors.ControlLight
        Me.ugOther.DisplayLayout.Override.TemplateAddRowAppearance = Appearance12
        Me.ugOther.DisplayLayout.ScrollBounds = Infragistics.Win.UltraWinGrid.ScrollBounds.ScrollToFill
        Me.ugOther.DisplayLayout.ScrollStyle = Infragistics.Win.UltraWinGrid.ScrollStyle.Immediate
        Me.ugOther.DisplayLayout.ViewStyleBand = Infragistics.Win.UltraWinGrid.ViewStyleBand.OutlookGroupBy
        Me.ugOther.Dock = System.Windows.Forms.DockStyle.Fill
        Me.ugOther.Location = New System.Drawing.Point(0, 0)
        Me.ugOther.Name = "ugOther"
        Me.ugOther.Size = New System.Drawing.Size(903, 1104)
        Me.ugOther.TabIndex = 52
        Me.ugOther.Text = "UltraGrid1"

        '
        'pnlChecklistControls
        '
        Me.pnlChecklistControls.BorderStyle = System.Windows.Forms.BorderStyle.Fixed3D
        Me.pnlChecklistControls.Controls.Add(Me.BtnFacpics)
        Me.pnlChecklistControls.Controls.Add(Me.BtnCapView)
        Me.pnlChecklistControls.Controls.Add(Me.btnSketch)
        Me.pnlChecklistControls.Controls.Add(Me.btnOther)
        ...
        'BtnFacpics
        '
        Me.BtnFacpics.Location = New System.Drawing.Point(0, 584)
        Me.BtnFacpics.Name = "BtnFacpics"
        Me.BtnFacpics.Size = New System.Drawing.Size(94, 32)
        Me.BtnFacpics.TabIndex = 16
        Me.BtnFacpics.Text = "13 - FAC PICS"
        '
        'BtnCapView
        '
        Me.BtnCapView.Location = New System.Drawing.Point(4, 72)
        Me.BtnCapView.Name = "BtnCapView"
        Me.BtnCapView.Size = New System.Drawing.Size(94, 32)
        Me.BtnCapView.TabIndex = 15
        Me.BtnCapView.Text = "CAPS"
        '
        'btnSketch
        '
        Me.btnSketch.Location = New System.Drawing.Point(0, 488)
        Me.btnSketch.Name = "btnSketch"
        Me.btnSketch.Size = New System.Drawing.Size(94, 32)
        Me.btnSketch.TabIndex = 14
        Me.btnSketch.Text = "10 - SKETCH"
        '
        'btnOther
        '
        Me.btnOther.Location = New System.Drawing.Point(0, 552)
        Me.btnOther.Name = "btnOther"
        Me.btnOther.Size = New System.Drawing.Size(94, 32)
        Me.btnOther.TabIndex = 13
        Me.btnOther.Text = "12 - OPER"
        '
        'btnSoc
        '
        Me.btnSoc.Location = New System.Drawing.Point(0, 520)
        Me.btnSoc.Name = "btnSoc"
        Me.btnSoc.Size = New System.Drawing.Size(94, 32)
        Me.btnSoc.TabIndex = 12
        Me.btnSoc.Text = "11 - SOC"
        '
        'btnComments
        '
        Me.btnComments.Location = New System.Drawing.Point(0, 424)
        Me.btnComments.Name = "btnComments"
        Me.btnComments.Size = New System.Drawing.Size(94, 32)
        Me.btnComments.TabIndex = 10
        Me.btnComments.Text = "8 - COMMENTS"
        '
        'btnTos
        '
        Me.btnTos.Location = New System.Drawing.Point(0, 392)
        Me.btnTos.Name = "btnTos"
        Me.btnTos.Size = New System.Drawing.Size(94, 32)
        Me.btnTos.TabIndex = 9
        Me.btnTos.Text = "7 - TOS"
        '
        'btnVisual
        '
        Me.btnVisual.Location = New System.Drawing.Point(0, 360)
        Me.btnVisual.Name = "btnVisual"
        Me.btnVisual.Size = New System.Drawing.Size(94, 32)
        Me.btnVisual.TabIndex = 8
        Me.btnVisual.Text = "6 - VISUAL"
        '
        'btnCatLeak
        '
        Me.btnCatLeak.Location = New System.Drawing.Point(0, 328)
        Me.btnCatLeak.Name = "btnCatLeak"
        Me.btnCatLeak.Size = New System.Drawing.Size(94, 32)
        Me.btnCatLeak.TabIndex = 7
        Me.btnCatLeak.Text = "5.9 - CAT LEAK"
        '
        'btnPipeLeak
        '
        Me.btnPipeLeak.Location = New System.Drawing.Point(0, 296)
        Me.btnPipeLeak.Name = "btnPipeLeak"
        Me.btnPipeLeak.Size = New System.Drawing.Size(94, 32)
        Me.btnPipeLeak.TabIndex = 6
        Me.btnPipeLeak.Text = "5 - PIPE LEAK"
        '
        'btnTankLeak
        '
        Me.btnTankLeak.Location = New System.Drawing.Point(0, 264)
        Me.btnTankLeak.Name = "btnTankLeak"
        Me.btnTankLeak.Size = New System.Drawing.Size(94, 32)
        Me.btnTankLeak.TabIndex = 5
        Me.btnTankLeak.Text = "4 - TANK LEAK"
        '
        'btnCp
        '
        Me.btnCp.Location = New System.Drawing.Point(0, 232)
        Me.btnCp.Name = "btnCp"
        Me.btnCp.Size = New System.Drawing.Size(94, 32)
        Me.btnCp.TabIndex = 4
        Me.btnCp.Text = "3 - CP"
        '
        'btnSpill
        '
        Me.btnSpill.Location = New System.Drawing.Point(0, 200)
        Me.btnSpill.Name = "btnSpill"
        Me.btnSpill.Size = New System.Drawing.Size(94, 32)
        Me.btnSpill.TabIndex = 3
        Me.btnSpill.Text = "2 - SPILL"
        '
        'btnReg
        '
        Me.btnReg.Location = New System.Drawing.Point(0, 168)
        Me.btnReg.Name = "btnReg"
        Me.btnReg.Size = New System.Drawing.Size(94, 32)
        Me.btnReg.TabIndex = 2
        Me.btnReg.Text = "1 - REG"
        '
        'btnCitations
        '
        Me.btnCitations.Location = New System.Drawing.Point(0, 456)
        Me.btnCitations.Name = "btnCitations"
        Me.btnCitations.Size = New System.Drawing.Size(94, 32)
        Me.btnCitations.TabIndex = 11
        Me.btnCitations.Text = "9 - CITATIONS"
        '
        'btnMaster
        '
        Me.btnMaster.Location = New System.Drawing.Point(4, 8)
        Me.btnMaster.Name = "btnMaster"
        Me.btnMaster.Size = New System.Drawing.Size(94, 32)
        Me.btnMaster.TabIndex = 0
        Me.btnMaster.Text = "FACILITY"
        '
        'btnTanksPipes
        '
        Me.btnTanksPipes.Location = New System.Drawing.Point(4, 40)
        Me.btnTanksPipes.Name = "btnTanksPipes"
        Me.btnTanksPipes.Size = New System.Drawing.Size(94, 32)
        Me.btnTanksPipes.TabIndex = 1
        Me.btnTanksPipes.Text = "TANKS / PIPES"
        '
        'btnMW
        '
        Me.btnMW.Location = New System.Drawing.Point(0, 616)
        Me.btnMW.Name = "btnMW"
        Me.btnMW.Size = New System.Drawing.Size(94, 32)
        ...
        Me.pnlChecklistDetails.Controls.Add(Me.Panel6)
        Me.pnlChecklistDetails.Controls.Add(Me.pnlTanksPipes)
        Me.pnlChecklistDetails.Controls.Add(Me.PnlCapValues)
        Me.pnlChecklistDetails.Controls.Add(Me.PnlSketch)
        Me.pnlChecklistDetails.Controls.Add(Me.pnlMaster)
        Me.pnlChecklistDetails.Controls.Add(Me.PnlPics)
        Me.pnlChecklistDetails.BringToFront()
        ...
        'Panel6
        '
        Me.Panel6.Controls.Add(Me.PnlOther)
        Me.Panel6.Controls.Add(Me.pnlMW)
        Me.Panel6.Controls.Add(Me.pnlComments)
        Me.Panel6.Controls.Add(Me.pnlInspectionCitations)
        Me.Panel6.Controls.Add(Me.pnlTOS)
        Me.Panel6.Controls.Add(Me.pnlVisual)
        Me.Panel6.Controls.Add(Me.pnlCatLeak)
        Me.Panel6.Controls.Add(Me.pnlPipeLeak)
        Me.Panel6.Controls.Add(Me.pnlTankLeak)
        Me.Panel6.Controls.Add(Me.pnlCP)
        Me.Panel6.Controls.Add(Me.pnlReg)
        Me.Panel6.Controls.Add(Me.pnlSpill)
        Me.Panel6.Controls.Add(Me.pnlSOC)
        Me.Panel6.Dock = System.Windows.Forms.DockStyle.Fill
        Me.Panel6.Location = New System.Drawing.Point(0, 0)
        Me.Panel6.Name = "Panel6"
        Me.Panel6.Size = New System.Drawing.Size(903, 1128)
        Me.Panel6.TabIndex = 48
        '
        'PnlOther
        '
        Me.PnlOther.Controls.Add(Me.Panel5)
        Me.PnlOther.Controls.Add(Me.Panel7)
        Me.PnlOther.Dock = System.Windows.Forms.DockStyle.Fill
        Me.PnlOther.Location = New System.Drawing.Point(0, 0)
        Me.PnlOther.Name = "PnlOther"
        Me.PnlOther.Size = New System.Drawing.Size(903, 1128)
        Me.PnlOther.TabIndex = 14
        '
        'Panel5
        '
        Me.Panel5.Controls.Add(Me.ugOther)
        Me.Panel5.Dock = System.Windows.Forms.DockStyle.Fill
        Me.Panel5.Location = New System.Drawing.Point(0, 24)
        Me.Panel5.Name = "Panel5"
        Me.Panel5.Size = New System.Drawing.Size(903, 1104)
        Me.Panel5.TabIndex = 48
        '
        'Panel7
        '
        Me.Panel7.Controls.Add(Me.lblOther)
        Me.Panel7.Dock = System.Windows.Forms.DockStyle.Top
        Me.Panel7.Location = New System.Drawing.Point(0, 0)
        Me.Panel7.Name = "Panel7"
        Me.Panel7.Size = New System.Drawing.Size(903, 24)
        Me.Panel7.TabIndex = 43
        '
        'lblOther
        '
        Me.lblOther.BackColor = System.Drawing.SystemColors.Highlight
        Me.lblOther.Dock = System.Windows.Forms.DockStyle.Fill
        Me.lblOther.Font = New System.Drawing.Font("Microsoft Sans Serif", 10.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.lblOther.ForeColor = System.Drawing.SystemColors.ActiveCaptionText
        Me.lblOther.Location = New System.Drawing.Point(0, 0)
        Me.lblOther.Name = "lblOther"
        Me.lblOther.Size = New System.Drawing.Size(903, 24)
        Me.lblOther.TabIndex = 2
        Me.lblOther.Text = "DESIGNATED OPERATOR ACKNOWLEDGEMENT CHECKLIST"
        ...
        Me.pnlMW.Dock = System.Windows.Forms.DockStyle.Fill
        Me.pnlMW.Location = New System.Drawing.Point(0, 0)
        Me.pnlMW.Name = "pnlMW"
        Me.pnlMW.Size = New System.Drawing.Size(903, 1128)
        ...
        Me.ugMW.DisplayLayout.Appearance = Appearance13
        Me.ugMW.DisplayLayout.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugMW.DisplayLayout.CaptionVisible = Infragistics.Win.DefaultableBoolean.[False]
        Appearance14.BackColor = System.Drawing.SystemColors.ActiveBorder
        Appearance14.BackColor2 = System.Drawing.SystemColors.ControlDark
        Appearance14.BackGradientStyle = Infragistics.Win.GradientStyle.Vertical
        Appearance14.BorderColor = System.Drawing.SystemColors.Window
        Me.ugMW.DisplayLayout.GroupByBox.Appearance = Appearance14
        Appearance15.ForeColor = System.Drawing.SystemColors.GrayText
        Me.ugMW.DisplayLayout.GroupByBox.BandLabelAppearance = Appearance15
        Me.ugMW.DisplayLayout.GroupByBox.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugMW.DisplayLayout.GroupByBox.Hidden = True
        Appearance16.BackColor = System.Drawing.SystemColors.ControlLightLight
        Appearance16.BackColor2 = System.Drawing.SystemColors.Control
        Appearance16.BackGradientStyle = Infragistics.Win.GradientStyle.Horizontal
        Appearance16.ForeColor = System.Drawing.SystemColors.GrayText
        Me.ugMW.DisplayLayout.GroupByBox.PromptAppearance = Appearance16
        Me.ugMW.DisplayLayout.MaxColScrollRegions = 1
        Me.ugMW.DisplayLayout.MaxRowScrollRegions = 1
        Appearance17.BackColor = System.Drawing.SystemColors.Window
        Appearance17.ForeColor = System.Drawing.SystemColors.ControlText
        Me.ugMW.DisplayLayout.Override.ActiveCellAppearance = Appearance17
        'Appearance18.BackColor = System.Drawing.SystemColors.Highlight
        'Appearance18.ForeColor = System.Drawing.SystemColors.HighlightText
        'Me.ugMW.DisplayLayout.Override.ActiveRowAppearance = Appearance18
        Me.ugMW.DisplayLayout.Override.BorderStyleCell = Infragistics.Win.UIElementBorderStyle.Dotted
        Me.ugMW.DisplayLayout.Override.BorderStyleRow = Infragistics.Win.UIElementBorderStyle.Dotted
        Appearance19.BackColor = System.Drawing.SystemColors.Window
        Me.ugMW.DisplayLayout.Override.CardAreaAppearance = Appearance19
        Appearance20.BorderColor = System.Drawing.Color.Silver
        Appearance20.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter
        Me.ugMW.DisplayLayout.Override.CellAppearance = Appearance20
        Me.ugMW.DisplayLayout.Override.CellClickAction = Infragistics.Win.UltraWinGrid.CellClickAction.EditAndSelectText
        Me.ugMW.DisplayLayout.Override.CellPadding = 0
        Appearance21.BackColor = System.Drawing.SystemColors.Control
        Appearance21.BackColor2 = System.Drawing.SystemColors.ControlDark
        Appearance21.BackGradientAlignment = Infragistics.Win.GradientAlignment.Element
        Appearance21.BackGradientStyle = Infragistics.Win.GradientStyle.Horizontal
        Appearance21.BorderColor = System.Drawing.SystemColors.Window
        Me.ugMW.DisplayLayout.Override.GroupByRowAppearance = Appearance21
        Appearance22.TextHAlignAsString = "Left"
        Me.ugMW.DisplayLayout.Override.HeaderAppearance = Appearance22
        Me.ugMW.DisplayLayout.Override.HeaderClickAction = Infragistics.Win.UltraWinGrid.HeaderClickAction.SortMulti
        Me.ugMW.DisplayLayout.Override.HeaderStyle = Infragistics.Win.HeaderStyle.WindowsXPCommand
        Appearance23.BackColor = System.Drawing.SystemColors.Window
        Appearance23.BorderColor = System.Drawing.Color.Silver
        Me.ugMW.DisplayLayout.Override.RowAppearance = Appearance23
        Me.ugMW.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.[False]
        Appearance24.BackColor = System.Drawing.SystemColors.ControlLight
        Me.ugMW.DisplayLayout.Override.TemplateAddRowAppearance = Appearance24
        Me.ugMW.DisplayLayout.ScrollBounds = Infragistics.Win.UltraWinGrid.ScrollBounds.ScrollToFill
        Me.ugMW.DisplayLayout.ScrollStyle = Infragistics.Win.UltraWinGrid.ScrollStyle.Immediate
        Me.ugMW.DisplayLayout.ViewStyleBand = Infragistics.Win.UltraWinGrid.ViewStyleBand.OutlookGroupBy
        Me.ugMW.Dock = System.Windows.Forms.DockStyle.Fill
        Me.ugMW.Location = New System.Drawing.Point(0, 48)
        Me.ugMW.Name = "ugMW"
        Me.ugMW.Size = New System.Drawing.Size(903, 1080)
        Me.ugMW.TabIndex = 49
        Me.ugMW.Text = "UltraGrid1"
        '
        'pnlMWAdd
        '
        ...
        Me.pnlMWAdd.Size = New System.Drawing.Size(903, 24)
        ...
        Me.btnMWAdd.UseVisualStyleBackColor = False
        '
        'pnlMWDisplay
        '
        ...
        Me.pnlMWDisplay.Size = New System.Drawing.Size(903, 24)
        ...
        Me.lblMW.Name = "lblMW"
        Me.lblMW.Size = New System.Drawing.Size(903, 24)
        Me.lblMW.TabIndex = 2
        ...
        Me.pnlComments.Location = New System.Drawing.Point(16, 1405)
        ...
        Me.pnlInspectionCitations.Dock = System.Windows.Forms.DockStyle.Fill
        Me.pnlInspectionCitations.Location = New System.Drawing.Point(0, 0)
        Me.pnlInspectionCitations.Name = "pnlInspectionCitations"
        Me.pnlInspectionCitations.Size = New System.Drawing.Size(903, 1128)
        ...
        Me.ugCitation.DisplayLayout.Appearance = Appearance25
        Me.ugCitation.DisplayLayout.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugCitation.DisplayLayout.CaptionVisible = Infragistics.Win.DefaultableBoolean.[False]
        Appearance26.BackColor = System.Drawing.SystemColors.ActiveBorder
        Appearance26.BackColor2 = System.Drawing.SystemColors.ControlDark
        Appearance26.BackGradientStyle = Infragistics.Win.GradientStyle.Vertical
        Appearance26.BorderColor = System.Drawing.SystemColors.Window
        Me.ugCitation.DisplayLayout.GroupByBox.Appearance = Appearance26
        Appearance27.ForeColor = System.Drawing.SystemColors.GrayText
        Me.ugCitation.DisplayLayout.GroupByBox.BandLabelAppearance = Appearance27
        Me.ugCitation.DisplayLayout.GroupByBox.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugCitation.DisplayLayout.GroupByBox.Hidden = True
        Appearance28.BackColor = System.Drawing.SystemColors.ControlLightLight
        Appearance28.BackColor2 = System.Drawing.SystemColors.Control
        Appearance28.BackGradientStyle = Infragistics.Win.GradientStyle.Horizontal
        Appearance28.ForeColor = System.Drawing.SystemColors.GrayText
        Me.ugCitation.DisplayLayout.GroupByBox.PromptAppearance = Appearance28
        Me.ugCitation.DisplayLayout.MaxColScrollRegions = 1
        Me.ugCitation.DisplayLayout.MaxRowScrollRegions = 1
        Appearance29.BackColor = System.Drawing.SystemColors.Window
        Appearance29.ForeColor = System.Drawing.SystemColors.ControlText
        Me.ugCitation.DisplayLayout.Override.ActiveCellAppearance = Appearance29
        'Appearance30.BackColor = System.Drawing.SystemColors.Highlight
        'Appearance30.ForeColor = System.Drawing.SystemColors.HighlightText
        'Me.ugCitation.DisplayLayout.Override.ActiveRowAppearance = Appearance30
        Me.ugCitation.DisplayLayout.Override.BorderStyleCell = Infragistics.Win.UIElementBorderStyle.Dotted
        Me.ugCitation.DisplayLayout.Override.BorderStyleRow = Infragistics.Win.UIElementBorderStyle.Dotted
        Appearance31.BackColor = System.Drawing.SystemColors.Window
        Me.ugCitation.DisplayLayout.Override.CardAreaAppearance = Appearance31
        Appearance32.BorderColor = System.Drawing.Color.Silver
        Appearance32.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter
        Me.ugCitation.DisplayLayout.Override.CellAppearance = Appearance32
        Me.ugCitation.DisplayLayout.Override.CellClickAction = Infragistics.Win.UltraWinGrid.CellClickAction.EditAndSelectText
        Me.ugCitation.DisplayLayout.Override.CellPadding = 0
        Appearance33.BackColor = System.Drawing.SystemColors.Control
        Appearance33.BackColor2 = System.Drawing.SystemColors.ControlDark
        Appearance33.BackGradientAlignment = Infragistics.Win.GradientAlignment.Element
        Appearance33.BackGradientStyle = Infragistics.Win.GradientStyle.Horizontal
        Appearance33.BorderColor = System.Drawing.SystemColors.Window
        Me.ugCitation.DisplayLayout.Override.GroupByRowAppearance = Appearance33
        Appearance34.TextHAlignAsString = "Left"
        Me.ugCitation.DisplayLayout.Override.HeaderAppearance = Appearance34
        Me.ugCitation.DisplayLayout.Override.HeaderClickAction = Infragistics.Win.UltraWinGrid.HeaderClickAction.SortMulti
        Me.ugCitation.DisplayLayout.Override.HeaderStyle = Infragistics.Win.HeaderStyle.WindowsXPCommand
        Appearance35.BackColor = System.Drawing.SystemColors.Window
        Appearance35.BorderColor = System.Drawing.Color.Silver
        Me.ugCitation.DisplayLayout.Override.RowAppearance = Appearance35
        Me.ugCitation.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.[False]
        Appearance36.BackColor = System.Drawing.SystemColors.ControlLight
        Me.ugCitation.DisplayLayout.Override.TemplateAddRowAppearance = Appearance36
        Me.ugCitation.DisplayLayout.ScrollBounds = Infragistics.Win.UltraWinGrid.ScrollBounds.ScrollToFill
        Me.ugCitation.DisplayLayout.ScrollStyle = Infragistics.Win.UltraWinGrid.ScrollStyle.Immediate
        Me.ugCitation.DisplayLayout.ViewStyleBand = Infragistics.Win.UltraWinGrid.ViewStyleBand.OutlookGroupBy
        Me.ugCitation.Dock = System.Windows.Forms.DockStyle.Fill
        Me.ugCitation.Location = New System.Drawing.Point(0, 24)
        Me.ugCitation.Name = "ugCitation"
        Me.ugCitation.Size = New System.Drawing.Size(903, 1104)
        Me.ugCitation.TabIndex = 47
        Me.ugCitation.Text = "UltraGrid1"
        '
        ...
        Me.pnlInspecCitationsDisplay.Size = New System.Drawing.Size(903, 24)
        ...
        Me.lblInspecCitationsDisplay.Size = New System.Drawing.Size(903, 24)
        ...
        Me.pnlTOS.Location = New System.Drawing.Point(0, 0)
        Me.pnlTOS.Name = "pnlTOS"
        Me.pnlTOS.Size = New System.Drawing.Size(903, 1128)
        ...
        Me.ugTOS.DisplayLayout.Appearance = Appearance37
        Me.ugTOS.DisplayLayout.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugTOS.DisplayLayout.CaptionVisible = Infragistics.Win.DefaultableBoolean.[False]
        Appearance38.ForeColor = System.Drawing.SystemColors.GrayText
        Me.ugTOS.DisplayLayout.GroupByBox.BandLabelAppearance = Appearance38
        Me.ugTOS.DisplayLayout.GroupByBox.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugTOS.DisplayLayout.GroupByBox.Hidden = True
        ...
        Me.ugTOS.DisplayLayout.GroupByBox.PromptAppearance = Appearance39
        Me.ugTOS.DisplayLayout.MaxColScrollRegions = 1
        Me.ugTOS.DisplayLayout.MaxRowScrollRegions = 1
        Appearance40.BackColor = System.Drawing.SystemColors.Window
        Appearance40.ForeColor = System.Drawing.SystemColors.ControlText
        Me.ugTOS.DisplayLayout.Override.ActiveCellAppearance = Appearance40
        ...
        'Me.ugTOS.DisplayLayout.Override.ActiveRowAppearance = Appearance41
        Me.ugTOS.DisplayLayout.Override.BorderStyleCell = Infragistics.Win.UIElementBorderStyle.Dotted
        Me.ugTOS.DisplayLayout.Override.BorderStyleRow = Infragistics.Win.UIElementBorderStyle.Dotted
        Appearance42.BackColor = System.Drawing.SystemColors.Window
        Me.ugTOS.DisplayLayout.Override.CardAreaAppearance = Appearance42
        ...
        Me.ugTOS.DisplayLayout.Override.CellAppearance = Appearance43
        Me.ugTOS.DisplayLayout.Override.CellClickAction = Infragistics.Win.UltraWinGrid.CellClickAction.EditAndSelectText
        Me.ugTOS.DisplayLayout.Override.CellPadding = 0
        ...
        Me.ugTOS.DisplayLayout.Override.GroupByRowAppearance = Appearance44
        Appearance45.TextHAlignAsString = "Left"
        Me.ugTOS.DisplayLayout.Override.HeaderAppearance = Appearance45
        Me.ugTOS.DisplayLayout.Override.HeaderClickAction = Infragistics.Win.UltraWinGrid.HeaderClickAction.SortMulti
        Me.ugTOS.DisplayLayout.Override.HeaderStyle = Infragistics.Win.HeaderStyle.WindowsXPCommand
        Appearance46.BackColor = System.Drawing.SystemColors.Window
        Appearance46.BorderColor = System.Drawing.Color.Silver
        Me.ugTOS.DisplayLayout.Override.RowAppearance = Appearance46
        Me.ugTOS.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.[False]
        Appearance47.BackColor = System.Drawing.SystemColors.ControlLight
        Me.ugTOS.DisplayLayout.Override.TemplateAddRowAppearance = Appearance47
        Me.ugTOS.DisplayLayout.ScrollBounds = Infragistics.Win.UltraWinGrid.ScrollBounds.ScrollToFill
        Me.ugTOS.DisplayLayout.ScrollStyle = Infragistics.Win.UltraWinGrid.ScrollStyle.Immediate
        Me.ugTOS.DisplayLayout.ViewStyleBand = Infragistics.Win.UltraWinGrid.ViewStyleBand.OutlookGroupBy
        Me.ugTOS.Dock = System.Windows.Forms.DockStyle.Fill
        Me.ugTOS.Location = New System.Drawing.Point(0, 24)
        Me.ugTOS.Name = "ugTOS"
        Me.ugTOS.Size = New System.Drawing.Size(903, 1104)
        Me.ugTOS.TabIndex = 47
        Me.ugTOS.Text = "UltraGrid1"
        '
        'pnlTOSDisplay
        '
        ...
        Me.pnlTOSDisplay.Size = New System.Drawing.Size(903, 24)
        ...
        Me.lblTOS.Size = New System.Drawing.Size(903, 24)
        ...
        Me.pnlVisual.Dock = System.Windows.Forms.DockStyle.Fill
        Me.pnlVisual.Location = New System.Drawing.Point(0, 0)
        Me.pnlVisual.Name = "pnlVisual"
        Me.pnlVisual.Size = New System.Drawing.Size(903, 1128)
        ...
        Me.ugVisual.DisplayLayout.Appearance = Appearance48
        Me.ugVisual.DisplayLayout.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugVisual.DisplayLayout.CaptionVisible = Infragistics.Win.DefaultableBoolean.[False]
        Appearance49.BackColor = System.Drawing.SystemColors.ActiveBorder
        Appearance49.BackColor2 = System.Drawing.SystemColors.ControlDark
        Appearance49.BackGradientStyle = Infragistics.Win.GradientStyle.Vertical
        Appearance49.BorderColor = System.Drawing.SystemColors.Window
        Me.ugVisual.DisplayLayout.GroupByBox.Appearance = Appearance49
        Appearance50.ForeColor = System.Drawing.SystemColors.GrayText
        Me.ugVisual.DisplayLayout.GroupByBox.BandLabelAppearance = Appearance50
        Me.ugVisual.DisplayLayout.GroupByBox.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugVisual.DisplayLayout.GroupByBox.Hidden = True
        ...
        Me.ugVisual.DisplayLayout.GroupByBox.PromptAppearance = Appearance51
        Me.ugVisual.DisplayLayout.MaxColScrollRegions = 1
        Me.ugVisual.DisplayLayout.MaxRowScrollRegions = 1
        Appearance52.BackColor = System.Drawing.SystemColors.Window
        Appearance52.ForeColor = System.Drawing.SystemColors.ControlText
        Me.ugVisual.DisplayLayout.Override.ActiveCellAppearance = Appearance52
        ...
        'Me.ugVisual.DisplayLayout.Override.ActiveRowAppearance = Appearance53
        Me.ugVisual.DisplayLayout.Override.BorderStyleCell = Infragistics.Win.UIElementBorderStyle.Dotted
        Me.ugVisual.DisplayLayout.Override.BorderStyleRow = Infragistics.Win.UIElementBorderStyle.Dotted
        Appearance54.BackColor = System.Drawing.SystemColors.Window
        Me.ugVisual.DisplayLayout.Override.CardAreaAppearance = Appearance54
        Appearance55.BorderColor = System.Drawing.Color.Silver
        Appearance55.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter
        Me.ugVisual.DisplayLayout.Override.CellAppearance = Appearance55
        Me.ugVisual.DisplayLayout.Override.CellClickAction = Infragistics.Win.UltraWinGrid.CellClickAction.EditAndSelectText
        Me.ugVisual.DisplayLayout.Override.CellPadding = 0
        ...
        Me.ugVisual.DisplayLayout.Override.GroupByRowAppearance = Appearance56
        Appearance57.TextHAlignAsString = "Left"
        Me.ugVisual.DisplayLayout.Override.HeaderAppearance = Appearance57
        Me.ugVisual.DisplayLayout.Override.HeaderClickAction = Infragistics.Win.UltraWinGrid.HeaderClickAction.SortMulti
        Me.ugVisual.DisplayLayout.Override.HeaderStyle = Infragistics.Win.HeaderStyle.WindowsXPCommand
        Appearance58.BackColor = System.Drawing.SystemColors.Window
        Appearance58.BorderColor = System.Drawing.Color.Silver
        Me.ugVisual.DisplayLayout.Override.RowAppearance = Appearance58
        Me.ugVisual.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.[False]
        Appearance59.BackColor = System.Drawing.SystemColors.ControlLight
        Me.ugVisual.DisplayLayout.Override.TemplateAddRowAppearance = Appearance59
        Me.ugVisual.DisplayLayout.ScrollBounds = Infragistics.Win.UltraWinGrid.ScrollBounds.ScrollToFill
        Me.ugVisual.DisplayLayout.ScrollStyle = Infragistics.Win.UltraWinGrid.ScrollStyle.Immediate
        Me.ugVisual.DisplayLayout.ViewStyleBand = Infragistics.Win.UltraWinGrid.ViewStyleBand.OutlookGroupBy
        ...
        Me.ugVisual.Size = New System.Drawing.Size(903, 1104)
        Me.ugVisual.TabIndex = 48
        Me.ugVisual.Text = "UltraGrid1"
        '
        'pnlVisualDisplay
        '
        ...
        Me.pnlVisualDisplay.Size = New System.Drawing.Size(903, 24)
        ...
        Me.lblVisual.Size = New System.Drawing.Size(903, 24)
        ...
        Me.pnlCatLeak.Dock = System.Windows.Forms.DockStyle.Fill
        Me.pnlCatLeak.Location = New System.Drawing.Point(0, 0)
        Me.pnlCatLeak.Name = "pnlCatLeak"
        Me.pnlCatLeak.Size = New System.Drawing.Size(903, 1128)
        ...
        Me.ugCatLeak.DisplayLayout.Appearance = Appearance60
        Me.ugCatLeak.DisplayLayout.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugCatLeak.DisplayLayout.CaptionVisible = Infragistics.Win.DefaultableBoolean.[False]
        ...
        Me.ugCatLeak.DisplayLayout.GroupByBox.Appearance = Appearance61
        Appearance62.ForeColor = System.Drawing.SystemColors.GrayText
        Me.ugCatLeak.DisplayLayout.GroupByBox.BandLabelAppearance = Appearance62
        Me.ugCatLeak.DisplayLayout.GroupByBox.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugCatLeak.DisplayLayout.GroupByBox.Hidden = True
        ...
        Me.ugCatLeak.DisplayLayout.GroupByBox.PromptAppearance = Appearance63
        Me.ugCatLeak.DisplayLayout.MaxColScrollRegions = 1
        Me.ugCatLeak.DisplayLayout.MaxRowScrollRegions = 1
        Appearance64.BackColor = System.Drawing.SystemColors.Window
        Appearance64.ForeColor = System.Drawing.SystemColors.ControlText
        Me.ugCatLeak.DisplayLayout.Override.ActiveCellAppearance = Appearance64
        ...
        'Me.ugCatLeak.DisplayLayout.Override.ActiveRowAppearance = Appearance65
        Me.ugCatLeak.DisplayLayout.Override.BorderStyleCell = Infragistics.Win.UIElementBorderStyle.Dotted
        Me.ugCatLeak.DisplayLayout.Override.BorderStyleRow = Infragistics.Win.UIElementBorderStyle.Dotted
        Appearance66.BackColor = System.Drawing.SystemColors.Window
        Me.ugCatLeak.DisplayLayout.Override.CardAreaAppearance = Appearance66
        ...
        Me.ugCatLeak.DisplayLayout.Override.CellAppearance = Appearance67
        Me.ugCatLeak.DisplayLayout.Override.CellClickAction = Infragistics.Win.UltraWinGrid.CellClickAction.EditAndSelectText
        Me.ugCatLeak.DisplayLayout.Override.CellPadding = 0
        ...
        Me.ugCatLeak.DisplayLayout.Override.GroupByRowAppearance = Appearance68
        Appearance69.TextHAlignAsString = "Left"
        Me.ugCatLeak.DisplayLayout.Override.HeaderAppearance = Appearance69
        Me.ugCatLeak.DisplayLayout.Override.HeaderClickAction = Infragistics.Win.UltraWinGrid.HeaderClickAction.SortMulti
        Me.ugCatLeak.DisplayLayout.Override.HeaderStyle = Infragistics.Win.HeaderStyle.WindowsXPCommand
        Appearance70.BackColor = System.Drawing.SystemColors.Window
        Appearance70.BorderColor = System.Drawing.Color.Silver
        Me.ugCatLeak.DisplayLayout.Override.RowAppearance = Appearance70
        Me.ugCatLeak.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.[False]
        Appearance71.BackColor = System.Drawing.SystemColors.ControlLight
        Me.ugCatLeak.DisplayLayout.Override.TemplateAddRowAppearance = Appearance71
        Me.ugCatLeak.DisplayLayout.ScrollBounds = Infragistics.Win.UltraWinGrid.ScrollBounds.ScrollToFill
        Me.ugCatLeak.DisplayLayout.ScrollStyle = Infragistics.Win.UltraWinGrid.ScrollStyle.Immediate
        Me.ugCatLeak.DisplayLayout.ViewStyleBand = Infragistics.Win.UltraWinGrid.ViewStyleBand.OutlookGroupBy
        ...
        Me.ugCatLeak.Size = New System.Drawing.Size(903, 1104)
        Me.ugCatLeak.TabIndex = 47
        Me.ugCatLeak.Text = "UltraGrid1"
        '
        'pnlCatLeakDisplay
        '
        ...
        Me.pnlCatLeakDisplay.Size = New System.Drawing.Size(903, 24)
        ...
        Me.lblCatLeak.Size = New System.Drawing.Size(903, 24)
        ...
        Me.pnlPipeLeak.Dock = System.Windows.Forms.DockStyle.Fill
        Me.pnlPipeLeak.Location = New System.Drawing.Point(0, 0)
        Me.pnlPipeLeak.Name = "pnlPipeLeak"
        Me.pnlPipeLeak.Size = New System.Drawing.Size(903, 1128)
        ...
        Me.ugPipeLeak.DisplayLayout.Appearance = Appearance72
        Me.ugPipeLeak.DisplayLayout.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugPipeLeak.DisplayLayout.CaptionVisible = Infragistics.Win.DefaultableBoolean.[False]
        ...
        Me.ugPipeLeak.DisplayLayout.GroupByBox.Appearance = Appearance73
        Appearance74.ForeColor = System.Drawing.SystemColors.GrayText
        Me.ugPipeLeak.DisplayLayout.GroupByBox.BandLabelAppearance = Appearance74
        Me.ugPipeLeak.DisplayLayout.GroupByBox.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugPipeLeak.DisplayLayout.GroupByBox.Hidden = True
        ...
        Me.ugPipeLeak.DisplayLayout.GroupByBox.PromptAppearance = Appearance75
        Me.ugPipeLeak.DisplayLayout.MaxColScrollRegions = 1
        Me.ugPipeLeak.DisplayLayout.MaxRowScrollRegions = 1
        Appearance76.BackColor = System.Drawing.SystemColors.Window
        Appearance76.ForeColor = System.Drawing.SystemColors.ControlText
        Me.ugPipeLeak.DisplayLayout.Override.ActiveCellAppearance = Appearance76
        ...
        'Me.ugPipeLeak.DisplayLayout.Override.ActiveRowAppearance = Appearance77
        Me.ugPipeLeak.DisplayLayout.Override.BorderStyleCell = Infragistics.Win.UIElementBorderStyle.Dotted
        Me.ugPipeLeak.DisplayLayout.Override.BorderStyleRow = Infragistics.Win.UIElementBorderStyle.Dotted
        Appearance78.BackColor = System.Drawing.SystemColors.Window
        Me.ugPipeLeak.DisplayLayout.Override.CardAreaAppearance = Appearance78
        ...
        Me.ugPipeLeak.DisplayLayout.Override.CellAppearance = Appearance79
        Me.ugPipeLeak.DisplayLayout.Override.CellClickAction = Infragistics.Win.UltraWinGrid.CellClickAction.EditAndSelectText
        Me.ugPipeLeak.DisplayLayout.Override.CellPadding = 0
        ...
        Me.ugPipeLeak.DisplayLayout.Override.GroupByRowAppearance = Appearance80
        Appearance81.TextHAlignAsString = "Left"
        Me.ugPipeLeak.DisplayLayout.Override.HeaderAppearance = Appearance81
        Me.ugPipeLeak.DisplayLayout.Override.HeaderClickAction = Infragistics.Win.UltraWinGrid.HeaderClickAction.SortMulti
        Me.ugPipeLeak.DisplayLayout.Override.HeaderStyle = Infragistics.Win.HeaderStyle.WindowsXPCommand
        Appearance82.BackColor = System.Drawing.SystemColors.Window
        Appearance82.BorderColor = System.Drawing.Color.Silver
        Me.ugPipeLeak.DisplayLayout.Override.RowAppearance = Appearance82
        Me.ugPipeLeak.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.[False]
        Appearance83.BackColor = System.Drawing.SystemColors.ControlLight
        Me.ugPipeLeak.DisplayLayout.Override.TemplateAddRowAppearance = Appearance83
        Me.ugPipeLeak.DisplayLayout.ScrollBounds = Infragistics.Win.UltraWinGrid.ScrollBounds.ScrollToFill
        Me.ugPipeLeak.DisplayLayout.ScrollStyle = Infragistics.Win.UltraWinGrid.ScrollStyle.Immediate
        Me.ugPipeLeak.DisplayLayout.ViewStyleBand = Infragistics.Win.UltraWinGrid.ViewStyleBand.OutlookGroupBy
        ...
        Me.ugPipeLeak.Size = New System.Drawing.Size(903, 1080)
        Me.ugPipeLeak.TabIndex = 46
        Me.ugPipeLeak.Text = "UltraGrid1"
        '
        'pnlPipeLeakAdd
        '
        ...
        Me.pnlPipeLeakAdd.Size = New System.Drawing.Size(903, 24)
        ...
        Me.btnAddPipeMW.UseVisualStyleBackColor = False
        '
        'pnlPipeLeakDisplay
        '
        ...
        Me.pnlPipeLeakDisplay.Size = New System.Drawing.Size(903, 24)
        ...
        Me.lblPipeLeak.Size = New System.Drawing.Size(903, 24)
        ...
        Me.pnlTankLeak.Dock = System.Windows.Forms.DockStyle.Fill
        Me.pnlTankLeak.Location = New System.Drawing.Point(0, 0)
        Me.pnlTankLeak.Name = "pnlTankLeak"
        Me.pnlTankLeak.Size = New System.Drawing.Size(903, 1128)
        ...
        Me.ugTankLeak.DisplayLayout.Appearance = Appearance84
        Me.ugTankLeak.DisplayLayout.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugTankLeak.DisplayLayout.CaptionVisible = Infragistics.Win.DefaultableBoolean.[False]
        ...
        Me.ugTankLeak.DisplayLayout.GroupByBox.Appearance = Appearance85
        Appearance86.ForeColor = System.Drawing.SystemColors.GrayText
        Me.ugTankLeak.DisplayLayout.GroupByBox.BandLabelAppearance = Appearance86
        Me.ugTankLeak.DisplayLayout.GroupByBox.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugTankLeak.DisplayLayout.GroupByBox.Hidden = True
        ...
        Me.ugTankLeak.DisplayLayout.GroupByBox.PromptAppearance = Appearance87
        Me.ugTankLeak.DisplayLayout.MaxColScrollRegions = 1
        Me.ugTankLeak.DisplayLayout.MaxRowScrollRegions = 1
        Appearance88.BackColor = System.Drawing.SystemColors.Window
        Appearance88.ForeColor = System.Drawing.SystemColors.ControlText
        Me.ugTankLeak.DisplayLayout.Override.ActiveCellAppearance = Appearance88
        ...
        'Me.ugTankLeak.DisplayLayout.Override.ActiveRowAppearance = Appearance89
        Me.ugTankLeak.DisplayLayout.Override.BorderStyleCell = Infragistics.Win.UIElementBorderStyle.Dotted
        Me.ugTankLeak.DisplayLayout.Override.BorderStyleRow = Infragistics.Win.UIElementBorderStyle.Dotted
        Appearance90.BackColor = System.Drawing.SystemColors.Window
        Me.ugTankLeak.DisplayLayout.Override.CardAreaAppearance = Appearance90
        ...
        Me.ugTankLeak.DisplayLayout.Override.CellAppearance = Appearance91
        Me.ugTankLeak.DisplayLayout.Override.CellClickAction = Infragistics.Win.UltraWinGrid.CellClickAction.EditAndSelectText
        Me.ugTankLeak.DisplayLayout.Override.CellPadding = 0
        ...
        Me.ugTankLeak.DisplayLayout.Override.GroupByRowAppearance = Appearance92
        Appearance93.TextHAlignAsString = "Left"
        Me.ugTankLeak.DisplayLayout.Override.HeaderAppearance = Appearance93
        Me.ugTankLeak.DisplayLayout.Override.HeaderClickAction = Infragistics.Win.UltraWinGrid.HeaderClickAction.SortMulti
        Me.ugTankLeak.DisplayLayout.Override.HeaderStyle = Infragistics.Win.HeaderStyle.WindowsXPCommand
        Appearance94.BackColor = System.Drawing.SystemColors.Window
        Appearance94.BorderColor = System.Drawing.Color.Silver
        Me.ugTankLeak.DisplayLayout.Override.RowAppearance = Appearance94
        Me.ugTankLeak.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.[False]
        Appearance95.BackColor = System.Drawing.SystemColors.ControlLight
        Me.ugTankLeak.DisplayLayout.Override.TemplateAddRowAppearance = Appearance95
        Me.ugTankLeak.DisplayLayout.ScrollBounds = Infragistics.Win.UltraWinGrid.ScrollBounds.ScrollToFill
        Me.ugTankLeak.DisplayLayout.ScrollStyle = Infragistics.Win.UltraWinGrid.ScrollStyle.Immediate
        Me.ugTankLeak.DisplayLayout.ViewStyleBand = Infragistics.Win.UltraWinGrid.ViewStyleBand.OutlookGroupBy
        ...
        'Me.ugTankLeak.Size = New System.Drawing.Size(903, 1080)
        Me.ugTankLeak.Size = New System.Drawing.Size(864, 96)
        Me.ugTankLeak.TabIndex = 46
        Me.ugTankLeak.Text = "UltraGrid1"
        '
        'pnlTankLeakAdd
        '
        ...
        Me.btnAddTankMW.UseVisualStyleBackColor = False
        '
        'pnlTankLeakDisplay
        '
        ...
        Me.lblTankLeak.Size = New System.Drawing.Size(903, 24)
        ...
        Me.pnlCP.Dock = System.Windows.Forms.DockStyle.Fill
        Me.pnlCP.Location = New System.Drawing.Point(0, 0)
        Me.pnlCP.Name = "pnlCP"
        Me.pnlCP.Size = New System.Drawing.Size(903, 1128)
        Me.pnlCP.TabIndex = 5
        '
        'ugCP
        '
        ...
        Me.ugCP.DisplayLayout.Appearance = Appearance96
        Me.ugCP.DisplayLayout.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugCP.DisplayLayout.CaptionVisible = Infragistics.Win.DefaultableBoolean.[False]
        ...
        Me.ugCP.DisplayLayout.GroupByBox.Appearance = Appearance97
        Appearance98.ForeColor = System.Drawing.SystemColors.GrayText
        Me.ugCP.DisplayLayout.GroupByBox.BandLabelAppearance = Appearance98
        Me.ugCP.DisplayLayout.GroupByBox.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugCP.DisplayLayout.GroupByBox.Hidden = True
        ...
        Me.ugCP.DisplayLayout.GroupByBox.PromptAppearance = Appearance99
        Me.ugCP.DisplayLayout.MaxColScrollRegions = 1
        Me.ugCP.DisplayLayout.MaxRowScrollRegions = 1
        ...
        Me.ugCP.DisplayLayout.Override.ActiveCellAppearance = Appearance100
        ...
        'Me.ugCP.DisplayLayout.Override.ActiveRowAppearance = Appearance101
        Me.ugCP.DisplayLayout.Override.BorderStyleCell = Infragistics.Win.UIElementBorderStyle.Dotted
        Me.ugCP.DisplayLayout.Override.BorderStyleRow = Infragistics.Win.UIElementBorderStyle.Dotted
        Appearance102.BackColor = System.Drawing.SystemColors.Window
        Me.ugCP.DisplayLayout.Override.CardAreaAppearance = Appearance102
        ...
        Me.ugCP.DisplayLayout.Override.CellAppearance = Appearance103
        Me.ugCP.DisplayLayout.Override.CellClickAction = Infragistics.Win.UltraWinGrid.CellClickAction.EditAndSelectText
        Me.ugCP.DisplayLayout.Override.CellPadding = 0
        ...
        Me.ugCP.DisplayLayout.Override.GroupByRowAppearance = Appearance104
        Appearance105.TextHAlignAsString = "Left"
        Me.ugCP.DisplayLayout.Override.HeaderAppearance = Appearance105
        Me.ugCP.DisplayLayout.Override.HeaderClickAction = Infragistics.Win.UltraWinGrid.HeaderClickAction.SortMulti
        Me.ugCP.DisplayLayout.Override.HeaderStyle = Infragistics.Win.HeaderStyle.WindowsXPCommand
        Appearance106.BackColor = System.Drawing.SystemColors.Window
        Appearance106.BorderColor = System.Drawing.Color.Silver
        Me.ugCP.DisplayLayout.Override.RowAppearance = Appearance106
        Me.ugCP.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.[False]
        Appearance107.BackColor = System.Drawing.SystemColors.ControlLight
        Me.ugCP.DisplayLayout.Override.TemplateAddRowAppearance = Appearance107
        Me.ugCP.DisplayLayout.ScrollBounds = Infragistics.Win.UltraWinGrid.ScrollBounds.ScrollToFill
        Me.ugCP.DisplayLayout.ScrollStyle = Infragistics.Win.UltraWinGrid.ScrollStyle.Immediate
        Me.ugCP.DisplayLayout.ViewStyleBand = Infragistics.Win.UltraWinGrid.ViewStyleBand.OutlookGroupBy
        Me.ugCP.Dock = System.Windows.Forms.DockStyle.Fill
        Me.ugCP.Location = New System.Drawing.Point(0, 48)
        Me.ugCP.Name = "ugCP"
        Me.ugCP.Size = New System.Drawing.Size(903, 1080)
        Me.ugCP.TabIndex = 45
        Me.ugCP.Text = "UltraGrid1"
        '
        'pnlCPAdd
        '
        ...
        Me.pnlCPAdd.Size = New System.Drawing.Size(903, 24)
        ...
        Me.btnAddTankCP.UseVisualStyleBackColor = False
        '
        'btnAddPipeCP
        '
        ...
        Me.btnAddPipeCP.UseVisualStyleBackColor = False
        '
        'btnAddTermCP
        '
        ...
        Me.btnAddTermCP.UseVisualStyleBackColor = False
        '
        'pnlCPDisplay
        '
        ...
        Me.pnlCPDisplay.Size = New System.Drawing.Size(903, 24)
        ...
        Me.lblCP.Name = "lblCP"
        Me.lblCP.Size = New System.Drawing.Size(903, 24)
        Me.lblCP.TabIndex = 2
        ...
        Me.pnlReg.Dock = System.Windows.Forms.DockStyle.Fill
        Me.pnlReg.Location = New System.Drawing.Point(0, 0)
        Me.pnlReg.Name = "pnlReg"
        Me.pnlReg.Size = New System.Drawing.Size(903, 1128)
        ...
        Me.ugReg.DisplayLayout.Appearance = Appearance108
        Me.ugReg.DisplayLayout.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugReg.DisplayLayout.CaptionVisible = Infragistics.Win.DefaultableBoolean.[False]
        ...
        Me.ugReg.DisplayLayout.GroupByBox.Appearance = Appearance109
        Appearance110.ForeColor = System.Drawing.SystemColors.GrayText
        Me.ugReg.DisplayLayout.GroupByBox.BandLabelAppearance = Appearance110
        Me.ugReg.DisplayLayout.GroupByBox.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugReg.DisplayLayout.GroupByBox.Hidden = True
        ...
        Me.ugReg.DisplayLayout.GroupByBox.PromptAppearance = Appearance111
        Me.ugReg.DisplayLayout.MaxColScrollRegions = 1
        Me.ugReg.DisplayLayout.MaxRowScrollRegions = 1
        ...
        Me.ugReg.DisplayLayout.Override.ActiveCellAppearance = Appearance112
        ...
        'Me.ugReg.DisplayLayout.Override.ActiveRowAppearance = Appearance113
        Me.ugReg.DisplayLayout.Override.BorderStyleCell = Infragistics.Win.UIElementBorderStyle.Dotted
        Me.ugReg.DisplayLayout.Override.BorderStyleRow = Infragistics.Win.UIElementBorderStyle.Dotted
        Appearance114.BackColor = System.Drawing.SystemColors.Window
        Me.ugReg.DisplayLayout.Override.CardAreaAppearance = Appearance114
        ...
        Me.ugReg.DisplayLayout.Override.CellAppearance = Appearance115
        Me.ugReg.DisplayLayout.Override.CellClickAction = Infragistics.Win.UltraWinGrid.CellClickAction.EditAndSelectText
        Me.ugReg.DisplayLayout.Override.CellPadding = 0
        ...
        Me.ugReg.DisplayLayout.Override.GroupByRowAppearance = Appearance116
        Appearance117.TextHAlignAsString = "Left"
        Me.ugReg.DisplayLayout.Override.HeaderAppearance = Appearance117
        Me.ugReg.DisplayLayout.Override.HeaderClickAction = Infragistics.Win.UltraWinGrid.HeaderClickAction.SortMulti
        Me.ugReg.DisplayLayout.Override.HeaderStyle = Infragistics.Win.HeaderStyle.WindowsXPCommand
        Appearance118.BackColor = System.Drawing.SystemColors.Window
        Appearance118.BorderColor = System.Drawing.Color.Silver
        Me.ugReg.DisplayLayout.Override.RowAppearance = Appearance118
        Me.ugReg.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.[False]
        Appearance119.BackColor = System.Drawing.SystemColors.ControlLight
        Me.ugReg.DisplayLayout.Override.TemplateAddRowAppearance = Appearance119
        Me.ugReg.DisplayLayout.ScrollBounds = Infragistics.Win.UltraWinGrid.ScrollBounds.ScrollToFill
        Me.ugReg.DisplayLayout.ScrollStyle = Infragistics.Win.UltraWinGrid.ScrollStyle.Immediate
        Me.ugReg.DisplayLayout.ViewStyleBand = Infragistics.Win.UltraWinGrid.ViewStyleBand.OutlookGroupBy
        Me.ugReg.Dock = System.Windows.Forms.DockStyle.Fill
        Me.ugReg.Location = New System.Drawing.Point(0, 24)
        Me.ugReg.Name = "ugReg"
        Me.ugReg.Size = New System.Drawing.Size(903, 1104)
        Me.ugReg.TabIndex = 39
        Me.ugReg.Text = "UltraGrid1"
        '
        'pnlRegDisplay
        '
        ...
        Me.pnlRegDisplay.Size = New System.Drawing.Size(903, 24)
        ...
        Me.lblReg.Size = New System.Drawing.Size(903, 24)
        ...
        Me.pnlSpill.Dock = System.Windows.Forms.DockStyle.Fill
        Me.pnlSpill.Location = New System.Drawing.Point(0, 0)
        Me.pnlSpill.Name = "pnlSpill"
        Me.pnlSpill.Size = New System.Drawing.Size(903, 1128)
        ...
        Me.ugSpill.DisplayLayout.Appearance = Appearance120
        Me.ugSpill.DisplayLayout.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugSpill.DisplayLayout.CaptionVisible = Infragistics.Win.DefaultableBoolean.[False]
        ...
        Me.ugSpill.DisplayLayout.GroupByBox.Appearance = Appearance121
        Appearance122.ForeColor = System.Drawing.SystemColors.GrayText
        Me.ugSpill.DisplayLayout.GroupByBox.BandLabelAppearance = Appearance122
        Me.ugSpill.DisplayLayout.GroupByBox.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugSpill.DisplayLayout.GroupByBox.Hidden = True
        ...
        Me.ugSpill.DisplayLayout.GroupByBox.PromptAppearance = Appearance123
        Me.ugSpill.DisplayLayout.MaxColScrollRegions = 1
        Me.ugSpill.DisplayLayout.MaxRowScrollRegions = 1
        ...
        Me.ugSpill.DisplayLayout.Override.ActiveCellAppearance = Appearance124
        ...
        'Me.ugSpill.DisplayLayout.Override.ActiveRowAppearance = Appearance125
        Me.ugSpill.DisplayLayout.Override.BorderStyleCell = Infragistics.Win.UIElementBorderStyle.Dotted
        Me.ugSpill.DisplayLayout.Override.BorderStyleRow = Infragistics.Win.UIElementBorderStyle.Dotted
        Appearance126.BackColor = System.Drawing.SystemColors.Window
        Me.ugSpill.DisplayLayout.Override.CardAreaAppearance = Appearance126
        ...
        Me.ugSpill.DisplayLayout.Override.CellAppearance = Appearance127
        Me.ugSpill.DisplayLayout.Override.CellClickAction = Infragistics.Win.UltraWinGrid.CellClickAction.EditAndSelectText
        Me.ugSpill.DisplayLayout.Override.CellPadding = 0
        ...
        Me.ugSpill.DisplayLayout.Override.GroupByRowAppearance = Appearance128
        Appearance129.TextHAlignAsString = "Left"
        Me.ugSpill.DisplayLayout.Override.HeaderAppearance = Appearance129
        Me.ugSpill.DisplayLayout.Override.HeaderClickAction = Infragistics.Win.UltraWinGrid.HeaderClickAction.SortMulti
        Me.ugSpill.DisplayLayout.Override.HeaderStyle = Infragistics.Win.HeaderStyle.WindowsXPCommand
        Appearance130.BackColor = System.Drawing.SystemColors.Window
        Appearance130.BorderColor = System.Drawing.Color.Silver
        Me.ugSpill.DisplayLayout.Override.RowAppearance = Appearance130
        Me.ugSpill.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.[False]
        Appearance131.BackColor = System.Drawing.SystemColors.ControlLight
        Me.ugSpill.DisplayLayout.Override.TemplateAddRowAppearance = Appearance131

        Me.ugSpill.DisplayLayout.ScrollBounds = Infragistics.Win.UltraWinGrid.ScrollBounds.ScrollToFill
        Me.ugSpill.DisplayLayout.ScrollStyle = Infragistics.Win.UltraWinGrid.ScrollStyle.Immediate
        Me.ugSpill.DisplayLayout.ViewStyleBand = Infragistics.Win.UltraWinGrid.ViewStyleBand.OutlookGroupBy
        ...
        Me.ugSpill.Size = New System.Drawing.Size(903, 1104)
        Me.ugSpill.TabIndex = 38
        Me.ugSpill.Text = "UltraGrid1"
        '
        'pnlSpillDisplay
        '
        ...
        Me.pnlSpillDisplay.Size = New System.Drawing.Size(903, 24)
        ...
        Me.lblSpill.Size = New System.Drawing.Size(903, 24)
        ...
        Me.pnlTanksPipes.Dock = System.Windows.Forms.DockStyle.Fill
        Me.pnlTanksPipes.BringToFront()
        Me.pnlTanksPipes.Location = New System.Drawing.Point(0, 0)
        Me.pnlTanksPipes.Name = "pnlTanksPipes"
        Me.pnlTanksPipes.Size = New System.Drawing.Size(903, 1128)
        ...
        Me.pnlTanksPipesDisplay.BringToFront()
        ...
        Me.pnlTanksPipesDisplay.Size = New System.Drawing.Size(903, 24)
        ...
        Me.lblTanksPipesDisplay.Size = New System.Drawing.Size(903, 24)
        ...
        Me.pnlTanksPipesDetails.BringToFront()
        ...
        Me.pnlTanksPipesDetails.Size = New System.Drawing.Size(903, 1104)
        Me.pnlTanksPipesDetails.TabIndex = 31
        '
        'pnlTanksTop
        '
        Me.pnlTanksTop.Controls.Add(Me.lblTanks)
        Me.pnlTanksTop.BringToFront()
        ...
        Me.pnlTanksTop.Size = New System.Drawing.Size(903, 23)
        ...
        Me.pnlTanksDetails.BringToFront()
        Me.pnlTanksDetails.Location = New System.Drawing.Point(0, 24)
        Me.pnlTanksDetails.Name = "pnlTanksDetails"
        Me.pnlTanksDetails.Size = New System.Drawing.Size(903, 169)
        ...
        Appearance1.BackColor = System.Drawing.SystemColors.Window
        Appearance1.BorderColor = System.Drawing.SystemColors.InactiveCaption
        Me.ugTanks.DisplayLayout.Appearance = Appearance1
        Me.ugTanks.DisplayLayout.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugTanks.DisplayLayout.CaptionVisible = Infragistics.Win.DefaultableBoolean.[False]
        Appearance2.BackColor = System.Drawing.SystemColors.ActiveBorder
        Appearance2.BackColor2 = System.Drawing.SystemColors.ControlDark
        Appearance2.BackGradientStyle = Infragistics.Win.GradientStyle.Vertical
        Appearance2.BorderColor = System.Drawing.SystemColors.Window
        Me.ugTanks.DisplayLayout.GroupByBox.Appearance = Appearance2
        Appearance3.ForeColor = System.Drawing.SystemColors.GrayText
        Me.ugTanks.DisplayLayout.GroupByBox.BandLabelAppearance = Appearance3
        Me.ugTanks.DisplayLayout.GroupByBox.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugTanks.DisplayLayout.GroupByBox.Hidden = True
        Appearance4.BackColor = System.Drawing.SystemColors.ControlLightLight
        Appearance4.BackColor2 = System.Drawing.SystemColors.Control
        Appearance4.BackGradientStyle = Infragistics.Win.GradientStyle.Horizontal
        Appearance4.ForeColor = System.Drawing.SystemColors.GrayText
        Me.ugTanks.DisplayLayout.GroupByBox.PromptAppearance = Appearance4
        Me.ugTanks.DisplayLayout.MaxColScrollRegions = 1
        Me.ugTanks.DisplayLayout.MaxRowScrollRegions = 1
        Appearance5.BackColor = System.Drawing.SystemColors.Window
        Appearance5.ForeColor = System.Drawing.SystemColors.ControlText
        Me.ugTanks.DisplayLayout.Override.ActiveCellAppearance = Appearance5
        'Appearance6.BackColor = System.Drawing.SystemColors.Highlight
        'Appearance6.ForeColor = System.Drawing.SystemColors.HighlightText
        'Me.ugTanks.DisplayLayout.Override.ActiveRowAppearance = Appearance6
        Me.ugTanks.DisplayLayout.Override.BorderStyleCell = Infragistics.Win.UIElementBorderStyle.Dotted
        Me.ugTanks.DisplayLayout.Override.BorderStyleRow = Infragistics.Win.UIElementBorderStyle.Dotted
        Appearance7.BackColor = System.Drawing.SystemColors.Window
        Me.ugTanks.DisplayLayout.Override.CardAreaAppearance = Appearance7
        Appearance8.BorderColor = System.Drawing.Color.Silver
        Appearance8.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter
        Me.ugTanks.DisplayLayout.Override.CellAppearance = Appearance8
        Me.ugTanks.DisplayLayout.Override.CellClickAction = Infragistics.Win.UltraWinGrid.CellClickAction.EditAndSelectText
        Me.ugTanks.DisplayLayout.Override.CellPadding = 0
        Appearance9.BackColor = System.Drawing.SystemColors.Control
        Appearance9.BackColor2 = System.Drawing.SystemColors.ControlDark
        Appearance9.BackGradientAlignment = Infragistics.Win.GradientAlignment.Element
        Appearance9.BackGradientStyle = Infragistics.Win.GradientStyle.Horizontal
        Appearance9.BorderColor = System.Drawing.SystemColors.Window
        Me.ugTanks.DisplayLayout.Override.GroupByRowAppearance = Appearance9
        Appearance10.TextHAlignAsString = "Left"
        Me.ugTanks.DisplayLayout.Override.HeaderAppearance = Appearance10
        Me.ugTanks.DisplayLayout.Override.HeaderClickAction = Infragistics.Win.UltraWinGrid.HeaderClickAction.SortMulti
        Me.ugTanks.DisplayLayout.Override.HeaderStyle = Infragistics.Win.HeaderStyle.WindowsXPCommand
        Appearance11.BackColor = System.Drawing.SystemColors.Window
        Appearance11.BorderColor = System.Drawing.Color.Silver
        Me.ugTanks.DisplayLayout.Override.RowAppearance = Appearance11
        Me.ugTanks.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.[False]
        Appearance12.BackColor = System.Drawing.SystemColors.ControlLight
        Me.ugTanks.DisplayLayout.Override.TemplateAddRowAppearance = Appearance12
        Me.ugTanks.DisplayLayout.ScrollBounds = Infragistics.Win.UltraWinGrid.ScrollBounds.ScrollToFill
        Me.ugTanks.DisplayLayout.ScrollStyle = Infragistics.Win.UltraWinGrid.ScrollStyle.Immediate
        Me.ugTanks.DisplayLayout.ViewStyleBand = Infragistics.Win.UltraWinGrid.ViewStyleBand.OutlookGroupBy
        Me.ugTanks.Dock = System.Windows.Forms.DockStyle.Fill
        Me.ugTanks.BringToFront()
        Me.ugTanks.Location = New System.Drawing.Point(0, 10)
        Me.ugTanks.Name = "ugTanks"
        Me.ugTanks.Size = New System.Drawing.Size(903, 1104)
        Me.ugTanks.TabIndex = 52
        Me.ugTanks.Text = "UltraGrid1"
        '
        'pnlPipeTop
        '
        Me.pnlPipeTop.Controls.Add(Me.lblPipes)
        Me.pnlPipeTop.Dock = System.Windows.Forms.DockStyle.Top
        Me.pnlPipeTop.BringToFront()
        Me.pnlPipeTop.Location = New System.Drawing.Point(0, 300)
        Me.pnlPipeTop.Name = "pnlPipeTop"
        Me.pnlPipeTop.Size = New System.Drawing.Size(903, 23)
        Me.pnlPipeTop.TabIndex = 35
        '
        'lblPipes
        '
        Me.lblPipes.Location = New System.Drawing.Point(6, 5)
        ...
        Me.pnlPipeDetails.BringToFront()
        Me.pnlPipeDetails.Location = New System.Drawing.Point(0, 315)
        Me.pnlPipeDetails.Name = "pnlPipeDetails"
        Me.pnlPipeDetails.Size = New System.Drawing.Size(903, 169)
        ...
        Appearance1.BackColor = System.Drawing.SystemColors.Window
        Appearance1.BorderColor = System.Drawing.SystemColors.InactiveCaption
        Me.ugPipes.DisplayLayout.Appearance = Appearance1
        Me.ugPipes.DisplayLayout.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugPipes.DisplayLayout.CaptionVisible = Infragistics.Win.DefaultableBoolean.[False]
        Appearance2.BackColor = System.Drawing.SystemColors.ActiveBorder
        Appearance2.BackColor2 = System.Drawing.SystemColors.ControlDark
        Appearance2.BackGradientStyle = Infragistics.Win.GradientStyle.Vertical
        Appearance2.BorderColor = System.Drawing.SystemColors.Window
        Me.ugPipes.DisplayLayout.GroupByBox.Appearance = Appearance2
        Appearance3.ForeColor = System.Drawing.SystemColors.GrayText
        Me.ugPipes.DisplayLayout.GroupByBox.BandLabelAppearance = Appearance3
        Me.ugPipes.DisplayLayout.GroupByBox.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugPipes.DisplayLayout.GroupByBox.Hidden = True
        Appearance4.BackColor = System.Drawing.SystemColors.ControlLightLight
        Appearance4.BackColor2 = System.Drawing.SystemColors.Control
        Appearance4.BackGradientStyle = Infragistics.Win.GradientStyle.Horizontal
        Appearance4.ForeColor = System.Drawing.SystemColors.GrayText
        Me.ugPipes.DisplayLayout.GroupByBox.PromptAppearance = Appearance4
        Me.ugPipes.DisplayLayout.MaxColScrollRegions = 1
        Me.ugPipes.DisplayLayout.MaxRowScrollRegions = 1
        Appearance5.BackColor = System.Drawing.SystemColors.Window
        Appearance5.ForeColor = System.Drawing.SystemColors.ControlText
        Me.ugPipes.DisplayLayout.Override.ActiveCellAppearance = Appearance5
        'Appearance6.BackColor = System.Drawing.SystemColors.Highlight
        'Appearance6.ForeColor = System.Drawing.SystemColors.HighlightText
        'Me.ugPipes.DisplayLayout.Override.ActiveRowAppearance = Appearance6
        Me.ugPipes.DisplayLayout.Override.BorderStyleCell = Infragistics.Win.UIElementBorderStyle.Dotted
        Me.ugPipes.DisplayLayout.Override.BorderStyleRow = Infragistics.Win.UIElementBorderStyle.Dotted
        Appearance7.BackColor = System.Drawing.SystemColors.Window
        Me.ugPipes.DisplayLayout.Override.CardAreaAppearance = Appearance7
        Appearance8.BorderColor = System.Drawing.Color.Silver
        Appearance8.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter
        Me.ugPipes.DisplayLayout.Override.CellAppearance = Appearance8
        Me.ugPipes.DisplayLayout.Override.CellClickAction = Infragistics.Win.UltraWinGrid.CellClickAction.EditAndSelectText
        Me.ugPipes.DisplayLayout.Override.CellPadding = 0
        Appearance9.BackColor = System.Drawing.SystemColors.Control
        Appearance9.BackColor2 = System.Drawing.SystemColors.ControlDark
        Appearance9.BackGradientAlignment = Infragistics.Win.GradientAlignment.Element
        Appearance9.BackGradientStyle = Infragistics.Win.GradientStyle.Horizontal
        Appearance9.BorderColor = System.Drawing.SystemColors.Window
        Me.ugPipes.DisplayLayout.Override.GroupByRowAppearance = Appearance9
        Appearance10.TextHAlignAsString = "Left"
        Me.ugPipes.DisplayLayout.Override.HeaderAppearance = Appearance10
        Me.ugPipes.DisplayLayout.Override.HeaderClickAction = Infragistics.Win.UltraWinGrid.HeaderClickAction.SortMulti
        Me.ugPipes.DisplayLayout.Override.HeaderStyle = Infragistics.Win.HeaderStyle.WindowsXPCommand
        Appearance11.BackColor = System.Drawing.SystemColors.Window
        Appearance11.BorderColor = System.Drawing.Color.Silver
        Me.ugPipes.DisplayLayout.Override.RowAppearance = Appearance11
        Me.ugPipes.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.[False]
        Appearance12.BackColor = System.Drawing.SystemColors.ControlLight
        Me.ugPipes.DisplayLayout.Override.TemplateAddRowAppearance = Appearance12
        Me.ugPipes.DisplayLayout.ScrollBounds = Infragistics.Win.UltraWinGrid.ScrollBounds.ScrollToFill
        Me.ugPipes.DisplayLayout.ScrollStyle = Infragistics.Win.UltraWinGrid.ScrollStyle.Immediate
        Me.ugPipes.DisplayLayout.ViewStyleBand = Infragistics.Win.UltraWinGrid.ViewStyleBand.OutlookGroupBy
        Me.ugPipes.Dock = System.Windows.Forms.DockStyle.Fill
        Me.ugPipes.BringToFront()
        Me.ugPipes.Location = New System.Drawing.Point(0, 10)
        Me.ugPipes.Name = "ugPipes"
        Me.ugPipes.Size = New System.Drawing.Size(903, 1104)
        Me.ugPipes.TabIndex = 52
        Me.ugPipes.Text = "UltraGrid1"
        '
        'pnlTerminationsTop
        '
        ...
        Me.pnlTerminationsTop.BringToFront()
        Me.pnlTerminationsTop.Name = "pnlTerminationsTop"
        Me.pnlTerminationsTop.Size = New System.Drawing.Size(903, 23)
        ...
        Me.pnlTerminationsDetails.BringToFront()
        Me.pnlTerminationsDetails.Location = New System.Drawing.Point(0, 615)
        Me.pnlTerminationsDetails.Name = "pnlTerminationsDetails"
        Me.pnlTerminationsDetails.Size = New System.Drawing.Size(903, 162)
        ...
        Appearance1.BackColor = System.Drawing.SystemColors.Window
        Appearance1.BorderColor = System.Drawing.SystemColors.InactiveCaption
        Me.ugTerminations.DisplayLayout.Appearance = Appearance1
        Me.ugTerminations.DisplayLayout.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugTerminations.DisplayLayout.CaptionVisible = Infragistics.Win.DefaultableBoolean.[False]
        Appearance2.BackColor = System.Drawing.SystemColors.ActiveBorder
        Appearance2.BackColor2 = System.Drawing.SystemColors.ControlDark
        Appearance2.BackGradientStyle = Infragistics.Win.GradientStyle.Vertical
        Appearance2.BorderColor = System.Drawing.SystemColors.Window
        Me.ugTerminations.DisplayLayout.GroupByBox.Appearance = Appearance2
        Appearance3.ForeColor = System.Drawing.SystemColors.GrayText
        Me.ugTerminations.DisplayLayout.GroupByBox.BandLabelAppearance = Appearance3
        Me.ugTerminations.DisplayLayout.GroupByBox.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugTerminations.DisplayLayout.GroupByBox.Hidden = True
        Appearance4.BackColor = System.Drawing.SystemColors.ControlLightLight
        Appearance4.BackColor2 = System.Drawing.SystemColors.Control
        Appearance4.BackGradientStyle = Infragistics.Win.GradientStyle.Horizontal
        Appearance4.ForeColor = System.Drawing.SystemColors.GrayText
        Me.ugTerminations.DisplayLayout.GroupByBox.PromptAppearance = Appearance4
        Me.ugTerminations.DisplayLayout.MaxColScrollRegions = 1
        Me.ugTerminations.DisplayLayout.MaxRowScrollRegions = 1
        Appearance5.BackColor = System.Drawing.SystemColors.Window
        Appearance5.ForeColor = System.Drawing.SystemColors.ControlText
        Me.ugTerminations.DisplayLayout.Override.ActiveCellAppearance = Appearance5
        'Appearance6.BackColor = System.Drawing.SystemColors.Highlight
        'Appearance6.ForeColor = System.Drawing.SystemColors.HighlightText
        'Me.ugTerminations.DisplayLayout.Override.ActiveRowAppearance = Appearance6
        Me.ugTerminations.DisplayLayout.Override.BorderStyleCell = Infragistics.Win.UIElementBorderStyle.Dotted
        Me.ugTerminations.DisplayLayout.Override.BorderStyleRow = Infragistics.Win.UIElementBorderStyle.Dotted
        Appearance7.BackColor = System.Drawing.SystemColors.Window
        Me.ugTerminations.DisplayLayout.Override.CardAreaAppearance = Appearance7
        Appearance8.BorderColor = System.Drawing.Color.Silver
        Appearance8.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter
        Me.ugTerminations.DisplayLayout.Override.CellAppearance = Appearance8
        Me.ugTerminations.DisplayLayout.Override.CellClickAction = Infragistics.Win.UltraWinGrid.CellClickAction.EditAndSelectText
        Me.ugTerminations.DisplayLayout.Override.CellPadding = 0
        Appearance9.BackColor = System.Drawing.SystemColors.Control
        Appearance9.BackColor2 = System.Drawing.SystemColors.ControlDark
        Appearance9.BackGradientAlignment = Infragistics.Win.GradientAlignment.Element
        Appearance9.BackGradientStyle = Infragistics.Win.GradientStyle.Horizontal
        Appearance9.BorderColor = System.Drawing.SystemColors.Window
        Me.ugTerminations.DisplayLayout.Override.GroupByRowAppearance = Appearance9
        Appearance10.TextHAlignAsString = "Left"
        Me.ugTerminations.DisplayLayout.Override.HeaderAppearance = Appearance10
        Me.ugTerminations.DisplayLayout.Override.HeaderClickAction = Infragistics.Win.UltraWinGrid.HeaderClickAction.SortMulti
        Me.ugTerminations.DisplayLayout.Override.HeaderStyle = Infragistics.Win.HeaderStyle.WindowsXPCommand
        Appearance11.BackColor = System.Drawing.SystemColors.Window
        Appearance11.BorderColor = System.Drawing.Color.Silver
        Me.ugTerminations.DisplayLayout.Override.RowAppearance = Appearance11
        Me.ugTerminations.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.[False]
        Appearance12.BackColor = System.Drawing.SystemColors.ControlLight
        Me.ugTerminations.DisplayLayout.Override.TemplateAddRowAppearance = Appearance12
        Me.ugTerminations.DisplayLayout.ScrollBounds = Infragistics.Win.UltraWinGrid.ScrollBounds.ScrollToFill
        Me.ugTerminations.DisplayLayout.ScrollStyle = Infragistics.Win.UltraWinGrid.ScrollStyle.Immediate
        Me.ugTerminations.DisplayLayout.ViewStyleBand = Infragistics.Win.UltraWinGrid.ViewStyleBand.OutlookGroupBy
        Me.ugTerminations.Dock = System.Windows.Forms.DockStyle.Fill
        Me.ugTerminations.Location = New System.Drawing.Point(0, 0)
        Me.ugTerminations.BringToFront()
        Me.ugTerminations.Name = "ugTerminations"
        Me.ugTerminations.Size = New System.Drawing.Size(903, 1104)
        Me.ugTerminations.TabIndex = 52
        Me.ugTerminations.Text = "UltraGrid1"
        ...
        'PnlCapValues
        '
        Me.PnlCapValues.Controls.Add(Me.pnlCapEntryView)
        Me.PnlCapValues.Controls.Add(Me.Panel16)
        Me.Panel16.Dock = System.Windows.Forms.DockStyle.Fill
        Me.PnlCapValues.Location = New System.Drawing.Point(19, 840)
        Me.PnlCapValues.Name = "PnlCapValues"
        Me.PnlCapValues.Size = New System.Drawing.Size(864, 288)
        Me.PnlCapValues.BringToFront()
        Me.PnlCapValues.TabIndex = 12
        Me.PnlCapValues.Visible = False
        '
        'pnlCapEntryView
        '
        Me.pnlCapEntryView.Anchor = CType((((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Bottom) _
            Or System.Windows.Forms.AnchorStyles.Left) _
            Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.pnlCapEntryView.Location = New System.Drawing.Point(8, 32)
        Me.pnlCapEntryView.Name = "pnlCapEntryView"
        Me.pnlCapEntryView.Size = New System.Drawing.Size(848, 224)
        Me.pnlCapEntryView.TabIndex = 31
        '
        'Panel16
        '
        ...
        Me.Panel16.Size = New System.Drawing.Size(864, 24)
        ...
        Me.Label5.Size = New System.Drawing.Size(864, 24)
        Me.Label5.TabIndex = 2
        Me.Label5.Text = "TANK & PIPE CAP VALUES"
        Me.Label5.TextAlign = System.Drawing.ContentAlignment.MiddleLeft
        '
        'PnlSketch
        '
        Me.PnlSketch.Controls.Add(Me.Panel8)
        Me.PnlSketch.Controls.Add(Me.pctSketchPad)
        Me.PnlSketch.Dock = System.Windows.Forms.DockStyle.Fill
        Me.PnlSketch.Location = New System.Drawing.Point(0, 0)
        Me.PnlSketch.BringToFront()
        Me.PnlSketch.Name = "PnlSketch"
        Me.PnlSketch.Size = New System.Drawing.Size(903, 1128)
        Me.PnlSketch.TabIndex = 15
        '
        'Panel8
        '
        Me.Panel8.Controls.Add(Me.lblSketch)
        Me.Panel8.BringToFront()
        Me.Panel8.Dock = System.Windows.Forms.DockStyle.Top
        Me.Panel8.Location = New System.Drawing.Point(0, 0)
        Me.Panel8.Name = "Panel8"
        Me.Panel8.Size = New System.Drawing.Size(903, 24)
        Me.Panel8.TabIndex = 43
        '
        'lblSketch
        '
        Me.lblSketch.BackColor = System.Drawing.SystemColors.Highlight
        Me.lblSketch.Dock = System.Windows.Forms.DockStyle.Top
        Me.lblSketch.Font = New System.Drawing.Font("Microsoft Sans Serif", 10.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.lblSketch.ForeColor = System.Drawing.SystemColors.ActiveCaptionText
        Me.lblSketch.Location = New System.Drawing.Point(0, 0)
        Me.lblSketch.Name = "lblSketch"
        Me.lblSketch.Size = New System.Drawing.Size(903, 24)
        Me.lblSketch.TabIndex = 2
        Me.lblSketch.Text = "SKETCH OF FACILITY"
        Me.lblSketch.TextAlign = System.Drawing.ContentAlignment.MiddleLeft
        '
        'pctSketchPad
        '
        Me.pctSketchPad.BackColor = System.Drawing.SystemColors.Control
        Me.pctSketchPad.BorderStyle = System.Windows.Forms.BorderStyle.Fixed3D
        Me.pctSketchPad.Controls.Add(Me.btnSavePic)
        Me.pctSketchPad.BringToFront()
        Me.pctSketchPad.Dock = System.Windows.Forms.DockStyle.Fill
        Me.pctSketchPad.Location = New System.Drawing.Point(0, 0)
        Me.pctSketchPad.Name = "pctSketchPad"
        Me.pctSketchPad.Size = New System.Drawing.Size(903, 1128)
        Me.pctSketchPad.TabIndex = 2
        Me.pctSketchPad.TabStop = False
        Me.pctSketchPad.Tag = "0"
        '
        'btnSavePic
        '
        Me.btnSavePic.Enabled = False
        Me.btnSavePic.Location = New System.Drawing.Point(8, 60)
        Me.btnSavePic.Name = "btnSavePic"
        Me.btnSavePic.BringToFront()
        Me.btnSavePic.Size = New System.Drawing.Size(160, 23)
        Me.btnSavePic.TabIndex = 11
        Me.btnSavePic.Text = "Create Powerpoint Sketch"
        '
        'pnlMaster
        '
        ...
        Me.pnlMasterDetails.BringToFront()
        ...
        Me.pnlContact.Controls.Add(Me.ugContacts)
        ...
        Me.ugContacts.DisplayLayout.Override.CellClickAction = Infragistics.Win.UltraWinGrid.CellClickAction.EditAndSelectText
        ...
        Me.ugContacts.Location = New System.Drawing.Point(0, 35)
        Me.ugContacts.Name = "ugContacts"
        Me.ugContacts.Size = New System.Drawing.Size(1500, 500)
        Me.ugContacts.TabIndex = 52
        ...
        Me.btnOwnerModifyContact.Location = New System.Drawing.Point(240, 8)
        ...
        Me.btnOwnerDeleteContact.Location = New System.Drawing.Point(472, 8)
        ...
        Me.btnOwnerAssociateContact.Location = New System.Drawing.Point(704, 8)
        ...
        Me.btnOwnerAddSearchContact.Location = New System.Drawing.Point(8, 8)
        ...
        Me.pnlMasterDetailsGrid.BringToFront()
        ...
        Appearance1.BackColor = System.Drawing.SystemColors.Window
        Appearance1.BorderColor = System.Drawing.SystemColors.InactiveCaption
        Me.ugInspector.DisplayLayout.Appearance = Appearance1
        Me.ugInspector.DisplayLayout.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugInspector.DisplayLayout.CaptionVisible = Infragistics.Win.DefaultableBoolean.[False]
        Appearance2.BackColor = System.Drawing.SystemColors.ActiveBorder
        Appearance2.BackColor2 = System.Drawing.SystemColors.ControlDark
        Appearance2.BackGradientStyle = Infragistics.Win.GradientStyle.Vertical
        Appearance2.BorderColor = System.Drawing.SystemColors.Window
        Me.ugInspector.DisplayLayout.GroupByBox.Appearance = Appearance2
        Appearance3.ForeColor = System.Drawing.SystemColors.GrayText
        Me.ugInspector.DisplayLayout.GroupByBox.BandLabelAppearance = Appearance3
        Me.ugInspector.DisplayLayout.GroupByBox.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugInspector.DisplayLayout.GroupByBox.Hidden = True
        Appearance4.BackColor = System.Drawing.SystemColors.ControlLightLight
        Appearance4.BackColor2 = System.Drawing.SystemColors.Control
        Appearance4.BackGradientStyle = Infragistics.Win.GradientStyle.Horizontal
        Appearance4.ForeColor = System.Drawing.SystemColors.GrayText
        Me.ugInspector.DisplayLayout.GroupByBox.PromptAppearance = Appearance4
        Me.ugInspector.DisplayLayout.MaxColScrollRegions = 1
        Me.ugInspector.DisplayLayout.MaxRowScrollRegions = 1
        Appearance5.BackColor = System.Drawing.SystemColors.Window
        Appearance5.ForeColor = System.Drawing.SystemColors.ControlText
        Me.ugInspector.DisplayLayout.Override.ActiveCellAppearance = Appearance5
        'Appearance6.BackColor = System.Drawing.SystemColors.Highlight
        'Appearance6.ForeColor = System.Drawing.SystemColors.HighlightText
        'Me.ugInspector.DisplayLayout.Override.ActiveRowAppearance = Appearance6
        Me.ugInspector.DisplayLayout.Override.BorderStyleCell = Infragistics.Win.UIElementBorderStyle.Dotted
        Me.ugInspector.DisplayLayout.Override.BorderStyleRow = Infragistics.Win.UIElementBorderStyle.Dotted
        Appearance7.BackColor = System.Drawing.SystemColors.Window
        Me.ugInspector.DisplayLayout.Override.CardAreaAppearance = Appearance7
        Appearance8.BorderColor = System.Drawing.Color.Silver
        Appearance8.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter
        Me.ugInspector.DisplayLayout.Override.CellAppearance = Appearance8
        Me.ugInspector.DisplayLayout.Override.CellClickAction = Infragistics.Win.UltraWinGrid.CellClickAction.EditAndSelectText
        Me.ugInspector.DisplayLayout.Override.CellPadding = 0
        Appearance9.BackColor = System.Drawing.SystemColors.Control
        Appearance9.BackColor2 = System.Drawing.SystemColors.ControlDark
        Appearance9.BackGradientAlignment = Infragistics.Win.GradientAlignment.Element
        Appearance9.BackGradientStyle = Infragistics.Win.GradientStyle.Horizontal
        Appearance9.BorderColor = System.Drawing.SystemColors.Window
        Me.ugInspector.DisplayLayout.Override.GroupByRowAppearance = Appearance9
        Appearance10.TextHAlignAsString = "Left"
        Me.ugInspector.DisplayLayout.Override.HeaderAppearance = Appearance10
        Me.ugInspector.DisplayLayout.Override.HeaderClickAction = Infragistics.Win.UltraWinGrid.HeaderClickAction.SortMulti
        Me.ugInspector.DisplayLayout.Override.HeaderStyle = Infragistics.Win.HeaderStyle.WindowsXPCommand
        Appearance11.BackColor = System.Drawing.SystemColors.Window
        Appearance11.BorderColor = System.Drawing.Color.Silver
        Me.ugInspector.DisplayLayout.Override.RowAppearance = Appearance11
        Me.ugInspector.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.[False]
        Appearance12.BackColor = System.Drawing.SystemColors.ControlLight
        Me.ugInspector.DisplayLayout.Override.TemplateAddRowAppearance = Appearance12
        Me.ugInspector.DisplayLayout.ScrollBounds = Infragistics.Win.UltraWinGrid.ScrollBounds.ScrollToFill
        Me.ugInspector.DisplayLayout.ScrollStyle = Infragistics.Win.UltraWinGrid.ScrollStyle.Immediate
        Me.ugInspector.DisplayLayout.ViewStyleBand = Infragistics.Win.UltraWinGrid.ViewStyleBand.OutlookGroupBy
        Me.ugInspector.Dock = System.Windows.Forms.DockStyle.Fill
        Me.ugInspector.Location = New System.Drawing.Point(0, 0)
        Me.ugInspector.Name = "ugInspector"
        Me.ugInspector.Size = New System.Drawing.Size(903, 1104)
        Me.ugInspector.TabIndex = 52
        Me.ugInspector.Text = "UltraGrid1"
        '
        'pnlMasterDetailsTop
        '
        Me.pnlMasterDetailsTop.Controls.Add(Me.txtDesOp)
        Me.pnlMasterDetailsTop.Controls.Add(Me.Label1)
        ...
        Me.txtDesOp.Location = New System.Drawing.Point(432, 112)
        Me.txtDesOp.MaxLength = 256
        Me.txtDesOp.Name = "txtDesOp"
        Me.txtDesOp.Size = New System.Drawing.Size(336, 20)
        Me.txtDesOp.TabIndex = 12
        '
        'Label1
        '
        Me.Label1.Location = New System.Drawing.Point(368, 112)
        Me.Label1.Name = "Label1"
        Me.Label1.Size = New System.Drawing.Size(72, 17)
        Me.Label1.TabIndex = 11
        Me.Label1.Text = "Des. Op :"
        ...
        'txtFacility
        '
        Me.txtFacility.Location = New System.Drawing.Point(432, 192)
        Me.txtFacility.Name = "txtFacility"
        Me.txtFacility.ReadOnly = True
        Me.txtFacility.Size = New System.Drawing.Size(120, 20)
        Me.txtFacility.TabIndex = 0
        '
        'lblFacility
        '
        Me.lblFacility.Location = New System.Drawing.Point(312, 192)
        ...
        'txtOwnerState
        '
        Me.txtOwnerState.Location = New System.Drawing.Point(432, 168)
        Me.txtOwnerState.Name = "txtOwnerState"
        Me.txtOwnerState.ReadOnly = True
        Me.txtOwnerState.Size = New System.Drawing.Size(48, 20)
        Me.txtOwnerState.TabIndex = 0
        '
        'txtOwnerCity
        '
        Me.txtOwnerCity.Location = New System.Drawing.Point(432, 144)
        Me.txtOwnerCity.Name = "txtOwnerCity"
        Me.txtOwnerCity.ReadOnly = True
        Me.txtOwnerCity.Size = New System.Drawing.Size(208, 20)
        Me.txtOwnerCity.TabIndex = 0
        '
        'lblOwnerCity
        '
        Me.lblOwnerCity.Location = New System.Drawing.Point(400, 144)
        ...
        'txtOwnersRep
        '
        Me.txtOwnersRep.Location = New System.Drawing.Point(584, 88)
        Me.txtOwnersRep.MaxLength = 256
        Me.txtOwnersRep.Name = "txtOwnersRep"
        Me.txtOwnersRep.Size = New System.Drawing.Size(184, 20)
        Me.txtOwnersRep.TabIndex = 10
        '
        'lblOwnersRap
        '
        Me.lblOwnersRap.Location = New System.Drawing.Point(504, 88)
        ...
        Me.chkCapCandidate.TextAlign = System.Drawing.ContentAlignment.TopLeft
        '
        'lblState
        '
        Me.lblState.Location = New System.Drawing.Point(392, 168)
        ...
        'PnlPics
        '
        Me.PnlPics.Controls.Add(Me.UltraTabStripControl1)
        Me.PnlPics.BringToFront()
        Me.PnlPics.Dock = System.Windows.Forms.DockStyle.Fill
        Me.PnlPics.Location = New System.Drawing.Point(170, 53)
        Me.PnlPics.Name = "PnlPics"
        Me.PnlPics.Size = New System.Drawing.Size(500, 500)
        Me.PnlPics.TabIndex = 190
        Me.PnlPics.Visible = False
        '
        'UltraTabStripControl1
        '
        Me.UltraTabStripControl1.Controls.Add(Me.UltraTabSharedControlsPage1)
        Me.UltraTabStripControl1.Location = New System.Drawing.Point(162, 480)
        ...
        Me.UltraTabStripControl1.Size = New System.Drawing.Size(200, 100)
        Me.UltraTabStripControl1.TabIndex = 12
        '
        ...
        Me.pnlSOC.Dock = System.Windows.Forms.DockStyle.Fill
        Me.pnlSOC.Location = New System.Drawing.Point(0, 0)
        Me.pnlSOC.Name = "pnlSOC"
        Me.pnlSOC.BringToFront()
        ...
        Appearance1.BackColor = System.Drawing.SystemColors.Window
        Appearance1.BorderColor = System.Drawing.SystemColors.InactiveCaption
        Me.ugSOC.DisplayLayout.Appearance = Appearance1
        Me.ugSOC.DisplayLayout.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugSOC.DisplayLayout.CaptionVisible = Infragistics.Win.DefaultableBoolean.[False]
        Appearance2.BackColor = System.Drawing.SystemColors.ActiveBorder
        Appearance2.BackColor2 = System.Drawing.SystemColors.ControlDark
        Appearance2.BackGradientStyle = Infragistics.Win.GradientStyle.Vertical
        Appearance2.BorderColor = System.Drawing.SystemColors.Window
        Me.ugSOC.DisplayLayout.GroupByBox.Appearance = Appearance2
        Appearance3.ForeColor = System.Drawing.SystemColors.GrayText
        Me.ugSOC.DisplayLayout.GroupByBox.BandLabelAppearance = Appearance3
        Me.ugSOC.DisplayLayout.GroupByBox.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.ugSOC.DisplayLayout.GroupByBox.Hidden = True
        Appearance4.BackColor = System.Drawing.SystemColors.ControlLightLight
        Appearance4.BackColor2 = System.Drawing.SystemColors.Control
        Appearance4.BackGradientStyle = Infragistics.Win.GradientStyle.Horizontal
        Appearance4.ForeColor = System.Drawing.SystemColors.GrayText
        Me.ugSOC.DisplayLayout.GroupByBox.PromptAppearance = Appearance4
        Me.ugSOC.DisplayLayout.MaxColScrollRegions = 1
        Me.ugSOC.DisplayLayout.MaxRowScrollRegions = 1
        Appearance5.BackColor = System.Drawing.SystemColors.Window
        Appearance5.ForeColor = System.Drawing.SystemColors.ControlText
        Me.ugSOC.DisplayLayout.Override.ActiveCellAppearance = Appearance5
        'Appearance6.BackColor = System.Drawing.SystemColors.Highlight
        'Appearance6.ForeColor = System.Drawing.SystemColors.HighlightText
        'Me.ugSOC.DisplayLayout.Override.ActiveRowAppearance = Appearance6
        Me.ugSOC.DisplayLayout.Override.BorderStyleCell = Infragistics.Win.UIElementBorderStyle.Dotted
        Me.ugSOC.DisplayLayout.Override.BorderStyleRow = Infragistics.Win.UIElementBorderStyle.Dotted
        Appearance7.BackColor = System.Drawing.SystemColors.Window
        Me.ugSOC.DisplayLayout.Override.CardAreaAppearance = Appearance7
        Appearance8.BorderColor = System.Drawing.Color.Silver
        Appearance8.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter
        Me.ugSOC.DisplayLayout.Override.CellAppearance = Appearance8
        Me.ugSOC.DisplayLayout.Override.CellClickAction = Infragistics.Win.UltraWinGrid.CellClickAction.EditAndSelectText
        Me.ugSOC.DisplayLayout.Override.CellPadding = 0
        Appearance9.BackColor = System.Drawing.SystemColors.Control
        Appearance9.BackColor2 = System.Drawing.SystemColors.ControlDark
        Appearance9.BackGradientAlignment = Infragistics.Win.GradientAlignment.Element
        Appearance9.BackGradientStyle = Infragistics.Win.GradientStyle.Horizontal
        Appearance9.BorderColor = System.Drawing.SystemColors.Window
        Me.ugSOC.DisplayLayout.Override.GroupByRowAppearance = Appearance9
        Appearance10.TextHAlignAsString = "Left"
        Me.ugSOC.DisplayLayout.Override.HeaderAppearance = Appearance10
        Me.ugSOC.DisplayLayout.Override.HeaderClickAction = Infragistics.Win.UltraWinGrid.HeaderClickAction.SortMulti
        Me.ugSOC.DisplayLayout.Override.HeaderStyle = Infragistics.Win.HeaderStyle.WindowsXPCommand
        Appearance11.BackColor = System.Drawing.SystemColors.Window
        Appearance11.BorderColor = System.Drawing.Color.Silver
        Me.ugSOC.DisplayLayout.Override.RowAppearance = Appearance11
        Me.ugSOC.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.[False]
        Appearance12.BackColor = System.Drawing.SystemColors.ControlLight
        Me.ugSOC.DisplayLayout.Override.TemplateAddRowAppearance = Appearance12
        Me.ugSOC.DisplayLayout.ScrollBounds = Infragistics.Win.UltraWinGrid.ScrollBounds.ScrollToFill
        Me.ugSOC.DisplayLayout.ScrollStyle = Infragistics.Win.UltraWinGrid.ScrollStyle.Immediate
        Me.ugSOC.DisplayLayout.ViewStyleBand = Infragistics.Win.UltraWinGrid.ViewStyleBand.OutlookGroupBy
        Me.ugSOC.Dock = System.Windows.Forms.DockStyle.Fill
        Me.ugSOC.Location = New System.Drawing.Point(0, 0)
        Me.ugSOC.BringToFront()
        Me.ugSOC.Name = "ugSOC"
        Me.ugSOC.Size = New System.Drawing.Size(903, 1104)
        Me.ugSOC.TabIndex = 52
        Me.ugSOC.Text = "UltraGrid1"
        '
        'UltraDataSource1
        '
        Me.UltraDataSource1.Band.Columns.AddRange(New Object() {UltraDataColumn25, UltraDataColumn26, UltraDataColumn27, UltraDataColumn28, UltraDataColumn29, UltraDataColumn30, UltraDataColumn31, UltraDataColumn32, UltraDataColumn33, UltraDataColumn34, UltraDataColumn35, UltraDataColumn36, UltraDataColumn37, UltraDataColumn38, UltraDataColumn39, UltraDataColumn40, UltraDataColumn41, UltraDataColumn42, UltraDataColumn43, UltraDataColumn44, UltraDataColumn45, UltraDataColumn46, UltraDataColumn47, UltraDataColumn48})
        '
        'CheckList
        '
        ...
        CType(Me.ugOther, System.ComponentModel.ISupportInitialize).EndInit()
        ...
        Me.PnlCapValues.ResumeLayout(False)
        Me.Panel16.ResumeLayout(False)
        Me.PnlSketch.ResumeLayout(False)
        Me.Panel8.ResumeLayout(False)
        CType(Me.pctSketchPad, System.ComponentModel.ISupportInitialize).EndInit()
        Me.pctSketchPad.ResumeLayout(False)
        ...
        Me.pnlMasterDetailsTop.PerformLayout()
...
#Region "UI Support Routines"
    Private Sub HideVisiblePanels(ByVal bolActivePanel As Boolean, ByRef pnlActivePanel As Panel)
        Try
            ...
            If PnlCapValues.Visible AndAlso Not pnlActivePanel Is PnlCapValues Then

                If Not controlCapEntry Is Nothing AndAlso controlCapEntry.CheckForDirtyScreen Then
                    ToggleButtonAppearance(Me.BtnCapView)
                    Exit Sub
                End If
    ...
    Private Sub LoadChecklistMaster()
        Try
            ...
            'oSketch.Retrieve(oInspection.InspectionInfo, 0)
            txtFacilityName.Text = oInspection.CheckListMaster.Owner.Facilities.Name
            txtDesOp.Text = oInspection.CheckListMaster.Owner.Facilities.DesignatedOperator
            ...
            Dim ds As DataSet = oInspection.CheckListMaster.Owner.RunSQLQuery("exec spGetOwnerFacilityPastDueList " + oInspection.OwnerID.ToString + "," + oInspection.FacilityID.ToString + "")
            ...
            ds = oInspection.CheckListMaster.Owner.RunSQLQuery("exec spGetOwnerFacilityPastDueList " + oInspection.OwnerID.ToString + " ,NULL")
            If Not ds Is Nothing AndAlso ds.Tables.Count > 0 AndAlso ds.Tables(0).Rows.Count > 0 AndAlso ds.Tables(0).Rows(0)(3) > 0 Then
                strFees = ds.Tables(0).Rows(0)(3)
                strFees = strFees.Split(".")(0)
            Else
            ...
            If (ugInspector Is Nothing) Then
                ugInspector = New Infragistics.Win.UltraWinGrid.UltraGrid()
            End If
            ...
            ugInspector.DisplayLayout.Override.AllowDelete = Infragistics.Win.DefaultableBoolean.True
            ugInspector.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.True
        Catch ex As Exception
            Dim MyErr As New ErrorReport(ex)
            MyErr.ShowDialog()
        End Try
    ...
    Private Sub SetupGrid(ByRef ug As Infragistics.Win.UltraWinGrid.UltraGrid)
        ...
        Try
            ...
            'SS commented below
            'If ugOther Is Nothing Then
            '    ugOther = New Infragistics.Win.UltraWinGrid.UltraGrid()
            'End If
            ...
            For Each ugcol In ug.DisplayLayout.Bands(0).Columns
                Select Case (ugcol.Key)
                    ...
                    Case "CCAT"
                        ...
                        If ug.Name = ugOther.Name Then
                            ug.DisplayLayout.Bands(0).Columns("CCAT").Hidden = True
                            ug.DisplayLayout.Bands(0).Columns("Question").Width = 585
                        End If
                    ...
                    Case "Yes"
                        ...
                        'End If
                    Case "N/A"
                        ug.DisplayLayout.Bands(0).Columns("N/A").Width = 50
                        ug.DisplayLayout.Bands(0).Columns("N/A").SortIndicator = Infragistics.Win.UltraWinGrid.SortIndicator.Disabled
                        'If ug.Name <> ugSOC.Name Then
                        '    hasYesNo = True
                        'End If
            ...
            '  If ug.Name = ugOther.Name Then
            '     ug.DisplayLayout.Bands(0).Columns("Yes").Header.Caption = "True"
            '     ug.DisplayLayout.Bands(0).Columns("No").Header.Caption = "False"
            '     ug.DisplayLayout.Bands(0).Columns("N/A").Hidden = True
            '  End If
    ...
    Private Sub SetupInspector(Optional ByVal [readOnly] As Boolean = False)
        ...
        Try
            ...
            If vListTime Is Nothing Then
                ...
                Next
                vListTime.ValueListItems.RemoveAt(0)
            End If
    ...
    Private Sub PrepTankPipeTerm()
        ...
        Try
            dsSet = oInspection.CheckListMaster.TanksPipesTables(oInspection.FacilityID, oInspection.ID)
            ToggleButtonAppearance(btnTanksPipes)
            HideVisiblePanels(True, pnlTanksPipes)
            If Me.ugTanks Is Nothing Then
                Me.ugTanks = New Infragistics.Win.UltraWinGrid.UltraGrid()
            End If
            If Not dsSet Is Nothing And dsSet.Tables.Count > 0 Then
                ...
                If Me.ugPipes Is Nothing Then
                    Me.ugPipes = New Infragistics.Win.UltraWinGrid.UltraGrid()
                End If
                If Me.ugTerminations Is Nothing Then
                    Me.ugTerminations = New Infragistics.Win.UltraWinGrid.UltraGrid()
                End If
    ...
    Private Sub ReLoadCapEntry()
        ...
        With pnlCapEntryView
            .Visible = False

            If Not controlCapEntry Is Nothing Then

                RemoveHandler controlCapEntry.CapChanged, AddressOf SaveDataInCap
            ...
            If oInspection.OwnerID > 0 AndAlso oInspection.FacilityID > 0 AndAlso Not bolReadOnly Then
                controlCapEntry = New CapEntry(oInspection.OwnerID, oInspection.FacilityID, Me.CallingForm, IIf(MusterContainer.AppUser.HEAD_INSPECTION And oInspection.SubmittedDate > "1/1/1960", False, True))

                If Not oInspection.CAPDatesEntered Then
                    controlCapEntry.CleanFieldsOnLoad = True
                End If
                ...
                AddHandler controlCapEntry.CapChanged, AddressOf SaveDataInCap

                If bolReadOnly Then
                    controlCapEntry.Enabled = False
                End If
    ...
    Private Sub PrepCapView()

        Try

            ToggleButtonAppearance(BtnCapView)

            ReLoadCapEntry()

            HideVisiblePanels(True, Me.PnlCapValues)
    ...
    Private Sub SetupTankPipeTerm(Optional ByVal grid As TankPipeTermGrid = TankPipeTermGrid.All, Optional ByVal [readOnly] As Boolean = False)
        ...
        Try
            If grid = TankPipeTermGrid.Tank Or grid = TankPipeTermGrid.All Then
                ...
                ugTanks.DisplayLayout.Bands(0).Columns("Tank #").SortIndicator = Infragistics.Win.UltraWinGrid.SortIndicator.Ascending
                For g As Integer = 0 To 0
                    'If ugTanks.DisplayLayout.Bands(g).Columns.Contains("Tank #") Then
                    ...
                    ugTanks.DisplayLayout.Bands(g).Columns("INSPECTIOn_ID").Hidden = True

                    'SIZE
                    ugTanks.DisplayLayout.Bands(g).Columns("SIZE").MaskInput = "nnn,nnn,nnn"
                    ugTanks.DisplayLayout.Bands(g).Columns("SIZE").NullText = "Unknown"
                ...
                For g As Integer = 0 To 0
                    ...
                    End If
                    '' Fuel Type
                    Dim vListCompFuelType As Infragistics.Win.ValueList
                    ...
                    Dim vlistcoptions As Infragistics.Win.ValueList
                    If ugTanks.DisplayLayout.Bands(g).Columns("options").ValueList Is Nothing Then
                        vlistcoptions = New Infragistics.Win.ValueList
                        For Each row As DataRow In oTank.PopulateTankSecondaryOption.Rows
                            vlistcoptions.ValueListItems.Add(row.Item("property_id"), row.Item("property_name").ToString)
                        Next
                        ugTanks.DisplayLayout.Bands(g).Columns("options").ValueList = vlistcoptions
                    End If
                    'cp_type
                    Dim vlistcptype As Infragistics.Win.ValueList
                    If ugTanks.DisplayLayout.Bands(g).Columns("cp type").ValueList Is Nothing Then
                        vlistcptype = New Infragistics.Win.ValueList
                        For Each row As DataRow In oTank.PopulateTankCPType.Rows
                            vlistcptype.ValueListItems.Add(row.Item("property_id"), row.Item("property_name").ToString)
                        Next
                        ugTanks.DisplayLayout.Bands(g).Columns("cp type").ValueList = vlistcptype
                    End If
            ...
            If grid = TankPipeTermGrid.Pipe Or grid = TankPipeTermGrid.All Then
                ...
                ugPipes.DisplayLayout.Bands(0).Columns("Pipe #").SortIndicator = Infragistics.Win.UltraWinGrid.SortIndicator.Ascending
                For g As Integer = 0 To 0
                    'If ugPipes.DisplayLayout.Bands(g).Columns.Contains("PARENT_PIPE_ID") Then
                    ...
                    ugPipes.DisplayLayout.Bands(g).Columns("INSPECTIOn_ID").Hidden = True
                ...
                For Each dr In ugPipes.Rows
                    ...
                    If dr.HasChild Then
                        ...
                        For Each dr2 As Infragistics.Win.UltraWinGrid.UltraGridRow In dr.ChildBands(0).Rows
                            SetupTankPipeTermRow(TankPipeTermGrid.Pipe, dr2, [readOnly], oTank, oPipe)
            ...
            If grid = TankPipeTermGrid.Term Or grid = TankPipeTermGrid.All Then
                ...
                ugTerminations.DisplayLayout.Bands(0).Columns("Pipe #").SortIndicator = Infragistics.Win.UltraWinGrid.SortIndicator.Ascending
                For g As Integer = 0 To 0
                    'If ugTerminations.DisplayLayout.Bands(g).Columns.Count > 0 Then
                    '    If ugTerminations.DisplayLayout.Bands(g).Columns.Contains("Pipe #") Then
                    ...
                    ugTerminations.DisplayLayout.Bands(g).Columns("INSPECTIOn_ID").Hidden = True
                ...
                For g As Integer = 0 To 0
                    ' populate the whole column as the table is the same for each row
                    ' Type Term @ Dispenser
                    'If ugTerminations.DisplayLayout.Bands(g).Columns.Contains("TYPE TERM@DISP") Then
                    ...
                    ' Type Term @ Tank
                    'If ugTerminations.DisplayLayout.Bands(g).Columns.Contains("TYPE TERM@TANK") Then
                    ...
                    ' Dispenser Term CP
                    ' If ugTerminations.DisplayLayout.Bands(g).Columns.Contains("DISP. TERM CP") Then
                    ...
                    ' Tank Term CP
                    ' If ugTerminations.DisplayLayout.Bands(g).Columns.Contains("TANK TERM CP") Then
                ...
                For Each dr In ugTerminations.Rows
                    ...
                    If dr.HasChild Then
                        ...
                        For Each dr2 As Infragistics.Win.UltraWinGrid.UltraGridRow In dr.ChildBands(0).Rows
                            SetupTankPipeTermRow(TankPipeTermGrid.Term, dr2, [readOnly], oTank, oPipe)
                            dr2.Appearance.BackColor = Color.LightSkyBlue
                        Next
                    End If
                Next
            ...
            If grid = TankPipeTermGrid.Tank Or grid = TankPipeTermGrid.All Then
                If ugTanks.DisplayLayout.Bands(0).Columns.Count > 0 Then
                    ugTanks.DisplayLayout.Bands(0).Columns("CP TESTED").CellActivation = Infragistics.Win.UltraWinGrid.Activation.NoEdit
                    ugTanks.DisplayLayout.Bands(0).Columns("LINING INSPECTED").CellActivation = Infragistics.Win.UltraWinGrid.Activation.NoEdit
                    '   ugTanks.DisplayLayout.Bands(0).Columns("TANK SEC INSP").Hidden = True
                    ugTanks.DisplayLayout.Bands(0).Columns("PTT").CellActivation = Infragistics.Win.UltraWinGrid.Activation.NoEdit
                    ugTanks.DisplayLayout.Bands(0).Columns("SPILL TESTED").CellActivation = Infragistics.Win.UltraWinGrid.Activation.NoEdit
                    ugTanks.DisplayLayout.Bands(0).Columns("OVERFILL TESTED").CellActivation = Infragistics.Win.UltraWinGrid.Activation.NoEdit
                    ugTanks.DisplayLayout.Bands(0).Columns("TANK ELEC INSP").CellActivation = Infragistics.Win.UltraWinGrid.Activation.NoEdit
                    ugTanks.DisplayLayout.Bands(0).Columns("ATG INSP").CellActivation = Infragistics.Win.UltraWinGrid.Activation.NoEdit
                End If
            End If
            ...
            If grid = TankPipeTermGrid.Pipe Or grid = TankPipeTermGrid.All Then
                ...
                For g As Integer = 0 To 0
                    If ugPipes.DisplayLayout.Bands(g).Columns.Count > 0 Then
                        ugPipes.DisplayLayout.Bands(g).Columns("CP TESTED").CellActivation = Infragistics.Win.UltraWinGrid.Activation.NoEdit
                        ugPipes.DisplayLayout.Bands(g).Columns("ALLD TESTED").CellActivation = Infragistics.Win.UltraWinGrid.Activation.NoEdit
                        ugPipes.DisplayLayout.Bands(g).Columns("PTT").CellActivation = Infragistics.Win.UltraWinGrid.Activation.NoEdit
                        ugPipes.DisplayLayout.Bands(g).Columns("SHEAR TEST").CellActivation = Infragistics.Win.UltraWinGrid.Activation.NoEdit
                        ugPipes.DisplayLayout.Bands(g).Columns("PIPE SEC INSP").CellActivation = Infragistics.Win.UltraWinGrid.Activation.NoEdit
                        ugPipes.DisplayLayout.Bands(g).Columns("PIPE ELEC INSP").CellActivation = Infragistics.Win.UltraWinGrid.Activation.NoEdit
                    End If
                Next
    ...
    Private Sub SetupTankPipeTermRow(ByVal grid As TankPipeTermGrid, ByRef dr As Infragistics.Win.UltraWinGrid.UltraGridRow, Optional ByVal [readOnly] As Boolean = False, Optional ByVal pTank As MUSTER.BusinessLogic.pTank = Nothing, Optional ByVal pPipe As MUSTER.BusinessLogic.pPipe = Nothing)
        ...
        Try
            ...
            If grid = TankPipeTermGrid.Tank Then
                ...
                ' Contents
                If dr.Cells.Contains("CONTENTS") Then
                ...
                End If
                ' Fuel Type
                If dr.Cells.Contains("CONTENTS") And dr.Cells.Contains("FUEL TYPE") Then
                    ...
                    Else
                        ...
                        Else
                            ...
                            If dtFuelType.Rows.Count > 0 Then
                ...
                ' Material Of Construction
                If dr.Cells.Contains("MATERIALS") Then
                    ...
                    If dr.Cells.Contains("OPTIONS") Then
                ...
                ' if Used oil or small delievery, then disable all new date fields

                If dr.Cells("CONTENTS").Value Is DBNull.Value Or dr.Cells("STATUS").Value Is DBNull.Value Or dr.Cells("CONTENTS").Value = 314 Or pTank.SmallDelivery Or dr.Cells("STATUS").Value <> "Currently In Use" Then    '314 = Used oil or small delievery
                    dr.Cells("SPILL INSTALLED").Hidden = True
                    dr.Cells("SPILL TESTED").Hidden = True
                    dr.Cells("OVERFILL INSTALLED").Hidden = True
                    dr.Cells("OVERFILL TESTED").Hidden = True
                    '  dr.Cells("TANK SEC INSP").Hidden = True
                    dr.Cells("TANK ELEC INSP").Hidden = True
                    dr.Cells("ATG INSP").Hidden = True
                    dr.Cells("SPILL INSTALLED").Value = DBNull.Value
                    UIUtilsGen.FillDateobjectValues(oTank.DateSpillInstalled, dtNullDate)
                    dr.Cells("SPILL TESTED").Value = DBNull.Value
                    UIUtilsGen.FillDateobjectValues(oTank.DateSpillTested, dtNullDate)
                    dr.Cells("OVERFILL INSTALLED").Value = DBNull.Value
                    UIUtilsGen.FillDateobjectValues(oTank.DateOverfillInstalled, dtNullDate)
                    dr.Cells("OVERFILL TESTED").Value = DBNull.Value
                    UIUtilsGen.FillDateobjectValues(oTank.DateOverfillTested, dtNullDate)
                    '   dr.Cells("TANK SEC INSP").Value = DBNull.Value
                    'UIUtilsGen.FillDateobjectValues(oTank.DateTankSecInsp, dtNullDate)
                    dr.Cells("TANK ELEC INSP").Value = DBNull.Value
                    UIUtilsGen.FillDateobjectValues(oTank.DateTankElecInsp, dtNullDate)
                    dr.Cells("ATG INSP").Value = DBNull.Value
                    UIUtilsGen.FillDateobjectValues(oTank.DateATGInsp, dtNullDate)
                Else
                    dr.Cells("SPILL INSTALLED").Hidden = False
                    dr.Cells("SPILL TESTED").Hidden = False
                    dr.Cells("OVERFILL INSTALLED").Hidden = False
                    dr.Cells("OVERFILL TESTED").Hidden = False
                    '  dr.Cells("TANK SEC INSP").Hidden = True
                    dr.Cells("TANK ELEC INSP").Hidden = True
                    dr.Cells("ATG INSP").Hidden = True
                    'If Not dr.Cells("LEAK DETECTION").Value Is DBNull.Value Then
                    'If dr.Cells("LEAK DETECTION").Value = 343 Then '343-Visual 
                    'dr.Cells("TANK SEC INSP").Hidden = False
                    'Else
                    '   dr.Cells("TANK SEC INSP").Value = DBNull.Value
                    '  UIUtilsGen.FillDateobjectValues(oTank.DateTankSecInsp, dtNullDate)
                    'End If
                    ...
                    If Not dr.Cells("LEAK DETECTION").Value Is DBNull.Value Then
                        ...
                        If dr.Cells("LEAK DETECTION").Value = 339 Then ' 339-Electric
                            dr.Cells("TANK ELEC INSP").Hidden = False
                        Else
                            dr.Cells("TANK ELEC INSP").Value = DBNull.Value
                            UIUtilsGen.FillDateobjectValues(oTank.DateTankElecInsp, dtNullDate)
                        End If
                    End If
                    If Not dr.Cells("LEAK DETECTION").Value Is DBNull.Value Then
                        If dr.Cells("LEAK DETECTION").Value = 336 Then '336 - Automatic
                            dr.Cells("ATG INSP").Hidden = False
                        Else
                            dr.Cells("ATG INSP").Value = DBNull.Value
                            UIUtilsGen.FillDateobjectValues(oTank.DateATGInsp, dtNullDate)
                        End If
                    ...
                    If Not oInspection.CAPDatesEntered Then
                        dr.Cells("SPILL TESTED").Value = DBNull.Value
                        If bolUpdateObject And Not bolCheckListPrinting Then
                            If Date.Compare(pTank.DateSpillTested, dtNullDate) <> 0 Then
                                pTank.DateSpillTested = dtNullDate
                                regenerateCheckListItems = True
                            End If
                        End If
                    End If
                    If Not oInspection.CAPDatesEntered Then
                        dr.Cells("OVERFILL TESTED").Value = DBNull.Value
                        If bolUpdateObject And Not bolCheckListPrinting Then
                            If Date.Compare(pTank.DateOverfillTested, dtNullDate) <> 0 Then
                                pTank.DateOverfillTested = dtNullDate
                                regenerateCheckListItems = True
                            End If
                        End If
                    End If
                    ...
                    'dr.Cells("TANK SEC INSP").Value = DBNull.Value
                    'If bolUpdateObject And Not bolCheckListPrinting Then
                    'If Date.Compare(pTank.DateTankSecInsp, dtNullDate) <> 0 Then
                    'pTank.DateTankSecInsp = dtNullDate
                    'regenerateCheckListItems = True
                    'End If
                    'End If
                    'End If
                    ...
                    If Not oInspection.CAPDatesEntered Then
                        ...
                        dr.Cells("TANK ELEC INSP").Value = DBNull.Value
                        If bolUpdateObject And Not bolCheckListPrinting Then
                            If Date.Compare(pTank.DateTankElecInsp, dtNullDate) <> 0 Then
                                pTank.DateTankElecInsp = dtNullDate
                                regenerateCheckListItems = True
                            End If
                        End If
                    End If
                    If Not oInspection.CAPDatesEntered Then
                        dr.Cells("ATG INSP").Value = DBNull.Value
                        If bolUpdateObject And Not bolCheckListPrinting Then
                            If Date.Compare(pTank.DateATGInsp, dtNullDate) <> 0 Then
                                pTank.DateATGInsp = dtNullDate
                                regenerateCheckListItems = True
                            End If
                        End If
                    End If
                ...
                Else
                    ...
                    dt = pTank.PopulateTankReleaseDetection(dr.Cells("OPTIONS").Value, IIf(dr.Cells("SIZE").Value Is DBNull.Value, 0, dr.Cells("SIZE").Value), IIf(dr.Cells("INSTALLED").Value > New Date(2008, 9, 30), True, False))
                    If Not (dt Is Nothing) Then
                        For Each row As DataRow In dt.Rows
                ...
                Else
                    ' #2889
                    If dr.Cells.Contains("OVERFILL TYPE") Then
            ...
            ElseIf grid = TankPipeTermGrid.Pipe Then
                    ...
                    For Each row As DataRow In pPipe.PopulatePipeStatusShort("EDIT").Rows
                    ...
                    ' Pipe Shear Tested Date     Pipe Type is Pressurized - 266
                    ' Pipe Seconary Test Date    Pipe LD is Visual Intersttial Monitoring 242
                    ' Pipe Elec Test Date        Pipe LD is Continuous Interstital Monitoring 243

                    If dr.Cells("STATUS").Value Is DBNull.Value OrElse dr.Cells("STATUS").Value <> 424 Then
                        dr.Cells("SHEAR TEST").Hidden = True
                        dr.Cells("PIPE SEC INSP").Hidden = True
                        dr.Cells("PIPE ELEC INSP").Hidden = True
                        dr.Cells("SHEAR TEST").Value = DBNull.Value
                        UIUtilsGen.FillDateobjectValues(oPipe.DateShearTest, dtNullDate)
                        dr.Cells("PIPE SEC INSP").Value = DBNull.Value
                        UIUtilsGen.FillDateobjectValues(oPipe.DatePipeSecInsp, dtNullDate)
                        dr.Cells("PIPE ELEC INSP").Value = DBNull.Value
                        UIUtilsGen.FillDateobjectValues(oPipe.DatePipeElecInsp, dtNullDate)
                    Else
                        dr.Cells("SHEAR TEST").Hidden = True
                        dr.Cells("PIPE SEC INSP").Hidden = True
                        dr.Cells("PIPE ELEC INSP").Hidden = True
                        If Not dr.Cells("TYPE OF SYSTEM").Value Is DBNull.Value Then
                            If dr.Cells("TYPE OF SYSTEM").Value = 266 Then
                                dr.Cells("SHEAR TEST").Hidden = False
                            Else
                                dr.Cells("SHEAR TEST").Value = DBNull.Value
                                UIUtilsGen.FillDateobjectValues(oPipe.DateShearTest, dtNullDate)
                            End If
                        End If
                        If Not dr.Cells("PRI. LEAK DETECTION").Value Is DBNull.Value Then
                            If dr.Cells("PRI. LEAK DETECTION").Value = 242 Then
                                dr.Cells("PIPE SEC INSP").Hidden = False
                            Else
                                dr.Cells("PIPE SEC INSP").Value = DBNull.Value
                                UIUtilsGen.FillDateobjectValues(oPipe.DatePipeSecInsp, dtNullDate)
                            End If
                        End If
                        If Not dr.Cells("PRI. LEAK DETECTION").Value Is DBNull.Value Then
                            If dr.Cells("PRI. LEAK DETECTION").Value = 243 Then
                                dr.Cells("PIPE ELEC INSP").Hidden = False
                            Else
                                dr.Cells("PIPE ELEC INSP").Value = DBNull.Value
                                UIUtilsGen.FillDateobjectValues(oPipe.DatePipeElecInsp, dtNullDate)
                            End If
                        ...
                        If Not oInspection.CAPDatesEntered Then
                            dr.Cells("SHEAR TEST").Value = DBNull.Value
                            If bolUpdateObject And Not bolCheckListPrinting Then
                                If Date.Compare(pPipe.DateShearTest, dtNullDate) <> 0 Then
                                    pPipe.DateShearTest = dtNullDate
                                    regenerateCheckListItems = True
                                End If
                            End If
                        End If
                        If Not oInspection.CAPDatesEntered Then
                            dr.Cells("PIPE SEC INSP").Value = DBNull.Value
                            If bolUpdateObject And Not bolCheckListPrinting Then
                                If Date.Compare(pPipe.DatePipeSecInsp, dtNullDate) <> 0 Then
                                    pPipe.DatePipeSecInsp = dtNullDate
                                    regenerateCheckListItems = True
                                End If
                            End If
                        End If
                        If Not oInspection.CAPDatesEntered Then
                            dr.Cells("PIPE ELEC INSP").Value = DBNull.Value
                            If bolUpdateObject And Not bolCheckListPrinting Then
                                If Date.Compare(pPipe.DatePipeElecInsp, dtNullDate) <> 0 Then
                                    pPipe.DatePipeElecInsp = dtNullDate
                                    regenerateCheckListItems = True
                                End If
                            End If
                        End If
                    ...
                    If Not vListType.FindByDataValue(dr.Cells("TYPE OF SYSTEM").Value) Is Nothing Then
                        If vListType.FindByDataValue(dr.Cells("TYPE OF SYSTEM").Value).DisplayText.IndexOf("Pressurized") > -1 Then
                            ...
                            dt = New DataTable
                            dt = pPipe.PopulatePipeReleaseDetection1(pPipe.PipeLD.ToString, IIf(dr.Cells("OPTIONS").Value Is DBNull.Value, 0, dr.Cells("OPTIONS").Value), IIf(pPipe.PipeInstallDate > New Date(2008, 9, 30), True, False))
                            If Not (dt Is Nothing) Then
                                For Each row As DataRow In dt.Rows
                            ...
                            If Not vListPrimLeak.FindByDataValue(dr.Cells("PRI. LEAK DETECTION").Value) Is Nothing Then
                                ...
                                If Not vListPrimLeak.FindByDataValue(dr.Cells("PRI. LEAK DETECTION").Value).DisplayText.IndexOf("Deferred") > -1 Then
                                    ...
                                    dt = pPipe.PopulatePipeReleaseDetection2(IIf(dr.Cells("PRI. LEAK DETECTION").Value Is DBNull.Value, 0, dr.Cells("PRI. LEAK DETECTION").Value), _
                                                                                IIf(dr.Cells("OPTIONS").Value Is DBNull.Value, 0, dr.Cells("OPTIONS").Value), IIf(pPipe.PipeInstallDate > New Date(2008, 9, 30), True, False))
                                    If Not (dt Is Nothing) Then
                                        For Each row As DataRow In dt.Rows
                                    ...
                                    If Not vListSecLeak.FindByDataValue(dr.Cells("SEC. LEAK DETECTION").Value) Is Nothing Then
                                        If vListSecLeak.FindByDataValue(dr.Cells("SEC. LEAK DETECTION").Value).DisplayText.IndexOf("Mechanical") > -1 Or _
                                        vListSecLeak.FindByDataValue(dr.Cells("SEC. LEAK DETECTION").Value).DisplayText.IndexOf("Electronic") > -1 Then
                        ...
                        ElseIf vListType.FindByDataValue(dr.Cells("TYPE OF SYSTEM").Value).DisplayText.IndexOf("U.S. Suction") > -1 Then
                            ...
                            Dim vListPrimLeak As New Infragistics.Win.ValueList
                            dt = New DataTable
                            dt = pPipe.PopulatePipeReleaseDetection1(pPipe.PipeLD.ToString, IIf(dr.Cells("OPTIONS").Value Is DBNull.Value, 0, dr.Cells("OPTIONS").Value), IIf(dr.Cells("INSTALLED").Value > New Date(2008, 9, 30), True, False))
                            If Not (dt Is Nothing) Then
                                For Each row As DataRow In dt.Rows
                                    vListPrimLeak.ValueListItems.Add(row.Item("PROPERTY_ID"), row.Item("PROPERTY_NAME").ToString)
                                Next
                    ...
                    If (Not (dr.Cells("STATUS").Value Is DBNull.Value)) AndAlso dr.Cells("STATUS").Value = 424 Then
                        dr.Cells("LAST USED").Hidden = True
                        'PipeLastUsedCount += 1
                        If bolUpdateObject And Not bolCheckListPrinting Then
                            ...
                            End If
                        End If
                    ElseIf (Not (dr.Cells("STATUS").Value Is DBNull.Value)) AndAlso dr.Cells("STATUS").Value = 426 Then
                    ...
                    If bolHideTermCPTested Then
                        ...
                        If bolUpdateObject And Not bolCheckListPrinting Then
                            If Date.Compare(pPipe.TermCPLastTested, dtNullDate) <> 0 Then
                                'pPipe.TermCPLastTested = dtNullDateLC
                                regenerateCheckListItems = True
                            End If
        ...
        Try
            ...
            For Each row In ugTanks.Rows
                If row.Appearance.BackColor.Name <> Color.LightGray.Name Then
                    ...
                    If strTankErrRow.Length > 0 AndAlso Not strTankErrRow.StartsWith("Optional") Then
            ...
            For Each row In ugPipes.Rows
                ...
                If strPipeErrRow.Length > 0 AndAlso Not strPipeErrRow.StartsWith("Optional") Then
            ...
            If strErr.Length > 0 Then
                strErr = IIf(allOptionalValidations, "The following field(s) are optional", "The following field(s) are required ") + strErr
            End If

            If allOptionalValidations Then strErr = String.Empty
        ...
        Try
            ...
            For i As Integer = 0 To arrUGName.GetUpperBound(0) - 1
                ...
                Select Case ugName
                    ...
                    Case ugOther.Name
                        ds = New DataSet
                        dTable = oInspection.CheckListMaster.OtherQusetionsTable
                        ds.Tables.Add(dTable)
    ...
    Private Function ValidateAddress() As Boolean
        Try
            AddressForm = New Address(UIUtilsGen.EntityTypes.Facility, oInspection.CheckListMaster.Owner.Facilities.ID, oInspection.CheckListMaster.Owner.Facilities.FacilityAddresses, "Facility", oInspection.CheckListMaster.Owner.AddressId)
        ...
        End Try
    End Function
    Friend Sub PrintCheckList(ByRef doPics As Integer, Optional ByVal strHeaderText As String = "Printing progress", Optional ByVal message As Boolean = True)
        Dim ugrow As Infragistics.Win.UltraWinGrid.UltraGridRow
        Dim ugcell As Infragistics.Win.UltraWinGrid.UltraGridCell
        Dim dsTerms As DataSet
        Dim dtTank, dtPipe As DataSet
        ...
        Try
            startTime = New Date(Now.Year, Now.Month, Now.Day, Now.Hour, Now.Minute, Now.Second)

            btnCapView_Click(Me, Nothing)
            ...
            For Each ugrow In ugTanks.Rows
                ...
                If ugrow.Index = 0 OrElse ugrow.Index Mod 5 = 0 Then
                    dt = New DataTable
                    dtTank.Tables.Add(dt)
                End If

                For Each ugcell In ugrow.Cells
                    If (ugcell.Hidden = False And ugcell.Column.Hidden = False) AndAlso (ugrow.Index = 0 Or ugrow.Index Mod 5 = 0) Then
                        Select Case ugcell.Column.Key.Trim.ToUpper
                            Case "TANK #"
                                dc = dt.Columns.Add("Tank #")
                            Case "COMPARTMENT #"
                                dc = dt.Columns.Add("Comp #")
                            Case "STATUS"
                                dc = dt.Columns.Add("Status")
                            Case "INSTALLED"
                                dc = dt.Columns.Add("Installed")
                                ' Case "PLACED IN SERVICE"
                                '    dtTank.Columns.Add("Placed In Service")
                            Case "SIZE"
                                dc = dt.Columns.Add("Size")
                            Case "CONTENTS"
                                dc = dt.Columns.Add("Contents")
                            Case "FUEL TYPE"
                                dc = dt.Columns.Add("Fuel Type")
                            Case "MATERIALS"
                                dc = dt.Columns.Add("Material of Construction")
                            Case "OPTIONS"
                                dc = dt.Columns.Add("Construction Options")
                            Case "LEAK DETECTION"
                                dc = dt.Columns.Add("Leak Detection")
                            Case "CP TYPE"
                                dc = dt.Columns.Add("CP Type")
                            Case "OVERFILL TYPE"
                                dc = dt.Columns.Add("Overfill Type")
                            Case "LINED"
                                dc = dt.Columns.Add("Lined")
                            Case "LINING INSPECTED"
                                dc = dt.Columns.Add("Lining Inspected")
                            Case "PTT"
                                dc = dt.Columns.Add("TT DATE")
                            Case "CP INSTALLED"
                                dc = dt.Columns.Add("CP Installed")
                            Case "CP TESTED"
                                dc = dt.Columns.Add("Tank CP Tested")
                            Case "SPILL TESTED"
                                dc = dt.Columns.Add("Spill Tested")
                            Case "OVERFILL TESTED"
                                dc = dt.Columns.Add("Overfill Tested")
                                ' Case "TANK SEC INSP"
                                '    dtTank.Columns.Add("Secondary Inspected")
                            Case "TANK ELEC INSP"
                                dc = dt.Columns.Add("Tank Elec Inspected")
                            Case "ATG INSP"
                                dc = dt.Columns.Add("Auto-Tank Gauging Inspected")
                ...
                For Each dtCol In dt.Columns
                    Select Case dtCol.ColumnName
                        ...
                        Case "Spill Tested"
                            strColName = "SPILL TESTED"
                        Case "Overfill Tested"
                            strColName = "OVERFILL TESTED"

                            '  Case "Secondary Inspected"
                            '     strColName = "TANK SEC INSP"
                        Case "Tank Elec Inspected"
                            strColName = "TANK ELEC INSP"
                        Case "Auto-Tank Gauging Inspected"
                            strColName = "ATG INSP"


                    End Select
                    If ugrow.Cells(strColName).Text > String.Empty AndAlso ugrow.Cells(strColName).Hidden = False Then
                        If strColName = "COMPARTMENT #" AndAlso ugrow.Cells(strColName).Text = "N/A" Then
                            dr(dtCol.ColumnName) = "Not Compartmentalized"
                        Else
                            dr(dtCol.ColumnName) = ugrow.Cells(strColName).Text
                        End If
                    ElseIf ugrow.Cells(strColName).Hidden = False Then
                        If Not controlCapEntry Is Nothing AndAlso controlCapEntry.CapDictionary.Contains(String.Format("T{0}_{1}", ugrow.Cells("TANK_ID").Value, dtCol.ColumnName).ToUpper) _
                            AndAlso DirectCast(controlCapEntry.CapDictionary.Item(String.Format("T{0}_{1}", ugrow.Cells("TANK_ID").Value, dtCol.ColumnName).ToUpper), Infragistics.Win.UltraWinGrid.UltraGridCell).Appearance.BackColor.ToString = Color.Red.ToString Then
                            dr(dtCol.ColumnName) = "<CAPNEEDED>"
                        Else
                            dr(dtCol.ColumnName) = String.Empty
                        End If
                    End If
            ...
            For Each ugrow In ugPipes.Rows
                ...
                If index = 0 OrElse index Mod 5 = 0 Then
                    dt = New DataTable
                    dtPipe.Tables.Add(dt)
                End If


                For Each ugcell In ugrow.Cells
                    If (ugcell.Hidden = False And ugcell.Column.Hidden = False) AndAlso (index = 0 Or index Mod 5 = 0) Then
                        Select Case ugcell.Column.Key.Trim.ToUpper
                            Case "PIPE #"
                                dc = dt.Columns.Add("Pipe #")
                            Case "STATUS"
                                dc = dt.Columns.Add("Status")
                            Case "INSTALLED"
                                dc = dt.Columns.Add("Installed")
                            Case "TYPE OF SYSTEM"
                                dc = dt.Columns.Add("Pipe Type")
                            Case "MATERIALS"
                                dc = dt.Columns.Add("Material of Construction")
                            Case "OPTIONS"
                                dc = dt.Columns.Add("Construction Options")
                            Case "BRAND"
                                dc = dt.Columns.Add("Brand")
                            Case "CP TYPE"
                                dc = dt.Columns.Add("CP Type")
                            Case "PRI. LEAK DETECTION"
                                dc = dt.Columns.Add("Primary LD")
                            Case "SEC. LEAK DETECTION"
                                dc = dt.Columns.Add("Secondary LD")
                            Case "ALLD TESTED"
                                dc = dt.Columns.Add("ALLD Tested")
                            Case "PTT"
                                dc = dt.Columns.Add("TT DATE")
                            Case "CP INSTALLED"
                                dc = dt.Columns.Add("CP Installed")
                            Case "CP TESTED"
                                dc = dt.Columns.Add("Pipe CP Tested")
                            Case "SHEAR TEST"
                                dc = dt.Columns.Add("Shear Tested")
                            Case "PIPE SEC INSP"
                                dc = dt.Columns.Add("Secondary Inspected")
                            Case "PIPE ELEC INSP"
                                dc = dt.Columns.Add("Pipe Elec Inspected")
                ...
                For Each dtCol In dt.Columns
                    Select Case dtCol.ColumnName
                        ...
                        Case "Pipe CP Tested"
                            strColName = "CP TESTED"
                        Case "Shear Tested"
                            strColName = "SHEAR TEST"
                        Case "Secondary Inspected"
                            strColName = "PIPE SEC INSP"
                        Case "Pipe Elec Inspected"
                            strColName = "PIPE ELEC INSP"
                    ...
                    ElseIf ugrow.Cells(strColName).Hidden = False Then
                        ...
                        If Not controlCapEntry Is Nothing AndAlso controlCapEntry.CapDictionary.Contains(String.Format("P{0}_{1}", ugrow.Cells("PIPE_ID").Value, dtCol.ColumnName).ToUpper) _
                            AndAlso DirectCast(controlCapEntry.CapDictionary.Item(String.Format("P{0}_{1}", ugrow.Cells("PIPE_ID").Value, dtCol.ColumnName).ToUpper), Infragistics.Win.UltraWinGrid.UltraGridCell).Appearance.BackColor.ToString = Color.Red.ToString Then
                            dr(dtCol.ColumnName) = "<CAPNEEDED>"
                        Else
                            dr(dtCol.ColumnName) = String.Empty
                        End If
                ...
                If ugrow.HasChild Then


                    For Each ugrow2 As Infragistics.Win.UltraWinGrid.UltraGridRow In ugrow.ChildBands(0).Rows
                            ...
                            If (ugcell.Hidden = False And ugcell.Column.Hidden = False) AndAlso (index = 0 Or index Mod 5 = 0) Then
                                Select Case ugcell.Column.Key.Trim.ToUpper
                                    ...
                                    Case "ALLD TESTED"
                                        dc = dt.Columns.Add("ALLD Tested")
                                    Case "TT DATE"
                                        dc = dt.Columns.Add("PTT")
                                    Case "CP INSTALLED"
                                        dc = dt.Columns.Add("CP Installed")
                                    Case "CP TESTED"
                                        dc = dt.Columns.Add("CP Tested")
                                    Case "SHEAR TEST"
                                        dc = dt.Columns.Add("Shear Tested")
                                    Case "PIPE SEC INSP"
                                        dc = dt.Columns.Add("Secondary Inspected")
                        ...
                        For Each dtCol In dt.Columns
                            Select Case dtCol.ColumnName
                                ...
                                Case "Secondary Inspected"
                                    strColName = "PIPE SEC INSP"
                                Case "Electronic Inspected"
                                    strColName = "PIPE ELEC INSP"

                            End Select

                            If ugrow.Cells(strColName).Text > String.Empty AndAlso ugrow.Cells(strColName).Hidden = False Then
                                dr(dtCol.ColumnName) = String.Format("{0}{1}", IIf(dtCol.ColumnName = "Child Pipe #", "CP ", ""), ugrow2.Cells(strColName).Text)
                            ElseIf ugrow.Cells(strColName).Hidden = False Then
                                If Not controlCapEntry Is Nothing AndAlso controlCapEntry.CapDictionary.Contains(String.Format("P{0}_{1}", ugrow.Cells("PIPE_ID").Value, dtCol.ColumnName).ToUpper) _
                                    AndAlso DirectCast(controlCapEntry.CapDictionary.Item(String.Format("P{0}_{1}", ugrow.Cells("PIPE_ID").Value, dtCol.ColumnName).ToUpper), Infragistics.Win.UltraWinGrid.UltraGridCell).Appearance.BackColor.ToString = Color.Red.ToString Then
                                    dr(dtCol.ColumnName) = "<CAPNEEDED>"
            ...
            For Each ugrow In ugTerminations.Rows
                If dsTerms.Tables(ugrow.Cells("PIPE_ID").Text) Is Nothing Then
                    ...
                    For Each dtCol In dtTerm.Columns
                        ...
                        If ugrow.Cells(strColName).Text > String.Empty AndAlso ugrow.Cells(strColName).Hidden = False Then
                            dr(dtCol.ColumnName) = String.Format("{0}{1}", IIf(dtCol.ColumnName = "Child Pipe #", "CP ", ""), ugrow.Cells(strColName).Text)
                        ElseIf ugrow.Cells(strColName).Hidden = False Then
                            If Not controlCapEntry Is Nothing AndAlso controlCapEntry.CapDictionary.Contains(String.Format("P{0}_{1}", ugrow.Cells("PIPE_ID").Value, dtCol.ColumnName).ToUpper) _
                                AndAlso DirectCast(controlCapEntry.CapDictionary.Item(String.Format("P{0}_{1}", ugrow.Cells("PIPE_ID").Value, dtCol.ColumnName).ToUpper), Infragistics.Win.UltraWinGrid.UltraGridCell).Appearance.BackColor.ToString = Color.Red.ToString Then
                                dr(dtCol.ColumnName) = "<CAPNEEDED>"
            ...
            Dim designatedOperator As String = txtDesOp.Text

            Dim wordapp As Word.Application
            wordapp = oLetter.GenerateInspectionCheckList(oInspection.CheckListMaster.Owner.Facilities.ID, "Inspection CheckList", "CheckList", "Facility Inspection CheckList", "InspectionCheckList.doc", oInspection, dtTank, dtPipe, dsTerms, ltrGen, frmCLProgress.ProgressBarValue, GetFlagsForPrintedChecklist(), oInspection.CheckListMaster.Owner.Facilities, String.Empty, designatedOperator, getImagesForPrintOut(doPics))
            ' Delay after closing a word document to resolve RPC Server is Unavailable Issue
            'UIUtilsGen.Delay(, 1)

            If Not wordapp Is Nothing AndAlso message = True Then
                MsgBox("Printing of checklist completed.")
    ...
    Private Sub SaveSOCValuesToObject()
        ...
        Dim notCompliantToBeDesignatedOperator As Boolean = False
...
#Region "Sketch"
    ...
    Private Sub SetupSketchPad(ByVal sketch As BusinessLogic.pInspectionSketch)
        ...
        Try
            ...
            oFilePath.Retrieve(UIUtilsGen.FilePathKey_Sketches)


            If Not oFilePath Is Nothing Then
                filename = String.Format("{0}\{1}.ppt", oFilePath.FilePath, oInspection.ID)
            Else
                Throw New Exception("File path for Sketches not found. Please insert profile record for Sketches")
            End If

            If _container.AppUser.ID = oInspection.CreatedBy Then
                btnSavePic.Enabled = True
            End If
            '  MsgBox("here 3")


            If sketch.ID <= 0 OrElse filename.Length = 0 OrElse Not System.IO.File.Exists(filename) Then


                btnSavePic.Text = "Create PowerPoint Sketch"
            Else
                ' MsgBox("here 1")
                LoadPowerPointImage(filename, Me.pctSketchPad)
                '  MsgBox("here 2")
                btnSavePic.Text = "Edit PowerPoint Sketch"
    ...
    Public Function getImagesForPrintOut(ByRef doPics As Integer) As Collections.ArrayList
        Dim oFilePath As New MUSTER.BusinessLogic.pFilePaths

        Try

            Dim PIC_PATH As String = String.Format("{0}\", MusterContainer.ProfileData.Retrieve(UIUtilsGen.FilePathKey_FacImages).ProfileValue)
            Dim PIC_PATH2 As String = String.Format("{0}\", MusterContainer.ProfileData.Retrieve(UIUtilsGen.FilePathKey_Sketches).ProfileValue)
            Dim images As Collections.ArrayList

            If Not PIC_PATH Is Nothing Then

                oFilePath.Retrieve(UIUtilsGen.FilePathKey_FacImages)

                If Not oFilePath Is Nothing Then

                    oInspection.CheckListMaster.LoadFacilityPics(PIC_PATH, oInspection.ID)

                    If Not oInspection.CheckListMaster.facpics Is Nothing AndAlso oInspection.CheckListMaster.facpics.Count > 0 Then

                        images = New Collections.ArrayList

                        For Each item As IO.FileInfo In oInspection.CheckListMaster.facpics
                            images.Add(UIUtilsGen.GetThumbnail(item.FullName))
                        Next

                        If (doPics = 0 AndAlso MsgBox("Would you like to add the facility pics to your print out(s)", MsgBoxStyle.YesNo) = MsgBoxResult.Yes) Or doPics = 1 Then

                            doPics = 1
                            Return images
                        ElseIf doPics = 2 Then
                            Return Nothing
                        End If
                    Else
                        Return Nothing
                ...
                Else
                    Throw New Exception("File path for Facility pics not found. Please insert profile record for facility Pics")
                End If
    ...
    Private Sub SetupPics(ByVal fileArray As Collections.ArrayList)
        ...
        Try
            ...
            Dim pnlUpload
            Dim DisplayBig As New PictureBox
            Dim inspdate As DateTime

            If Not removeFileButton Is Nothing Then
                RemoveHandler removeFileButton.Fileremoved, AddressOf btnfacpics_Click
            End If

            removeFileButton = New FileRemovalButton


            inspdate = oInspection.CheckListMaster.GetThisInspectionDate

            If inspdate < "1/1/1930" Then
                inspdate = New Date(Now.Year, Now.Month, Now.Day).AddDays(-1)
            End If



            pnl.Top = 65
            pnl.Height = PnlPics.Height - 75
            pnl.Left = 10
            pnl.Width = PnlPics.Width - 20
            pnl.Name = "PnlOfPnlPics"
            ...
            Me.PnlPics.Controls.Clear()

            uploadMaster = Nothing

            If uploadMaster Is Nothing Then
                uploadMaster = New FacPicFileUpload(oInspection.FacilityID, inspdate, UIUtilsGen.ModuleID.Inspection)
                AddHandler uploadMaster.FilesDone, AddressOf btnfacpics_Click
            End If


            uploadMaster.Anchor = AnchorStyles.Top Or AnchorStyles.Left Or AnchorStyles.Right
            uploadMaster.Height = 60
            uploadMaster.Top = 2
            uploadMaster.Left = 2
            uploadMaster.Width = PnlPics.Width - 5

            PnlPics.Controls.Add(uploadMaster)
            PnlPics.Controls.Add(pnl)

            pnl.Controls.Clear()


            DisplayBig.SizeMode = PictureBoxSizeMode.StretchImage
            DisplayBig.Left = 120
            DisplayBig.Width = PnlPics.Width - 180
            DisplayBig.BorderStyle = BorderStyle.Fixed3D
            removeFileButton.Left = 1
            removeFileButton.Width = 110




            If Not fileArray Is Nothing AndAlso fileArray.Count > 0 Then
                For Each item As IO.FileInfo In fileArray

                    filename = item.FullName
                    LoadFacImage(filename, cnt, pnl, DisplayBig)
                    cnt += 1
                Next
            End If

            DisplayBig.Anchor = AnchorStyles.Bottom Or AnchorStyles.Left Or AnchorStyles.Right

            removeFileButton.Top = DisplayBig.Top + 5

            pnl.Controls.Add(DisplayBig)

            pnl.Controls.Add(removeFileButton)
            pnl.Tag = removeFileButton

            AddHandler removeFileButton.Fileremoved, AddressOf btnfacpics_Click
    ...
    Sub LoadPowerPointImage(ByVal filename As String, ByVal pic As PictureBox)

        Dim p As pp.Application
        Dim pr As pp.Presentation

        Try
            '   MsgBox("there1")
            p = New pp.Application

            '     p.WindowState = pp.PpWindowState.ppWindowMinimized
            '    p.ShowStartupDialog = Microsoft.Office.Core.MsoTriState.msoFalse
            '   p.ShowWindowsInTaskbar = Microsoft.Office.Core.MsoTriState.msoFalse
            '  MsgBox("there2")
            If System.IO.File.Exists(filename) Then
                ...
                pr = p.Presentations.Open(filename, Microsoft.Office.Core.MsoTriState.msoCTrue, Microsoft.Office.Core.MsoTriState.msoTriStateToggle, Microsoft.Office.Core.MsoTriState.msoFalse)
                '  MsgBox("there3   " + filename)
                Try
                    '       MsgBox("there4")
                    pr.SaveAs(filename.Replace(".ppt", ".bmp"), pp.PpSaveAsFileType.ppSaveAsBMP)
                    '    MsgBox("there5")
                Catch ex As Exception
                    t = ex
                Finally
                ...
                Try
                    ...
                    file = New IO.FileStream(filename.Replace(".ppt", "\Slide1.bmp"), IO.FileMode.Open)
        ...
        Finally
            ...
            For Each proc As Process In Process.GetProcessesByName("POWERPNT")
                proc.Kill()
            Next
    ...
    Sub LoadFacImage(ByVal filename As String, ByVal cnt As Integer, ByVal pnl As Panel, ByRef DisplayPnl As PictureBox)
        ...
        Try
            ...
            With pnl
                ...
                If System.IO.File.Exists(filename) Then
                    ...
                    p.Width = 80
                    p.Top = (Int(cnt / 8.0) * 70)
                    p.Height = 68

                    DisplayPnl.Top = ((Int(cnt / 8.0) + 1) * 90)
                    DisplayPnl.Height = .Height - ((Int(cnt / 8.0) + 1) * 70) - .Top - 20

                    ' p.Image = New Bitmap(filename)
                    ' p.SizeMode = PictureBoxSizeMode.StretchImage
                    ' p.Tag = DisplayPnl
                    p.Anchor = AnchorStyles.Top Or AnchorStyles.Left
                    p.Image = UIUtilsGen.GetThumbnail(filename)
                    p.Text = filename
                    p.SizeMode = PictureBoxSizeMode.StretchImage
                    ...
                    RemoveHandler p.MouseEnter, AddressOf DisplayPictureBig
                    AddHandler p.MouseEnter, AddressOf DisplayPictureBig
    ...
    Sub DisplayPictureBig(ByVal sender As Object, ByVal e As EventArgs)
        With DirectCast(sender, PictureBox)
            If TypeOf .Tag Is PictureBox Then
                With DirectCast(.Tag, PictureBox)
                    If .Tag Is Nothing OrElse Not .Tag Is sender Then
                        .Tag = sender
                        .Image = DirectCast(sender, PictureBox).Image

                        If Not DirectCast(.Parent, Panel).Tag Is Nothing AndAlso TypeOf DirectCast(.Parent, Panel).Tag Is FileRemovalButton Then
                            DirectCast(DirectCast(.Parent, Panel).Tag, FileRemovalButton).filePath = DirectCast(sender, PictureBox).Text
                        End If
    ...
    Sub SavePowerPointPicture(ByVal sender As Object, ByVal e As EventArgs) Handles btnSavePic.Click

        Dim p As pp.Application

        Dim filename As String = String.Empty
        Dim sketch As New BusinessLogic.pInspectionSketch
        ...
        Try
            ...
            If System.IO.File.Exists(filename) Then
                p.Presentations.Open(filename, Microsoft.Office.Core.MsoTriState.msoFalse, Microsoft.Office.Core.MsoTriState.msoFalse)

                For Each ppTarget As pp.Slide In p.ActivePresentation.Slides

                    For Each ppItem As pp.Shape In ppTarget.Shapes

                        If ppItem.Name = "WordArt 5" Then
                            ppItem.TextEffect.Text = String.Format("Facility Sketch for # {0} - {1}", oInspection.FacilityID, Me.txtFacilityName.Text)
                        End If
                    Next
                Next
            ...
            Else
                ...
                p.Presentations.Open(String.Format("{0}\{1}", oFilePath.FilePath, "SketchTemplate.ppt"), Microsoft.Office.Core.MsoTriState.msoFalse, Microsoft.Office.Core.MsoTriState.msoFalse)
                ...
                p.ActivePresentation.SaveAs(filename, pp.PpSaveAsFileType.ppSaveAsPresentation, Microsoft.Office.Core.MsoTriState.msoTrue)

            End If


            sketch.Retrieve(oInspection.InspectionInfo)

            If sketch.ID <= 0 Then
                sketch.SketchFileName = String.Format("{0}.PPT", oInspection.ID)
                sketch.InspectionID = oInspection.ID

                sketch.Save(moduleID, MusterContainer.AppUser.UserKey, retval)
...
#Region "Navigation Button Click"
    Private Sub CheckTankPipeTermModified()
        Try
            If regenerateCheckListItems Then
                ...
                oInspection.CheckListMaster.GenerateCheckList(True, bolReadOnly, bolOwnerIsDesignatedOperator)
                ShowHideMW()
                regenerateCheckListItems = False
    ...
    Private Sub btnMaster_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnMaster.Click
        Try
            ...
            ToggleButtonAppearance(btnMaster)
            LoadChecklistMaster()
            Me.pnlChecklistDetails.Visible = True
            Me.pnlMaster.Visible = True

            Me.pnlMasterDetails.Visible = True
            Me.pnlMasterDisplay.Visible = True
            Me.pnlContact.Visible = True
            Me.pnlMasterDetailsGrid.Visible = True
            Me.pnlMasterDetailsTop.Visible = True
    ...
    Private Sub btnTanksPipes_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnTanksPipes.Click
        Try
            ...
            PrepTankPipeTerm()
            Me.pnlChecklistDetails.Visible = True
            Me.pnlTanksPipes.Visible = True
            Me.pnlTanksPipesDetails.Visible = True
            Me.pnlTanksPipesDisplay.Visible = True
            Me.pnlTerminationsDetails.Visible = True
            Me.pnlTerminationsTop.Visible = True
            Me.pnlPipeDetails.Visible = True
            Me.pnlPipeTop.Visible = True
            Me.pnlTanksDetails.Visible = True
            Me.pnlTanksTop.Visible = True
            Cursor.Current = Cursors.Default
        Catch ex As Exception
            Cursor.Current = Cursors.Default
            Dim MyErr As New ErrorReport(ex)
        ...
        End Try
    End Sub
    Private Sub btnCapView_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnCapView.Click
        Try
            Cursor.Current = Cursors.AppStarting
            PrepCapView()
            Me.pnlChecklistDetails.Visible = True
            Me.PnlCapValues.Visible = True
            Me.pnlCapEntryView.Visible = True
    ...
    ' Sub SetUpuserDefineGrid(ByVal mode As Integer, ByVal oldGrid As Infragistics.Win.UltraWinGrid.UltraGrid)

    ' Dim userdefGrid As New Infragistics.Win.UltraWinGrid.UltraGrid
    'Dim lastGridpnl As Control = Nothing
    ' Dim usergridPnl As Panel


    ' For Each item As Control In Me.pnlChecklistDetails.Controls
    '    If item.Name = "UserGridPnl" Then
    '       lastGridpnl = item
    '      Exit For
    ' End If
    ' Next

    ' If Not lastGridpnl Is Nothing Then


    '    lastGridpnl.Controls.Clear()
    '   pnlChecklistDetails.Controls.Remove(lastGridpnl)
    ...
    'userdefGrid.Anchor = AnchorStyles.Bottom And AnchorStyles.Left


    'If oInspection.CheckListMaster.AddUserDefineRows(mode, oInspection.ID).Rows.Count > 0 Then

    '   usergridPnl = New Panel
    ...
    '  .Visible = True
    ' End With
    ' userdefGrid.Height = 300
    'userdefGrid.Dock = DockStyle.Bottom
    'oldGrid.Dock = DockStyle.Fill
    'usergridPnl.Controls.Add(oldGrid)
    'usergridPnl.Controls.Add(userdefGrid)
    'pnlChecklistDetails.Controls.Add(usergridPnl)
    'usergridPnl.BringToFront()


    'userdefGrid.DataSource = oInspection.CheckListMaster.AddUserDefineRows(mode, oInspection.ID)

    'With userdefGrid.DisplayLayout
    ...
    ' .Override.AllowColMoving = Infragistics.Win.UltraWinGrid.AllowColMoving.NotAllowed

    '.Override.AllowColSizing = Infragistics.Win.UltraWinGrid.AllowColSizing.Free
    '.Override.CellAppearance.FontData.SizeInPoints = 7.5


    'With .Bands(0).Columns

    '   .Item("deleted").Hidden = True
    '  .Item("datecreated").Hidden = True
    ' .Item("userdefine_question_id").Hidden = True
    '.Item("inspection_id").Hidden = True

    ' .Item("chklist_item_number").Width = 55
    ' .Item("chklist_item_number").CellActivation = Infragistics.Win.UltraWinGrid.Activation.NoEdit
    ' .Item("chklist_item_number").Header.Caption = "Line Number"

    '.Item("Question").Header.Caption = "User-Defined Question"
    '.Item("Answer").Header.Caption = "Answer/Comment"

    '.Item("Question").CellActivation = Infragistics.Win.UltraWinGrid.Activation.NoEdit
    ' .Item("Answer").CellActivation = Infragistics.Win.UltraWinGrid.Activation.NoEdit
    ...
    Private Sub btnReg_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReg.Click
        Try
            ...
            Me.pnlReg.Visible = True
            Me.pnlRegDisplay.Visible = True
            '  SetUpuserDefineGrid(1, ugReg)
            ugReg.DrawFilter = rp
            SetupGrid(ugReg)
            If ugReg.Rows.Count > 0 Then
                ugReg.Focus()
                If ugReg.Rows.Count > 1 Then
                    ugReg.Rows(1).Cells("Question").Activate()
                End If
                SetupGridHeader(ugReg)
        ...
        End Try
    End Sub
    Private Sub SetupGridHeader(ByRef ug As Infragistics.Win.UltraWinGrid.UltraGrid)
        For Each dr As Infragistics.Win.UltraWinGrid.UltraGridRow In ug.Rows
            If testAllUpperCase(dr.Cells("Question").Value.ToString()) Then
                dr.CellAppearance.BackColor = System.Drawing.Color.LightSteelBlue
                dr.Cells("Yes").Style = Infragistics.Win.UltraWinGrid.ColumnStyle.FormattedText
                dr.Cells("No").Style = Infragistics.Win.UltraWinGrid.ColumnStyle.FormattedText
                dr.Cells("N/A").Style = Infragistics.Win.UltraWinGrid.ColumnStyle.FormattedText
                dr.Cells("Yes").Appearance.ForeColor = System.Drawing.Color.LightSteelBlue
                dr.Cells("No").Appearance.ForeColor = System.Drawing.Color.LightSteelBlue
                dr.Cells("N/A").Appearance.ForeColor = System.Drawing.Color.LightSteelBlue
                'dr.Activated = False
                dr.Activation = Infragistics.Win.UltraWinGrid.Activation.NoEdit
            End If
        Next
    ...
    Private Sub btnCitations_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCitations.Click
        Try
            ...
            If Me.ugCitation Is Nothing Then
                Me.ugCitation = New Infragistics.Win.UltraWinGrid.UltraGrid()
            End If
            Me.pnlChecklistDetails.Visible = True
            Me.Panel6.Visible = True
            Me.pnlInspectionCitations.Visible = True
    ...
    Private Sub btnCp_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCp.Click
        Try
            ...
            'Me.pnlCPAdd.Visible = True
            Me.pnlCPDisplay.Visible = True
            'Me.pnlSpill.Visible = True
            ' Me.pnlSpillDisplay.Visible = True
            ...
            '    Next
            'End If
            If ugCP.Rows.Count > 0 Then
                ugCP.Focus()
                If ugCP.Rows.Count > 1 Then
                    ugCP.Rows(1).Cells("Question").Activate()
                End If
                SetupGridHeader(ugCP)
                ugCP.DisplayLayout.Override.AllowDelete = Infragistics.Win.DefaultableBoolean.True
                ugCP.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.True
            End If
            Cursor.Current = Cursors.Default
        Catch ex As Exception
            Cursor.Current = Cursors.Default
        ...
        End Try
    End Sub
    Public Function testAllUpperCase(ByVal str As String) As Boolean
        Dim ch As Char
        Dim c As Integer
    ...
    Private Sub btnTankLeak_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnTankLeak.Click
        Try
            ...
            If Me.ugTankLeak Is Nothing Then
                Me.ugTankLeak = New Infragistics.Win.UltraWinGrid.UltraGrid()
            End If
            ...
            If ugTankLeak.Rows.Count > 0 Then
                ugTankLeak.Focus()
                If ugTankLeak.Rows.Count > 1 Then
                    ugTankLeak.Rows(1).Cells("Question").Activate()
                End If
                SetupGridHeader(ugTankLeak)
                ugTankLeak.DisplayLayout.Override.AllowDelete = Infragistics.Win.DefaultableBoolean.True
                ugTankLeak.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.True
            End If
            Me.pnlTankLeakAdd.Visible = True
            btnAddTankMW.Enabled = True
            Cursor.Current = Cursors.Default
        Catch ex As Exception
            Cursor.Current = Cursors.Default
    ...
    Private Sub btnPipeLeak_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPipeLeak.Click
        Try
            ...
            If Me.ugPipeLeak Is Nothing Then
                Me.ugPipeLeak = New Infragistics.Win.UltraWinGrid.UltraGrid()
            End If
            ...
            '    End If
            'Next
            If ugPipeLeak.Rows.Count > 0 Then
                ugPipeLeak.Focus()
                If ugPipeLeak.Rows.Count > 1 Then
                    ugPipeLeak.Rows(1).Cells("Question").Activate()
                End If
                SetupGridHeader(ugPipeLeak)
                ugPipeLeak.DisplayLayout.Override.AllowDelete = Infragistics.Win.DefaultableBoolean.True
                ugPipeLeak.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.True
            End If
            Cursor.Current = Cursors.Default
        Catch ex As Exception
            Cursor.Current = Cursors.Default
    ...
    Private Sub btnMW_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnMW.Click
        Try
            ...
            If btnMW.Visible Then
                ...
                If Me.ugMW Is Nothing Then
                    Me.ugMW = New Infragistics.Win.UltraWinGrid.UltraGrid()
                End If
                Me.pnlChecklistDetails.Visible = True
                Me.Panel6.Visible = True
                Me.pnlMW.Visible = True
                Me.pnlMWAdd.Visible = True
                Me.ugMW.DataSource = oInspection.CheckListMaster.MWellTable(bolReadOnly)
                ugMW.DrawFilter = rp
                SetupGrid(ugMW)
                ugMW.DisplayLayout.Override.AllowDelete = Infragistics.Win.DefaultableBoolean.True
                Me.ugMW.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.True
                If ugMW.Rows.Count > 0 Then
                    ugMW.Focus()
                    If ugMW.Rows.Count > 1 Then
                        ugMW.Rows(1).Cells("Question").Activate()
                    End If
                    SetupGridHeader(ugMW)
    ...
    Private Sub btnSoc_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSoc.Click
        Try
            ...
            Me.pnlChecklistDetails.Visible = True
            Me.Panel6.Visible = True
            Me.pnlSOC.Visible = True
            Me.pnlSOCDisplay.Visible = True
            Me.Panel1.Visible = True
            Me.Panel2.Visible = True
            SetupGrid(ugSOC)
            If ugSOC.Rows.Count > 0 Then
                ugSOC.Focus()
                If ugSOC.Rows.Count > 1 Then
                    ugSOC.Rows(1).Cells("Question").Activate()
                End If
                SetupGridHeader(ugSOC)
    ...
    Private Sub btnOther_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnOther.Click
        Try
            CheckTankPipeTermModified()
            Cursor.Current = Cursors.AppStarting
            ToggleButtonAppearance(btnOther)
            HideVisiblePanels(True, PnlOther)
            ' only inspection head can edit the values
            If Me.ugOther Is Nothing Then
                Me.ugOther = New Infragistics.Win.UltraWinGrid.UltraGrid()
            End If
            ugOther.DataSource = oInspection.CheckListMaster.OtherQusetionsTable(bolReadOnly)
            Me.pnlChecklistDetails.Visible = True
            Me.Panel6.Visible = True
            Me.PnlOther.Visible = True
            Me.Panel5.Visible = True

            ugOther.DrawFilter = rp
            SetupGrid(ugOther)
            If ugOther.Rows.Count > 0 Then
                ugOther.Focus()
                ugOther.Rows(1).Cells("Question").Activate()
                SetupGridHeader(ugOther)
            End If
            Cursor.Current = Cursors.Default
        Catch ex As Exception
            Cursor.Current = Cursors.Default
    ...
    Private Sub btnSketch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSketch.Click
        Try


            CheckTankPipeTermModified()
            Cursor.Current = Cursors.AppStarting
            ToggleButtonAppearance(btnSketch)
            HideVisiblePanels(True, PnlSketch)
            Me.pnlChecklistDetails.Visible = True
            Me.PnlSketch.Visible = True
            Me.Panel8.Visible = True
            oSketch = New BusinessLogic.pInspectionSketch

            oSketch.Retrieve(oInspection.InspectionInfo)

            SetupSketchPad(oSketch)
    ...
    Private Sub btnfacpics_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnFacpics.Click
        ...
        Try
            ...
            If Not PIC_PATH Is Nothing Then
                ...
                If Not oFilePath Is Nothing Then
                    ...
                    CheckTankPipeTermModified()
                    Cursor.Current = Cursors.AppStarting
                    ToggleButtonAppearance(Me.BtnFacpics)
                    HideVisiblePanels(True, Me.PnlPics)

                    Me.pnlChecklistDetails.Visible = True
                    Me.PnlPics.Visible = True


                    oInspection.CheckListMaster.LoadFacilityPics(PIC_PATH, oInspection.ID)

                    SetupPics(oInspection.CheckListMaster.facpics)
...
#Region "CheckList"
    ...
    Private Sub ugReg_CellChange(ByVal sender As Object, ByVal e As Infragistics.Win.UltraWinGrid.CellEventArgs) Handles ugReg.CellChange
        Try
            ...
            Dim HasCCAt As Boolean = False
            If e.Cell.Row.Cells.HasCell("NO") AndAlso e.Cell.Row.Cells("NO").Value Then
                HasCCAt = True
            End If
            ...
            If "Yes".Equals(e.Cell.Column.Key) Then
                If e.Cell.Row.Cells("RESPONSE").Value = 1 And e.Cell.Value Then
                    e.Cell.CancelUpdate()
                Else
                    CellUpdate(1, e.Cell.Row, HasCCAt)
                End If
            ElseIf "No".Equals(e.Cell.Column.Key) Then
                If e.Cell.Row.Cells("RESPONSE").Value = 0 And e.Cell.Value Then
                    e.Cell.CancelUpdate()
                Else
                    CellUpdate(0, e.Cell.Row, HasCCAt)
                End If
            ElseIf "N/A".Equals(e.Cell.Column.Key) Then
                If e.Cell.Row.Cells("RESPONSE").Value = 2 And e.Cell.Value Then
                    e.Cell.CancelUpdate()
                Else
                    CellUpdate(2, e.Cell.Row, HasCCAt)
                End If
    ...
    Private Sub ugTankLeak_CellChange(ByVal sender As Object, ByVal e As Infragistics.Win.UltraWinGrid.CellEventArgs) Handles ugTankLeak.CellChange
        Try
            ...
            Dim HasCCAt As Boolean = False
            If e.Cell.Row.Band.Key.IndexOf("LeakWell") <= -1 AndAlso e.Cell.Row.Cells.HasCell("NO") AndAlso e.Cell.Row.Cells("NO").Value Then
                HasCCAt = True
            End If
            ...
            ElseIf ("Surface Sealed" + vbCrLf + "Yes").Equals(e.Cell.Column.Key) Then
                If e.Cell.Row.Cells("SURFACE_SEALED").Value = 1 And e.Cell.Value Then
                    e.Cell.CancelUpdate()
                Else
                    CellUpdate(1, e.Cell.Row, HasCCAt, e.Cell.Column.Key, ugTankLeak.Name)
                End If
            ElseIf ("Surface Sealed" + vbCrLf + "No").Equals(e.Cell.Column.Key) Then
                If e.Cell.Row.Cells("SURFACE_SEALED").Value = 0 And e.Cell.Value Then
                    e.Cell.CancelUpdate()
                Else
                    CellUpdate(0, e.Cell.Row, HasCCAt, e.Cell.Column.Key, ugTankLeak.Name)
                End If
        ...
        Try
            ...
            ElseIf ("Surface Sealed" + vbCrLf + "Yes").Equals(e.Cell.Column.Key) Then
                If e.Cell.Row.Cells("SURFACE_SEALED").Value = 1 And e.Cell.Value Then
                    e.Cell.CancelUpdate()
                Else
                    CellUpdate(1, e.Cell.Row, HasCCAt, e.Cell.Column.Key, ugPipeLeak.Name)
                End If
            ElseIf ("Surface Sealed" + vbCrLf + "No").Equals(e.Cell.Column.Key) Then
                If e.Cell.Row.Cells("SURFACE_SEALED").Value = 0 And e.Cell.Value Then
                    e.Cell.CancelUpdate()
                Else
                    CellUpdate(0, e.Cell.Row, HasCCAt, e.Cell.Column.Key, ugPipeLeak.Name)
                End If
            ElseIf ("Well Caps" + vbCrLf + "Yes").Equals(e.Cell.Column.Key) Then
                If e.Cell.Row.Cells("WELL_CAPS").Value = 1 And e.Cell.Value Then
                    e.Cell.CancelUpdate()
    ...
    Private Sub ugMW_CellChange(ByVal sender As Object, ByVal e As Infragistics.Win.UltraWinGrid.CellEventArgs) Handles ugMW.CellChange
        Try
            ...
            If ("Surface Sealed" + vbCrLf + "Yes").Equals(e.Cell.Column.Key) Then
                If e.Cell.Row.Cells("SURFACE_SEALED").Value = 1 And e.Cell.Value Then
                    e.Cell.CancelUpdate()
                Else
                    CellUpdate(1, e.Cell.Row, False, e.Cell.Column.Key, ugMW.Name)
                End If
            ElseIf ("Surface Sealed" + vbCrLf + "No").Equals(e.Cell.Column.Key) Then
                If e.Cell.Row.Cells("SURFACE_SEALED").Value = 0 And e.Cell.Value Then
                    e.Cell.CancelUpdate()
                Else
                    CellUpdate(0, e.Cell.Row, False, e.Cell.Column.Key, ugMW.Name)
                End If
            ElseIf ("Well Caps" + vbCrLf + "Yes").Equals(e.Cell.Column.Key) Then
                If e.Cell.Row.Cells("WELL_CAPS").Value = 1 And e.Cell.Value Then
                    e.Cell.CancelUpdate()
        ...
        End Try
    End Sub
    Private Sub CellUpdate(ByVal response As Int64, ByRef row As Infragistics.Win.UltraWinGrid.UltraGridRow, ByVal hasCCAT As Boolean, Optional ByVal ugCell As String = "", Optional ByVal gridName As String = "")
        ...
        Try
            ...
            Dim msg As String = row.Cells("QUESTION_ID").Value

            If (msg = 56 OrElse msg = 94) Then

                If ugCell.IndexOf("Surface Sealed") > -1 Then
                    msg = (row.Cells("QUESTION_ID").Value * -1)
                Else
                    msg = (row.Cells("QUESTION_ID").Value * -1) - 100000
                End If

            End If


            checkList = oInspection.InspectionInfo.ChecklistMasterCollection.Item(msg)

            If response = 1 Then
                ' ccat exists only if checklist's ccat is true
                If checkList.CCAT AndAlso hasCCAT Then
                    ' check if ccat exists
                    For Each ccat In oInspection.InspectionInfo.CCATsCollection.Values
                        If ccat.QuestionID = msg Then
                ...
                If ugCell = "" And gridName = "" Then
                    ...
                    row.Cells("N/A").Value = False

                    row.Cells("Yes").Value = True
                ElseIf gridName = ugCP.Name Then
                    If ugCell = "Yes" OrElse ugCell = "No" OrElse ugCell = "N/A" Then
                ...
                If deleteCCat Then
                    ...
                    If result = MsgBoxResult.Yes Then
                        ...
                        For Each ccat In oInspection.InspectionInfo.CCATsCollection.Values
                            If ccat.QuestionID = checkList.ID And ((ugCell <> "Surface Sealed" + vbCrLf + "Yes" AndAlso ugCell <> "Well Caps" + vbCrLf + "Yes") OrElse (row.Cells("Surface Sealed" + vbCrLf + "Yes").Value AndAlso row.Cells("Well Caps" + vbCrLf + "Yes").Value)) Then
                    ...
                    ElseIf result = MsgBoxResult.No Then
                        If ugCell = "" And gridName = "" Then
                            ...
                            row.Cells("N/A").Value = row.Cells("N/A").OriginalValue
                ...
                If checkList.Citation <> -1 Or checkList.DiscrepText <> String.Empty Then
                    ...
                    ElseIf gridName = ugPipeLeak.Name Or gridName = ugTankLeak.Name Then
                        ...
                        strUpdatedCCAT = UpdateCitationCCATForMWell(ugCell, row, checkList)
                        deleteCitation = True
                        deleteDiscrep = True
                ...
                ElseIf gridName = ugCP.Name Then
                    ...
                    End If
                    If ugCell = "Yes" Or ugCell = "No" Or ugCell = "N/A" Then
                ...
                ElseIf gridName = ugPipeLeak.Name Or gridName = ugTankLeak.Name Or gridName = ugMW.Name Then
                    ...
                    Select Case ugCell
                        Case ("Surface Sealed" + vbCrLf + "Yes")
                            ...
                            oInspection.CheckListMaster.InspectionMonitorWells.QuestionID = msg
                        Case ("Well Caps" + vbCrLf + "Yes")
            ...
            ElseIf response = 0 Or response = 2 Then
                ...
                If ugCell = "" And gridName = "" Then
                    row.Cells("RESPONSE").Value = response
                    row.Cells("Yes").Value = False
                    row.Cells("No").Value = IIf(response = 0, True, False)
                    row.Cells("N/A").Value = IIf(response = 0, False, True)
                ElseIf gridName = ugCP.Name Then
                ...
                If (response = 0) AndAlso msg <> "146" AndAlso checkList.ID <> -1 And Not (ugCell = "Yes" Or ugCell = "No" Or ugCell = "N/A") Then


                    If row.Cells("Line#").Text.StartsWith("12.") Then
                    ...
                    For Each citation In oInspection.InspectionInfo.CitationsCollection.Values
                        If citation.QuestionID = checkList.ID Then
                            ...
                            ElseIf row.Cells("Line#").Text.StartsWith("4.2.8.") Or row.Cells("Line#").Text.StartsWith("5.2.8.") Then
                                ...
                                Dim code As String
                                If row.Cells("Line#").Text.StartsWith("4.2.8") Then
                                    code = "TMW"
                                Else
                                    code = "PMW"
                                End If
                                oInspection.CheckListMaster.InspectionCitation.CCAT += ", " + code + row.Cells("Well#").Text
                                ...
                                For Each str In oInspection.CheckListMaster.InspectionCitation.CCAT.Split(",")
                                    ...
                                    If Not slCCAT.Contains(val) Then
                                        slCCAT.Add(val, str)
                                        val += 1
                                    End If
                                Next
                                ...
                                Next
                                If str <> String.Empty Then
                                    str = str.Trim.TrimEnd(",").TrimStart(",")
                                End If
                                oInspection.CheckListMaster.InspectionCitation.CCAT = str
                            Else
                                oInspection.CheckListMaster.InspectionCitation.Reset()
                    ...
                    If createCitation Then
                        ...
                        ElseIf row.Cells("Line#").Text.StartsWith("4.2.8.") Then
                            citation.CCAT = "TMW" + row.Cells("Well#").Text
                        ElseIf row.Cells("Line#").Text.StartsWith("5.2.8.") Then
                            citation.CCAT = "PMW" + row.Cells("Well#").Text
                        End If

                        If row.Cells("Line#").Text.StartsWith("1.13") AndAlso oInspection.CheckListMaster.hasOwnerAsDesignatedOperator Then
                ...
                ' discrep exists only if DiscrepText is not empty
                If response = 0 AndAlso checkList.DiscrepText <> String.Empty And Not (ugCell = "Yes" Or ugCell = "No" Or ugCell = "N/A") Then
                    ' discrep
                ...
                ' CCAT
                If checkList.CCAT And Not response = 2 And Not (ugCell = "Yes" Or ugCell = "No") And (Not ugCell = "N/A") Then
                    ' reset ccat
                    For Each ccat In oInspection.InspectionInfo.CCATsCollection.Values
                        ...
                        Select Case ugCell
                            Case "Well#", "Well Depth", "Depth to" + vbCrLf + "Water", "Depth to" + vbCrLf + "Slots", "Inspector's Observations"
                                ...
                                If ugCell = "Well#" Then
                                    ...
                                    If row.Cells("Well Caps" + vbCrLf + "No").Value Then
                                        btnClose.Focus()
                                        CellUpdate(1, row, False, "Well Caps" + vbCrLf + "Yes", gridName)
                                        CellUpdate(0, row, False, "Well Caps" + vbCrLf + "No", gridName)
                                    End If

                                    If row.Cells("Surface Sealed" + vbCrLf + "No").Value Then
                                        btnClose.Focus()
                                        CellUpdate(1, row, False, "Surface Sealed" + vbCrLf + "Yes", gridName)
                                        CellUpdate(0, row, False, "Surface Sealed" + vbCrLf + "No", gridName)
    ...
    Private Sub UpdateCitationCCATForCP(ByVal row As Infragistics.Win.UltraWinGrid.UltraGridRow, ByVal checklist As MUSTER.Info.InspectionChecklistMasterInfo)
        ...
        End Try
    End Sub
    Private Function UpdateCitationCCATForMWell(ByVal ugcell As String, ByVal row As Infragistics.Win.UltraWinGrid.UltraGridRow, ByVal checklist As MUSTER.Info.InspectionChecklistMasterInfo) As String
        Try
            Dim strUpdatedCCAT As String = ""
            Dim slCCAT As New SortedList
            ...
            For Each ugRow As Infragistics.Win.UltraWinGrid.UltraGridRow In row.ParentCollection
                ...
                If ugcell.IndexOf("Surface Sealed") > -1 Then
                    If ugRow.Cells("Surface Sealed" + vbCrLf + "No").Value AndAlso ugRow.Cells("ID").Value <> row.Cells("ID").Value Then
                        slCCAT.Add(num, String.Format("{1}{0}", ugRow.Cells("Well#").Value, code))
                        num += 1
                    End If
                End If

                If ugcell.IndexOf("Well Caps") > -1 Then
                    If ugRow.Cells("Well Caps" + vbCrLf + "No").Value AndAlso ugRow.Cells("ID").Value <> row.Cells("ID").Value Then
                        slCCAT.Add(num, String.Format("{1}{0}", ugRow.Cells("Well#").Value, code))
                        num += 1
            ...
            strUpdatedCCAT = strUpdatedCCAT.Trim.TrimEnd(",").TrimStart(",").Trim

            Return strUpdatedCCAT
                ...
                Select Case ug.Name
                    Case ugCP.Name
                        If e.Cell.Row.Band.Index = 2 Or e.Cell.Row.Band.Index = 6 Or e.Cell.Row.Band.Index = 10 Then
                            If "Yes".Equals(e.Cell.Column.Key) Then
                                bolSetCellColor = True
                            ElseIf "No".Equals(e.Cell.Column.Key) OrElse "N/A".Equals(e.Cell.Column.Key) Then
                                bolSetCellColor = True
                            End If
        ...
        Try
            If Not ug.ActiveCell Is Nothing Then
                If ug.ActiveCell.Row.Band.Index = 0 Then
                    ...
                    ElseIf "No".Equals(ug.ActiveCell.Column.Key) OrElse "N/A".Equals(ug.ActiveCell.Column.Key) Then
                        bolReSetCellColor = True
                    End If
                Else
                    Select Case ug.Name
        ...
        Try
            ...
            If Not ugReg.ActiveCell Is Nothing Then
                If "CCAT".Equals(ugReg.ActiveCell.Column.Key) Then
                    If ugReg.ActiveRow.Cells("No").Value = True And ugReg.ActiveRow.Cells("CCAT").Value <> String.Empty AndAlso Not "N/A".Equals(ugReg.ActiveCell.Column.Key) Then
                        Dim checkList As MUSTER.Info.InspectionChecklistMasterInfo
                        'Dim ccat As MUSTER.Info.InspectionCCATInfo
    ...
    Private Sub ugSpill_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ugSpill.DoubleClick
        Try
            ...
            If Not ugSpill.ActiveCell Is Nothing Then
                If "CCAT".Equals(ugSpill.ActiveCell.Column.Key) Then
                    If ugSpill.ActiveRow.Cells("No").Value = True And ugSpill.ActiveRow.Cells("CCAT").Value <> String.Empty AndAlso Not "N/A".Equals(ugSpill.ActiveCell.Column.Key) Then
                        Dim checkList As MUSTER.Info.InspectionChecklistMasterInfo
                        'Dim ccat As MUSTER.Info.InspectionCCATInfo
        ...
        End Try
    End Sub
    'Private Sub ugCP_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs)
    '    Try
    '        If Not UIUtilsInfragistics.WinGridRowDblClicked(sender, e) Then
    '            Me.Cursor = Cursors.Default
    '            Exit Sub
    ...
    '            If "CCAT".Equals(ugCP.ActiveCell.Column.Key) AndAlso Not "N/A".Equals(ugCP.ActiveCell.Column.Key) Then
    ...
    Private Sub ugTankLeak_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ugTankLeak.DoubleClick
        Try
            If Not UIUtilsInfragistics.WinGridRowDblClicked(sender, e) Then
                ...
                Exit Sub
            End If
            If Not ugTankLeak.ActiveCell Is Nothing AndAlso Not "N/A".Equals(ugTankLeak.ActiveCell.Column.Key) Then
                Dim checkList As MUSTER.Info.InspectionChecklistMasterInfo
    ...
    Private Sub ugPipeLeak_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ugPipeLeak.DoubleClick
        Try
            If Not UIUtilsInfragistics.WinGridRowDblClicked(sender, e) Then
                ...
                Exit Sub
            End If
            If Not ugPipeLeak.ActiveCell Is Nothing AndAlso Not "N/A".Equals(ugPipeLeak.ActiveCell.Column.Key) Then
                Dim checkList As MUSTER.Info.InspectionChecklistMasterInfo
    ...
    Private Sub ugTOS_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ugTOS.DoubleClick
        Try
            ...
            If Not ugTOS.ActiveCell Is Nothing Then
                If "CCAT".Equals(ugTOS.ActiveCell.Column.Key) AndAlso Not "N/A".Equals(ugTOS.ActiveCell.Column.Key) Then
                    ...
                    If checkList.Citation <> -1 Or checkList.DiscrepText <> String.Empty Then
                        ...
                        For Each ugRow As Infragistics.Win.UltraWinGrid.UltraGridRow In e.Rows(0).ParentCollection
                            ...
                            If Not alRowIDs.Contains(ugRow.Cells("ID").Value.ToString) Then
                                ' if any other row belonging to the updating row's parent
                                ' has "No" set to true, set delete variables to false
                                If ugRow.Cells("Well Caps" + vbCrLf + "No").Value Then

                                    If Not slCCAT.Contains(String.Format("{0} A", ugRow.Cells("Well#").Value)) Then
                                        slCCAT.Add(String.Format("{0} A", ugRow.Cells("Well#").Value), ugRow.Cells("Well#").Text)
                                    End If

                                    'deleteCitation = False
                                    deleteDiscrep = False
                                End If
                                If ugRow.Cells("Surface Sealed" + vbCrLf + "No").Value Then

                                    If Not slCCAT.Contains(String.Format("{0} B", ugRow.Cells("Well#").Value)) Then
                                        slCCAT.Add(String.Format("{0} B", ugRow.Cells("Well#").Value), ugRow.Cells("Well#").Text)
                                    End If
...
#Region "Tank Pipe Term"
    ...
    Private Sub ugTanks_AfterCellUpdate(ByVal sender As Object, ByVal e As Infragistics.Win.UltraWinGrid.CellEventArgs) Handles ugTanks.AfterCellUpdate
        ...
        Try
            ...
            '                "TANK SEC INSP".Equals(e.Cell.Column.Key.ToUpper) Or _
            ...
            If "SIZE".Equals(e.Cell.Column.Key.ToUpper) Or _
                ...
                "SPILL INSTALLED".Equals(e.Cell.Column.Key.ToUpper) Or _
                "SPILL TESTED".Equals(e.Cell.Column.Key.ToUpper) Or _
                "OVERFILL INSTALLED".Equals(e.Cell.Column.Key.ToUpper) Or _
                "OVERFILL TESTED".Equals(e.Cell.Column.Key.ToUpper) Or _
                "TANK ELEC INSP".Equals(e.Cell.Column.Key.ToUpper) Or _
                "ATG INSP".Equals(e.Cell.Column.Key.ToUpper) Or _
                ...
                ElseIf "CP TESTED".Equals(e.Cell.Column.Key.ToUpper) Then
                    ...
                    If Not oInspection.CAPDatesEntered Then
                        oInspection.CAPDatesEntered = True
                    End If
                ElseIf "SPILL INSTALLED".Equals(e.Cell.Column.Key.ToUpper) Then
                    UIUtilsGen.FillDateobjectValues(oTank.DateSpillInstalled, e.Cell.Text)
                    tankCellUpdated = True
                    tankDateCellUpdated = True
                    If Date.Compare(oTank.DateSpillInstalled, dtNullDate) = 0 Then
                        e.Cell.Value = DBNull.Value
                    Else
                        e.Cell.Value = e.Cell.Text
                    End If
                    If Not oInspection.CAPDatesEntered Then
                        oInspection.CAPDatesEntered = True
                    End If
                ElseIf "SPILL TESTED".Equals(e.Cell.Column.Key.ToUpper) Then
                    UIUtilsGen.FillDateobjectValues(oTank.DateSpillTested, e.Cell.Text)
                    tankCellUpdated = True
                    tankDateCellUpdated = True
                    If Date.Compare(oTank.DateSpillTested, dtNullDate) = 0 Then
                        e.Cell.Value = DBNull.Value
                    Else
                        e.Cell.Value = e.Cell.Text
                    End If
                    If Not oInspection.CAPDatesEntered Then
                        oInspection.CAPDatesEntered = True
                    End If
                ElseIf "OVERFILL INSTALLED".Equals(e.Cell.Column.Key.ToUpper) Then
                    UIUtilsGen.FillDateobjectValues(oTank.DateOverfillInstalled, e.Cell.Text)
                    tankCellUpdated = True
                    tankDateCellUpdated = True
                    If Date.Compare(oTank.DateOverfillInstalled, dtNullDate) = 0 Then
                        e.Cell.Value = DBNull.Value
                    Else
                        e.Cell.Value = e.Cell.Text
                    End If
                    If Not oInspection.CAPDatesEntered Then
                        oInspection.CAPDatesEntered = True
                    End If
                ElseIf "OVERFILL TESTED".Equals(e.Cell.Column.Key.ToUpper) Then
                    UIUtilsGen.FillDateobjectValues(oTank.DateOverfillTested, e.Cell.Text)
                    tankCellUpdated = True
                    tankDateCellUpdated = True
                    If Date.Compare(oTank.DateOverfillTested, dtNullDate) = 0 Then
                        e.Cell.Value = DBNull.Value
                    Else
                        e.Cell.Value = e.Cell.Text
                    End If
                    If Not oInspection.CAPDatesEntered Then
                        oInspection.CAPDatesEntered = True
                    End If
                    ' ElseIf "TANK SEC INSP".Equals(e.Cell.Column.Key.ToUpper) Then
                    '     UIUtilsGen.FillDateobjectValues(oTank.DateTankSecInsp, e.Cell.Text)
                    '    tankCellUpdated = True
                    '    tankDateCellUpdated = True
                    '    If Date.Compare(oTank.DateTankSecInsp, dtNullDate) = 0 Then
                    '       e.Cell.Value = DBNull.Value
                    '  Else
                    '       e.Cell.Value = e.Cell.Text
                    '  End If
                    ...
                    '         oInspection.CAPDatesEntered = True
                    '    End If
                ElseIf "TANK ELEC INSP".Equals(e.Cell.Column.Key.ToUpper) Then
                    UIUtilsGen.FillDateobjectValues(oTank.DateTankElecInsp, e.Cell.Text)
                    tankCellUpdated = True
                    tankDateCellUpdated = True
                    If Date.Compare(oTank.DateTankElecInsp, dtNullDate) = 0 Then
                        e.Cell.Value = DBNull.Value
                    Else
                        e.Cell.Value = e.Cell.Text
                    End If
                    If Not oInspection.CAPDatesEntered Then
                        oInspection.CAPDatesEntered = True
                    End If
                ElseIf "ATG INSP".Equals(e.Cell.Column.Key.ToUpper) Then
                    UIUtilsGen.FillDateobjectValues(oTank.DateATGInsp, e.Cell.Text)
                    tankCellUpdated = True
                    tankDateCellUpdated = True
                    If Date.Compare(oTank.DateATGInsp, dtNullDate) = 0 Then
                        e.Cell.Value = DBNull.Value
                    Else
                        e.Cell.Value = e.Cell.Text
                    End If
        ...
        Try
            ...
            If tankCellUpdated Or tankSizeUpdated Then
                ...
                Else
                    ...
                    oTank.Save(moduleID, MusterContainer.AppUser.UserKey, returnVal, MusterContainer.AppUser.ID, True, False, False, , , oInspection.SubmittedDate <= CDate("1/1/1950"))
                    If Not UIUtilsGen.HasRights(returnVal) Then
                        e.Cancel = True
                        e.Row.Selected = True
    ...
    Private Sub ugPipes_AfterCellUpdate(ByVal sender As Object, ByVal e As Infragistics.Win.UltraWinGrid.CellEventArgs) Handles ugPipes.AfterCellUpdate
        ...
        Try
            If "INSTALLED".Equals(e.Cell.Column.Key.ToUpper) Or _
                ...
                "CP INSTALLED".Equals(e.Cell.Column.Key.ToUpper) Or _
                "CP TESTED".Equals(e.Cell.Column.Key.ToUpper) Or _
                "SHEAR TEST".Equals(e.Cell.Column.Key.ToUpper) Or _
                "PIPE SEC INSP".Equals(e.Cell.Column.Key.ToUpper) Or _
                "PIPE ELEC INSP".Equals(e.Cell.Column.Key.ToUpper) Or _
                "LAST USED".Equals(e.Cell.Column.Key.ToUpper) Then
                ...
                ElseIf "CP TESTED".Equals(e.Cell.Column.Key.ToUpper) Then
                    ...
                    If Not oInspection.CAPDatesEntered Then
                        oInspection.CAPDatesEntered = True
                    End If
                ElseIf "SHEAR TEST".Equals(e.Cell.Column.Key.ToUpper) Then
                    UIUtilsGen.FillDateobjectValues(oPipe.DateShearTest, e.Cell.Text)
                    pipeCellUpdated = True
                    pipeDateCellUpdated = True
                    If Date.Compare(oPipe.DateShearTest, dtNullDate) = 0 Then
                        e.Cell.Value = DBNull.Value
                    Else
                        e.Cell.Value = e.Cell.Text
                    End If
                    If Not oInspection.CAPDatesEntered Then
                        oInspection.CAPDatesEntered = True
                    End If
                ElseIf "PIPE SEC INSP".Equals(e.Cell.Column.Key.ToUpper) Then
                    UIUtilsGen.FillDateobjectValues(oPipe.DatePipeSecInsp, e.Cell.Text)
                    pipeCellUpdated = True
                    pipeDateCellUpdated = True
                    If Date.Compare(oPipe.DatePipeSecInsp, dtNullDate) = 0 Then
                        e.Cell.Value = DBNull.Value
                    Else
                        e.Cell.Value = e.Cell.Text
                    End If
                    If Not oInspection.CAPDatesEntered Then
                        oInspection.CAPDatesEntered = True
                    End If
                ElseIf "PIPE ELEC INSP".Equals(e.Cell.Column.Key.ToUpper) Then
                    UIUtilsGen.FillDateobjectValues(oPipe.DatePipeElecInsp, e.Cell.Text)
                    pipeCellUpdated = True
                    pipeDateCellUpdated = True
                    If Date.Compare(oPipe.DatePipeElecInsp, dtNullDate) = 0 Then
                        e.Cell.Value = DBNull.Value
                    Else
                        e.Cell.Value = e.Cell.Text
                    End If
        ...
        Try
            ...
            If pipeCellUpdated Then
                ...
                Else
                    ...
                    End If
                    oPipe.Save(moduleID, MusterContainer.AppUser.UserKey, returnVal, MusterContainer.AppUser.ID, True, False, , oInspection.SubmittedDate <= CDate("1/1/1950"))
                    If Not UIUtilsGen.HasRights(returnVal) Then
                        e.Cancel = True
                        e.Row.Selected = True
                        If bolCapDataSavedThisTime Then
    ...
    Private Sub ugInspector_BeforeRowsDeleted(ByVal sender As Object, ByVal e As Infragistics.Win.UltraWinGrid.BeforeRowsDeletedEventArgs) Handles ugInspector.BeforeRowsDeleted
        ...
        Try
            ...
            Else
                ...
                Dim strMesg As String = "You have selected " + e.Rows.Length.ToString + " row(s) for deletion." + vbCrLf + "Choose Yes to delete the rows or No to exit."
                If MessageBox.Show(strMesg, "Delete Rows", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.No Then
                    e.Cancel = True
                    Exit Sub
                End If
...
#Region "UI Control Events"
    ...
    Private Sub txtdesop_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtDesOp.TextChanged

        If bolLoading Then Exit Sub

        oInspection.CheckListMaster.Owner.Facilities.DesignatedOperator = txtDesOp.Text
    ...
    Private Sub txtAddress_DoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtAddress.DoubleClick
        Try
            ...
            Address.EditAddress(AddressForm, oInspection.CheckListMaster.Owner.Facilities.ID, oInspection.CheckListMaster.Owner.Facilities.FacilityAddresses, "Facility", moduleID, txtAddress, UIUtilsGen.EntityTypes.Facility, True)
        ...
        Try
            ...
            If ValidateCheckList(bolValidateTankPipe, False) Then
                If ValidateLatLong() Then
                    ...
                    ' save Inspection Mirrored data back into main tanks and Pipe tables
                    oInspection.UpdateTanksPipesFromMirrorTable(oInspection.FacilityID)
    ...
    Private Sub formClosed(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        ...
        Try
            If (Not bolReadOnly) And (Not bolPrint) And (Not bolCancel) Then
                If oInspection.CheckListMaster.colIsDirty() Then
                    Dim Results As Long = _container.DirtyIgnored

                    If Results = -1 Then
                        Results = MsgBox("There are unsaved changes.  Do you wish to save the changes?", MsgBoxStyle.Question & MsgBoxStyle.YesNoCancel, "Data Changed")
                    End If
                ...
                Else
                    ...
                    If Me.bolCapDirty Then

                        If (_container.DirtyIgnored = MsgBoxResult.Yes OrElse (_container.DirtyIgnored = -1 AndAlso MsgBox("You have made changes to the CAP fields for this inspection. Do you wish to save this checklist in order to keep the CAP data ?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes)) Then
                            ...
                            If Success Then
                                bolCapDirty = False
                                '  MsgBox("CAP data is now saved and now will no longer be overwritten by blank values.")
                            Else
                                e.Cancel = True
                            End If
                        End If
...
#Region "Contact Management"
    ...
    Private Sub SetFilter()
        ...
        Try
            ...
            If chkOwnerShowContactsforAllModules.Checked Then
                ...
                nEntityID = oInspection.FacilityID
                nModuleID = 0
            Else
                nEntityID = oInspection.FacilityID
                nModuleID = moduleID
            ...
            Else
                strentities = String.Empty
            End If
            UIUtilsGen.LoadContacts(ugContacts, nEntityID, nEntityType, MusterContainer.pConStruct, nModuleID, strentities, bolActive, strEntityAssocIDs, nRelatedEntityType)
    ...
    Private Sub btnOwnerAddSearchContact_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOwnerAddSearchContact.Click
        Try
            objCntSearch = New ContactSearch(oInspection.FacilityID, 6, "Inspection", MusterContainer.pConStruct)
            'objCntSearch.Show()
    ...
    Private Sub LoadContacts(ByRef ugGrid As Infragistics.Win.UltraWinGrid.UltraGrid, ByVal EntityID As Integer, ByVal EntityType As Integer)
        ...
        Try
            ...
            txtDesOp.Text = MusterContainer.pOwn.Facility.DesignatedOperator

            UIUtilsGen.LoadContacts(ugGrid, EntityID, EntityType, MusterContainer.pConStruct, 615)

            If (dv Is Nothing) Then
                dv = New DataView()
            End If

            If Not (Me.ugContacts Is Nothing) Then
                dv = Me.ugContacts.DataSource
            End If

            If Not dv Is Nothing AndAlso dv.Count > 0 Then
                For Each c As DataRow In dv.Table.Select
                    If c.Item("Type").ToString.IndexOf("Designated Operator") > -1 Then
                        dirty = False
                        Exit For
                    End If
                Next
            ...
            If dirty <> Me.bolOwnerIsDesignatedOperator Then
                Me.bolOwnerIsDesignatedOperator = dirty
                Me.regenerateCheckListItems = True
            End If
    ...
    Private Function ModifyContact(ByRef ugGrid As Infragistics.Win.UltraWinGrid.UltraGrid)
        Try
            ...
            If UIUtilsGen.ModifyContact(ugGrid, 615, MusterContainer.pConStruct) Then
    ...
    Private Function AssociateContact(ByRef ugGrid As Infragistics.Win.UltraWinGrid.UltraGrid, ByVal nEntityID As Integer, ByVal nEntityType As Integer)
        Try
            If UIUtilsGen.AssociateContact(ugGrid, nEntityID, nEntityType, 615, MusterContainer.pConStruct) Then
                Me.Contact_ContactAdded()
            End If
    ...
    Private Function DeleteContact(ByRef ugGrid As Infragistics.Win.UltraWinGrid.UltraGrid, ByVal nEntityID As Integer)
        Try
            ...
            UIUtilsGen.DeleteContact(ugGrid, nEntityID, 615, MusterContainer.pConStruct)
            Contact_ContactAdded()
...
#End Region
    ...
    Private Sub BtnFacpics_ChangeUICues(ByVal sender As Object, ByVal e As System.Windows.Forms.UICuesEventArgs) Handles BtnFacpics.ChangeUICues
    ...
    Private Sub pctSketchPad_Click(sender As Object, e As EventArgs) Handles pctSketchPad.Click
    ...
    Private Sub ugCatLeak_BeforeCellActivate(sender As Object, e As Infragistics.Win.UltraWinGrid.CancelableCellEventArgs) Handles ugCatLeak.BeforeCellActivate
        BeforeCellActivate(ugCatLeak, e)
    End Sub

    Private Sub ugCatLeak_BeforeCellDeactivate(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles ugCatLeak.BeforeCellDeactivate
        BeforeCellDeactivate(ugCatLeak)
    End Sub

    Private Sub ugCatLeak_CellChange(sender As Object, e As Infragistics.Win.UltraWinGrid.CellEventArgs) Handles ugCatLeak.CellChange
        Try
    ...
    Private Sub ugCatLeak_DoubleClick(sender As Object, e As EventArgs) Handles ugCatLeak.DoubleClick
        Try
            If Not UIUtilsInfragistics.WinGridRowDblClicked(sender, e) Then
                Me.Cursor = Cursors.Default
                Exit Sub
            ...
            If Not ugCatLeak.ActiveCell Is Nothing Then
                If "CCAT".Equals(ugCatLeak.ActiveCell.Column.Key) AndAlso Not "N/A".Equals(ugCatLeak.ActiveCell.Column.Key) Then
    ...
    Private Sub ugOther_BeforeCellActivate(sender As Object, e As Infragistics.Win.UltraWinGrid.CancelableCellEventArgs) Handles ugOther.BeforeCellActivate
        BeforeCellActivate(ugOther, e)
    End Sub

    Private Sub ugOther_BeforeCellDeactivate(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles ugOther.BeforeCellDeactivate
        BeforeCellDeactivate(ugOther)
    End Sub

    Private Sub ugOther_CellChange(sender As Object, e As Infragistics.Win.UltraWinGrid.CellEventArgs) Handles ugOther.CellChange
        Try
            Dim HasCCAt As Boolean = False
            If e.Cell.Row.Cells.HasCell("NO") AndAlso e.Cell.Row.Cells("NO").Value Then
                HasCCAt = True
    ...
    Private Sub ugOther_DoubleClick(sender As Object, e As EventArgs) Handles ugOther.DoubleClick
        Try
            If Not UIUtilsInfragistics.WinGridRowDblClicked(sender, e) Then
                Me.Cursor = Cursors.Default
                Exit Sub
            End If
            If Not ugOther.ActiveCell Is Nothing Then
                If "CCAT".Equals(ugOther.ActiveCell.Column.Key) AndAlso Not "N/A".Equals(ugOther.ActiveCell.Column.Key) Then
                    If ugOther.ActiveRow.Cells("No").Value = True And ugOther.ActiveRow.Cells("CCAT").Value <> String.Empty Then
                        Dim checkList As MUSTER.Info.InspectionChecklistMasterInfo
                        checkList = oInspection.InspectionInfo.ChecklistMasterCollection.Item(ugOther.ActiveRow.Cells("QUESTION_ID").Value)
                        ' CCAT
                        If checkList.CCAT Then
                            Dim frmCCAT As CCAT
                            frmCCAT = New CCAT(oInspection, ugOther.ActiveRow, bolReadOnly, , , True)
                            frmCCAT.ShowDialog()
                        End If
                    End If
                End If
    ...
    Private Sub ugCP_BeforeCellActivate(sender As Object, e As Infragistics.Win.UltraWinGrid.CancelableCellEventArgs) Handles ugCP.BeforeCellActivate
        BeforeCellActivate(ugCP, e)
    End Sub

    Private Sub ugCP_BeforeCellDeactivate(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles ugCP.BeforeCellDeactivate
        BeforeCellDeactivate(ugCP)
    End Sub

    Private Sub ugCP_BeforeRowsDeleted(sender As Object, e As Infragistics.Win.UltraWinGrid.BeforeRowsDeletedEventArgs) Handles ugCP.BeforeRowsDeleted
        'Dim cp As MUSTER.Info.InspectionCPReadingsInfo
        Dim dr As Infragistics.Win.UltraWinGrid.UltraGridRow
        Dim msgBoxResult As Windows.Forms.DialogResult
        Try
    ...
    Private Sub ugCP_CellChange(sender As Object, e As Infragistics.Win.UltraWinGrid.CellEventArgs) Handles ugCP.CellChange
        Try
            Cursor.Current = Cursors.AppStarting

            Dim HasCCAt As Boolean = False
            If e.Cell.Row.Band.Key.IndexOf("Response") <= -1 AndAlso e.Cell.Row.Cells.HasCell("NO") AndAlso e.Cell.Row.Cells("NO").Value Then
                HasCCAt = True
            End If
            If "Yes".Equals(e.Cell.Column.Key) Then
                ...
                ElseIf e.Cell.Band.Index = 2 Or e.Cell.Band.Index = 6 Or e.Cell.Band.Index = 10 Then
                    If e.Cell.Row.Cells("TESTED_BY_INSPECTOR_RESPONSE").Value = True And e.Cell.Value Then
                        e.Cell.CancelUpdate()
                    Else
                        CellUpdate(1, e.Cell.Row, HasCCAt, e.Cell.Column.Key, ugCP.Name)
            ...
            ElseIf "No".Equals(e.Cell.Column.Key) Then
                ...
                ElseIf e.Cell.Band.Index = 2 Or e.Cell.Band.Index = 6 Or e.Cell.Band.Index = 10 Then
                    If e.Cell.Row.Cells("TESTED_BY_INSPECTOR_RESPONSE").Value = False And e.Cell.Value Then
                        e.Cell.CancelUpdate()
                    Else
                        CellUpdate(0, e.Cell.Row, HasCCAt, e.Cell.Column.Key, ugCP.Name)
                        If e.Cell.Band.Index = 2 Then
                            hasCPTank = False
                        ElseIf e.Cell.Band.Index = 6 Then
                            hasCPPipe = False
            ...
            ElseIf "Incon".Equals(e.Cell.Column.Key) Then
                If e.Cell.Row.Cells("PASSFAILINCON").Value = 2 And e.Cell.Value Then
                    e.Cell.CancelUpdate()
                Else
                    CellUpdate(2, e.Cell.Row, HasCCAt, e.Cell.Column.Key, ugCP.Name)
                End If
    ...
    Private Sub ugCP_DoubleClick(sender As Object, e As EventArgs) Handles ugCP.DoubleClick
        Try
            If Not UIUtilsInfragistics.WinGridRowDblClicked(sender, e) Then
                Me.Cursor = Cursors.Default
                Exit Sub
    ...
    Private Sub ugSOC_CellChange(sender As Object, e As Infragistics.Win.UltraWinGrid.CellEventArgs) Handles ugSOC.CellChange
            ...
            If "Yes".Equals(e.Cell.Column.Key) Then
                ...
                If e.Cell.Row.Index = 0 Then
                    ...
                    Else
                        ...
                        e.Cell.Row.Cells("N/A").Value = False
                    End If
