...
#End Region
    ...
    Private Sub CrystalReportsParamForm_FormClosed(sender As Object, e As FormClosedEventArgs) Handles MyBase.FormClosed
        ReportDisplay.FlagParamDialogClosed = True
    End Sub
    Private Sub CrystalReportsParamForm_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        ReportDisplay.FlagParamDialogClosed = True
    End Sub
End Class
