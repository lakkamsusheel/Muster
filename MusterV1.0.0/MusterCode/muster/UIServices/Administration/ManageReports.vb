...
#Region "UI Support Routines"
    ...
    End Sub
    Sub resetform()     'Updated by SS -it was function
    ...
    Private Sub newReportName()
        ...
        End If
    End Sub
    Private Sub buildReports()  'updated by SS- was function
        'Dim availableGroupItem As Object   'Commented by SS
        'Dim groupWithAcessItem As Object   'Commented by SS
        Dim itemExists As Boolean = False
        'Dim arr As ArrayList    'Commented by SS
        Dim i As Integer = 0
        'Dim dtRow As DataRow   'Commented by SS
    ...
    Private Sub Clear()
        ...
        End Try
    End Sub
    Private Sub LeftRightEnable()   'Changed to Sub by SS
        Try
...
#Region "UI Control Events"
    Private Sub btnSearchReport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearchReport.Click
        ...
        'Dim nReportID As Integer   'SS commentede
