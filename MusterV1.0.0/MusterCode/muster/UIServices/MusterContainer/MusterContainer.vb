...
Imports Microsoft.SqlServer.Management.Smo.Restore
...
#Region "User Defined Variables"
    ...
    Private WithEvents oRestore As Microsoft.SqlServer.Management.Smo.Restore
    Private bJustClosedAll As Boolean = False
    'Private WithEvents oSQLServer As SQLDMO.SQLServer
    Private WithEvents oSQLServer As Microsoft.SqlServer.Management.Smo.Server
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(MusterContainer))
        ...
        Me.pnlRightMost.Padding = New System.Windows.Forms.Padding(0, 0, 16, 0)
        ...
        Me.btnCalDueToMeModify.Size = New System.Drawing.Size(75, 23)
        ...
        Me.btnDueToMeDelete.Size = New System.Drawing.Size(75, 23)
        ...
        Me.btnCalToDoModify.Size = New System.Drawing.Size(75, 23)
        ...
        Me.btnToDoDelete.Size = New System.Drawing.Size(75, 23)
        ...
        Me.lnkLblNextForm.Size = New System.Drawing.Size(27, 14)
        ...
        Me.lnklblPrevForm.Size = New System.Drawing.Size(27, 14)
        ...
        Me.lblFacilityAddress.Size = New System.Drawing.Size(0, 14)
        ...
        Me.lblOwnerAddress.Size = New System.Drawing.Size(0, 14)
        ...
        Me.lblOwner.Size = New System.Drawing.Size(55, 16)
        ...
        Me.lblOwnerName.Size = New System.Drawing.Size(0, 16)
        ...
        Me.lblFacility.Size = New System.Drawing.Size(62, 16)
        ...
        Me.LinkLabel6.Size = New System.Drawing.Size(0, 14)
        ...
        Me.lblFacilityName.Size = New System.Drawing.Size(0, 14)
        ...
        Me.btnCloseForm.Size = New System.Drawing.Size(75, 23)
        ...
        Me.grpBxQuickSearch.PerformLayout()
        Me.pnlCommonReferenceArea.ResumeLayout(False)
        Me.pnlCommonReferenceArea.PerformLayout()
            ...
            If System.IO.Directory.Exists(DOC_PATH) Then
                ...
                If arrDirectories.Count > 0 Then
                    ...
                    While enDirectory.MoveNext
                        ...
                        If strUserAndModule.Contains("\") Then
...
#Region "Help"
    ...
    Private Sub DoRestore()
        ...
        Try
            ...
            Dim conn As New ServerConnection(System.Net.Dns.GetHostName, "sa", "password")
            oSQLServer = New Server(conn)
            'oSQLServer = New Microsoft.SqlServer.Management.Smo.Server
            oRestore = New Microsoft.SqlServer.Management.Smo.Restore



            oSQLServer.ConnectionContext.Connect()
            ...
            With oRestore
                ...
                .RelocateFiles.Add(String.Format("[Muster_Prd_Data],[{0}],[Muster_Prd_Log],[{1}] ", DbFile, LogFile))
                .DatabaseFiles.Add(String.Format("[{0}]", aRestoreParameters(0)))
                .Database = "Muster_Prd"
                .ReplaceDatabase = True
                .PercentCompleteNotification = 10

                AddHandler .PercentComplete, AddressOf ProgressEventHandler
                AddHandler .Complete, AddressOf CompleteEventHandler

                .SqlRestoreAsync(oSQLServer)
            ...
            oRestore = Nothing
            oSQLServer.ConnectionContext.Disconnect()
    ...
    Private Sub PerformRestoreAfterUnZip(ByVal strFileName As String)
        ...
        'strSQLPath = "C:\Program Files (x86)\Microsoft SQL Server\MSSQL"
        strSQLPath = "C:\Program Files\Microsoft SQL Server\MSSQL11.SQLSERVER2012\MSSQL"
        ...
        ' change registry entry to point to local db KCLARK-GA\SQLSERVER2012
        'Dim strConnStr As String = "Data Source=" + System.Net.Dns.GetHostName + ";Initial Catalog=master;user='sa';password='password';"
        Dim strConnStr As String = "Data Source=KCLARK-GA\SQLSERVER2012;Initial Catalog=master;user='sa';password='password';"
        strConnStr = strConnStr.Substring(0, strConnStr.Length)
        LocalUserSettings.CurrentUser.SetValue("MusterSQLConnection", strConnStr)
        ...
        Catch ex As Exception
            ...
            Try
                ...
                ElseIf ex.Message.ToUpper.Contains("The RPC server is unavailable.".ToUpper) Then
                    WordApp = New Word.Application
                ElseIf ex.Message.ToUpper.Contains("The object invoked has disconnected from its clients.".ToUpper) Then
                    WordApp = New Word.Application
                Else
                    Try
...
#End Region
    ...
    Private Sub ProgressEventHandler(sender As Object, e As PercentCompleteEventArgs)

        RaiseEvent FireProgressMessage(String.Format("Restoring Database at {0} percent", e), 100, String.Empty)
    End Sub

    Private Sub CompleteEventHandler(sender As Object, e As ServerMessageEventArgs)
        RaiseEvent FireProgressMessage("Synchronization Data Restore Successfully Executed. Finishing Up Details", 100, String.Empty)
    End Sub
