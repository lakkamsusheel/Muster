...
#Region " Windows Form Designer generated code "
    ...
    Public Sub New(ByRef frmCaller As MusterContainer)
        ...
        Catch ex As Exception
            'MessageBox.Show("Exception On LOGON :  " + ex.Message())
        End Try
    End Sub
    ...
    "then click OK"
        ...
        'txtDBPwd
        '
        Me.txtDBPwd.Location = New System.Drawing.Point(106, 120)
        Me.txtDBPwd.Name = "txtDBPwd"
        Me.txtDBPwd.PasswordChar = Global.Microsoft.VisualBasic.ChrW(42)
        Me.txtDBPwd.Size = New System.Drawing.Size(120, 20)
        Me.txtDBPwd.TabIndex = 7
        Me.txtDBPwd.Text = "password"
        '
        'lblDBPwd
        '
        Me.lblDBPwd.Location = New System.Drawing.Point(1, 120)
        Me.lblDBPwd.Name = "lblDBPwd"
        Me.lblDBPwd.Size = New System.Drawing.Size(80, 16)
        Me.lblDBPwd.TabIndex = 0
        Me.lblDBPwd.Text = "DB Password"
        '
        'txtDBLogin
        '
        Me.txtDBLogin.Location = New System.Drawing.Point(106, 99)
        Me.txtDBLogin.Name = "txtDBLogin"
        Me.txtDBLogin.Size = New System.Drawing.Size(120, 20)
        Me.txtDBLogin.TabIndex = 6
        Me.txtDBLogin.Text = "sa"
        '
        'cboServers
        '
        Me.cboServers.Items.AddRange(New Object() {"OPCGW", "muster.deq.state.ms.us", "muster-prod", "GARD-ALL", "GARD-PROD", "KCLARK-GA\SQLSERVER2012", "MUSTER-DEV"})
        ...
        'lblDBLogin
        '
        Me.lblDBLogin.Location = New System.Drawing.Point(1, 99)
        Me.lblDBLogin.Name = "lblDBLogin"
        Me.lblDBLogin.Size = New System.Drawing.Size(80, 16)
        ...
        Me.txtLogonPwd.PasswordChar = Global.Microsoft.VisualBasic.ChrW(42)
...
#End Region
    ...
    Private Sub btnLogon_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnLogon.Click
        ...
        Try
            ...
            End If
            If cboServers.Text = "muster-prod" Then  'DBLogin = MusterApp
                WorkConnStr += "user='sa';password='newGrade12';"
                Me.txtDBLogin.Text = "Muster_deq"
            ElseIf cboServers.Text = "GARD-PROD" Then  'DBLogin = MusterApp
                WorkConnStr += "user='MusterApp';password='8f1-4c9A';"
                Me.txtDBLogin.Text = "MusterApp"
            ElseIf cboServers.Text.ToLower() = "gard-all" Then  'DBLogin = MusterApp
                WorkConnStr += "user='sa';password='Sqlserver2012';"
                Me.txtDBLogin.Text = "muster_prod_1"
            Else
                ...
                Else
                    ...
                    Else
                        If cboServers.Text = "MUSTER-DEV" Then
                            WorkConnStr += "user='" + txtDBLogin.Text + "';password='password';"
                        ElseIf cboServers.Text = "KCLARK-GA\SQLSERVER2012" Then
                            WorkConnStr += "user='" + txtDBLogin.Text + "';password='password';"
            ...
            Try
                ...
                'SqlConn.ConnectionString = "Initial Catalog=Sus_muster_temp2;Data Source=KCLARK-GA\SQLSERVER2012;Integrated Security=true;"
                'SqlConn.ConnectionString = "Initial Catalog=Sus_muster_temp;Data Source=MUSTER-DEV\SQL2008R2;Integrated Security=true;"
                SqlConn.Open()
                SqlConn.Close()
            Catch ex As Exception
...
#End If
        ...
        ElseIf MyFrm.Inspector Then
            txtInitialCatalog.Text = "MUSTER_DEQ"
            cboServers.Text = System.Net.Dns.GetHostName

        Else
            Me.grpUserSpecs.Enabled = False

            'txtInitialCatalog.Text = "MUSTER_DEQ"      'By SS
            txtInitialCatalog.Text = "MUSTER_PRD"
            If flag = "0" Then
                'cboServers.Text = "muster-prod"        'By SS
