...
Namespace MUSTER.DataAccess
    Public Class CalendarDB
        Private _strConn As String  'Updated by SS 
...
#Region "Exposed Operations"
        Public Function GetAllInfo(ByVal strUser As String, Optional ByVal showDeleted As Boolean = False) As Muster.Info.CalendarCollection
            ...
            drSet = Nothing 'Updated by SS - addedthis line
        ...
        Public Function DBGetByID(ByVal nVal As Int64) As Muster.Info.CalendarInfo
            ...
            Dim Params As Collection
            Dim drSet As SqlDataReader
            drSet = Nothing     'updated by SS - added
        ...
        Public Function DBGetDS(ByVal strSQL As String) As DataSet
            ...
            End Try
        End Function
        Public Function Put(ByRef obj As MUSTER.Info.CalendarInfo, ByVal moduleID As Integer, ByVal staffID As Integer, ByRef returnVal As String) As String
            Try
                Put = String.Empty
                If Not moduleID = 0 Then
                    If Not (SqlHelper.HasWriteAccess(moduleID, staffID, CType(SqlHelper.EntityTypes.Calendar, Integer))) Then
                        Put = "You do not have rights to save Calendar."
                        Exit Function
                    End If
                End If
