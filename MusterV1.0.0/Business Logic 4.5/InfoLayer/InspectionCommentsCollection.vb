'-------------------------------------------------------------------------------
' MUSTER.Info.InspectionCommentsCollection
...
Namespace MUSTER.Info
    Public Class InspectionCommentsCollection
        Inherits DictionaryBase
        '#Region "Public Events"
        '        Public Event evtInspectionCommentsColChanged(ByVal bolValue As Boolean)
        '#End Region
        ...
        Default Public Property Item(ByVal index As String) As MUSTER.Info.InspectionCommentsInfo
            ...
            Set(ByVal Value As MUSTER.Info.InspectionCommentsInfo)
                If Not MyBase.Dictionary.Contains(Integer.Parse(index)) Then
                    ...
                    'RaiseEvent evtInspectionCommentsColChanged(True)
                Else
