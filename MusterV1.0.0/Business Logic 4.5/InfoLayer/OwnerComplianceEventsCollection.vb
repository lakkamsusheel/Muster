'-------------------------------------------------------------------------------
' MUSTER.Info. OwnerComplianceEventsCollection
...
Namespace MUSTER.Info
    Public Class  OwnerComplianceEventsCollection
        Inherits DictionaryBase
#Region "Public Events"
        Public Event  OwnerComplianceEventColChanged(ByVal bolValue As Boolean)
#End Region
#Region "Exposed Operations"
        Default Public Property Item(ByVal index As String) As MUSTER.Info. OwnerComplianceEventInfo
            Get
                Return CType(MyBase.Dictionary.Item(index), MUSTER.Info. OwnerComplianceEventInfo)
            End Get
            Set(ByVal Value As MUSTER.Info. OwnerComplianceEventInfo)
                If Not MyBase.Dictionary.Contains(Integer.Parse(index)) Then
                    ...
                    RaiseEvent  OwnerComplianceEventColChanged(True)
                Else
        ...
        Public ReadOnly Property GetKeys() As String()
            ...
            End Get
        End Property
        Public Sub Add(ByVal value As MUSTER.Info. OwnerComplianceEventInfo)
            Me.Item(value.ID.ToString) = value
        End Sub
        Public Function Contains(ByVal value As MUSTER.Info. OwnerComplianceEventInfo) As Boolean
            Return MyBase.Dictionary.Contains(value.ID.ToString)
        End Function
        Public Function Contains(ByVal Key As String) As Boolean
            Return MyBase.Dictionary.Contains(Key)
        End Function
        Public Sub Remove(ByVal value As MUSTER.Info. OwnerComplianceEventInfo)
...
#Region "Overloaded Operators"
        Protected Overloads Sub OnInsert(ByVal Key As Object, ByVal value As Object)
            If Not value.GetType() Is (GetType(MUSTER.Info. OwnerComplianceEventInfo)) Then
                Throw New ArgumentException("Only  OwnerComplianceEvents may be inserted into a  OwnerComplianceEvent collection!", "value")
            End If
        End Sub

        Protected Overloads Sub OnRemove(ByVal Key As Object, ByVal value As Object)
            If Not value.GetType() Is (GetType(MUSTER.Info. OwnerComplianceEventInfo)) Then
                Throw New ArgumentException("Only  OwnerComplianceEvents may be removed from a  OwnerComplianceEvent collection!", "value")
            End If
        End Sub

        Protected Overloads Sub OnSet(ByVal Key As Object, ByVal oldvalue As Object, ByVal newvalue As Object)
            If Not newvalue.GetType() Is (GetType(MUSTER.Info. OwnerComplianceEventInfo)) Then
                Throw New ArgumentException("Only  OwnerComplianceEvents updated in a  OwnerComplianceEvent collection!", "value")
            End If
        End Sub

        Protected Overloads Sub OnValidate(ByVal Key As Object, ByVal value As Object)
            If Not value.GetType() Is (GetType(MUSTER.Info. OwnerComplianceEventInfo)) Then
                Throw New ArgumentException("Only  OwnerComplianceEvents may be validated in a  OwnerComplianceEvent collection!", "value")
            End If
        End Sub
#End Region
    End Class
