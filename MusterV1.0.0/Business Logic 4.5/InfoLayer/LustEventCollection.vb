'-------------------------------------------------------------------------------
' MUSTER.Info.LustEventCollection
'   Provides a stongly-typed collection for storing LustEvent objects
'
...
Namespace MUSTER.Info
    Public Class LustEventCollection
        Inherits DictionaryBase
        ' Raised whenever a member is inserted into or removed from the LustEvent collection
        Public Event LustEventColChanged As LustEventColChangedEventHandler
        Public Delegate Sub LustEventColChangedEventHandler()
        Public Sub Add(ByVal value As MUSTER.Info.LustEventInfo)
        ...
        End Sub
        Public Function Contains(ByVal value As MUSTER.Info.LustEventInfo) As Boolean
        ...
        Public ReadOnly Property GetKeys() As String()
            ...
            End Get
        End Property
        Default Public Property Item(ByVal index As String) As MUSTER.Info.LustEventInfo
            Get
                ' #Region "XDEOperation" ' Begin Template Expansion{71588C6A-EF74-4200-98A5-6FBD1587D3FA}
                Return CType(MyBase.Dictionary.Item(index), MUSTER.Info.LustEventInfo)
                ' #End Region ' XDEOperation End Template Expansion{71588C6A-EF74-4200-98A5-6FBD1587D3FA}
            End Get
            Set(ByVal Value As MUSTER.Info.LustEventInfo)
            ...
            End Set
        End Property
        Public Sub Remove(ByVal value As MUSTER.Info.LustEventInfo)
