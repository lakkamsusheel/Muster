...
' New()             Instantiates an empty TemplateInfo object
' New(Deleted, CreatedBy, CreatedOn, ModifiedBy, LastEdited, OwnerL2CSnippet)
'                   Instantiates a populated TemplateInfo object
' New(dr)           Instantiates a populated TemplateInfo object taking member state
...
#Region "Public Events"
        Public Event TemplateInfoChanged(ByVal bolValue As Boolean)
#End Region
...
#Region "Exposed Operations"
        Public Sub Reset()
            ...
            bolIsDirty = False
            RaiseEvent TemplateInfoChanged(bolIsDirty)
        End Sub
        Public Sub Archive()
            onID = nID
            '********************************************************
