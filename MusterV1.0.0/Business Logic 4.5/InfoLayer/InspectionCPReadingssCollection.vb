'-------------------------------------------------------------------------------
' MUSTER.Info.InspectionCPReadingssCollection
...
Namespace MUSTER.Info
    Public Class InspectionCPReadingssCollection
        Inherits DictionaryBase
#Region "Public Events"
        Public Event InspectionCPReadingsColChanged(ByVal bolValue As Boolean)
#End Region
        ...
        Default Public Property Item(ByVal index As String) As MUSTER.Info.InspectionCPReadingsInfo
            ...
            Set(ByVal Value As MUSTER.Info.InspectionCPReadingsInfo)
                If Not MyBase.Dictionary.Contains(Integer.Parse(index)) Then
                    ...
                    RaiseEvent InspectionCPReadingsColChanged(True)
                Else
