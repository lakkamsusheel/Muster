'-------------------------------------------------------------------------------
' MUSTER.Info.InspectionMonitorWellsCollection
...
Namespace MUSTER.Info
    Public Class InspectionMonitorWellsCollection
        Inherits DictionaryBase
        '#Region "Public Events"
        '        Public Event evtInspectionMonitorWellsColChanged(ByVal bolValue As Boolean)
        '#End Region
#Region "Exposed Operations"
        Default Public Property Item(ByVal index As String) As MUSTER.Info.InspectionMonitorWellsInfo
            Get
                Return CType(MyBase.Dictionary.Item(index), MUSTER.Info.InspectionMonitorWellsInfo)
            End Get
            Set(ByVal Value As MUSTER.Info.InspectionMonitorWellsInfo)
                If Not MyBase.Dictionary.Contains(Integer.Parse(index)) Then
                    MyBase.Dictionary.Add(Value.ID.ToString, Value)
                    'RaiseEvent evtInspectionMonitorWellsColChanged(True)
                Else
        ...
        Public ReadOnly Property GetKeys() As String()
            ...
            End Get
        End Property
        Public Sub Add(ByVal value As MUSTER.Info.InspectionMonitorWellsInfo)
            Me.Item(value.ID.ToString) = value
        End Sub
        Public Function Contains(ByVal value As MUSTER.Info.InspectionMonitorWellsInfo) As Boolean
            Return MyBase.Dictionary.Contains(value.ID.ToString)
        End Function
        Public Function Contains(ByVal Key As String) As Boolean
            Return MyBase.Dictionary.Contains(Key)
        End Function
        Public Sub Remove(ByVal value As MUSTER.Info.InspectionMonitorWellsInfo)
...
#Region "Overloaded Operators"
        Protected Overloads Sub OnInsert(ByVal Key As Object, ByVal value As Object)
            If Not value.GetType() Is (GetType(MUSTER.Info.InspectionMonitorWellsInfo)) Then
                Throw New ArgumentException("Only InspectionMonitorWellss may be inserted into a InspectionMonitorWells collection!", "value")
            End If
        End Sub

        Protected Overloads Sub OnRemove(ByVal Key As Object, ByVal value As Object)
            If Not value.GetType() Is (GetType(MUSTER.Info.InspectionMonitorWellsInfo)) Then
                Throw New ArgumentException("Only InspectionMonitorWellss may be removed from a InspectionMonitorWells collection!", "value")
            End If
        End Sub

        Protected Overloads Sub OnSet(ByVal Key As Object, ByVal oldvalue As Object, ByVal newvalue As Object)
            If Not newvalue.GetType() Is (GetType(MUSTER.Info.InspectionMonitorWellsInfo)) Then
                Throw New ArgumentException("Only InspectionMonitorWellss updated in a InspectionMonitorWells collection!", "value")
            End If
        End Sub

        Protected Overloads Sub OnValidate(ByVal Key As Object, ByVal value As Object)
            If Not value.GetType() Is (GetType(MUSTER.Info.InspectionMonitorWellsInfo)) Then
                Throw New ArgumentException("Only InspectionMonitorWellss may be validated in a InspectionMonitorWells collection!", "value")
            End If
        End Sub
#End Region
    End Class
