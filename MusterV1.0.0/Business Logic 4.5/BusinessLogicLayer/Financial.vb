...
#Region " Populate Routines "
        ...
        Public Function PopulateRolloverForNewPO() As DataSet
            ...
            End Try
        End Function
        Public Function PopulateCommitmentTecDocList(ByVal EventID As Int64, ByVal CommitmentID As Int64, ByVal ACtivityID As Integer, ByVal mode As String) As DataSet
            Dim dsRemSys As New DataSet
            Dim dtReturn As DataTable
            Dim strSQL As String
            ...
            Try
                ...
                strSQL = String.Format("exec spGetFinAvailableCommitmentDocs {0}, {1}, {2}, '{3}'", ACtivityID, CommitmentID, EventID, mode)

                'strSQL = " Select (Select DocName from tblTEC_Document where Document_ID = Document_Property_ID) as Report, Event_Activity_Document_ID, Due_Date, Extension_Date, Received_Date, Date_Sent_To_Finance, Commitment_ID, Date_Closed, Paid "
                ...
                ' strSQL = String.Format(" exec spGetFinTechReports {0}, {1}, {2} ,'{3}' ", EventID, CommitmentID, IIf(ForInvoice, 1, 0), Mode)
                'strSQL &= " from dbo.tblTEC_EVENT_ACTIVITY_DOCUMENT  "
                'strSQL &= " where Deleted = 0 and Document_Property_ID in (Select Document_ID from vFinancialInvoicedDocuments)  "
