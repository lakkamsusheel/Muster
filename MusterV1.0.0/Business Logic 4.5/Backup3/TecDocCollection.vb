...
Namespace MUSTER.Info
    Public Class TecDocCollection
        Inherits DictionaryBase
        Public Delegate Sub TecDocumentColChangedEventHandler()
        ' Raised whenever a member is inserted into or removed from the TecDoc collection
        Public Event TecDocumentColChanged As TecDocumentColChangedEventHandler
        Public Sub Add(ByVal value As MUSTER.Info.TecDocInfo)
        ...
        Public Sub ChangeKey(ByVal OldKey As String, ByVal NewKey As String)
            ...
            End If
        End Sub
        Public Function Contains(ByVal value As MUSTER.Info.TecDocInfo) As Boolean
        ...
        Public ReadOnly Property GetKeys() As String()
            ...
            End Get
        End Property
        Default Public Property Item(ByVal index As String) As MUSTER.Info.TecDocInfo
            Get
                Return CType(MyBase.Dictionary.Item(index), MUSTER.Info.TecDocInfo)
            End Get
            Set(ByVal Value As MUSTER.Info.TecDocInfo)
                ...
                Else
                    ...
                    RaiseEvent TecDocumentColChanged()
                End If
            End Set
        End Property
        Public Sub Remove(ByVal value As MUSTER.Info.TecDocInfo)
