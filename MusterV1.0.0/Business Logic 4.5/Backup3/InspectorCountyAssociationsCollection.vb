'-------------------------------------------------------------------------------
' MUSTER.Info.InspectorCountyAssociationsCollection
...
Namespace MUSTER.Info
    Public Class InspectorCountyAssociationsCollection
        Inherits DictionaryBase
#Region "Public Events"
        Public Event InspectorCountyAssociationColChanged(ByVal bolValue As Boolean)
#End Region
#Region "Exposed Operations"
        Default Public Property Item(ByVal index As String) As MUSTER.Info.InspectorCountyAssociationInfo
            Get
                Return CType(MyBase.Dictionary.Item(index), MUSTER.Info.InspectorCountyAssociationInfo)
            End Get
            Set(ByVal Value As MUSTER.Info.InspectorCountyAssociationInfo)
                If Not MyBase.Dictionary.Contains(Integer.Parse(index)) Then
                    ...
                    RaiseEvent InspectorCountyAssociationColChanged(True)
                Else
        ...
        Public ReadOnly Property GetKeys() As String()
            ...
            End Get
        End Property
        Public Sub Add(ByVal value As MUSTER.Info.InspectorCountyAssociationInfo)
            Me.Item(value.ID.ToString) = value
        End Sub
        Public Function Contains(ByVal value As MUSTER.Info.InspectorCountyAssociationInfo) As Boolean
            Return MyBase.Dictionary.Contains(value.ID.ToString)
        End Function
        Public Function Contains(ByVal Key As String) As Boolean
            Return MyBase.Dictionary.Contains(Key)
        End Function
        Public Sub Remove(ByVal value As MUSTER.Info.InspectorCountyAssociationInfo)
...
#Region "Overloaded Operators"
        Protected Overloads Sub OnInsert(ByVal Key As Object, ByVal value As Object)
            If Not value.GetType() Is (GetType(MUSTER.Info.InspectorCountyAssociationInfo)) Then
                Throw New ArgumentException("Only InspectorCountyAssociations may be inserted into a InspectorCountyAssociation collection!", "value")
            End If
        End Sub

        Protected Overloads Sub OnRemove(ByVal Key As Object, ByVal value As Object)
            If Not value.GetType() Is (GetType(MUSTER.Info.InspectorCountyAssociationInfo)) Then
                Throw New ArgumentException("Only InspectorCountyAssociations may be removed from a InspectorCountyAssociation collection!", "value")
            End If
        End Sub

        Protected Overloads Sub OnSet(ByVal Key As Object, ByVal oldvalue As Object, ByVal newvalue As Object)
            If Not newvalue.GetType() Is (GetType(MUSTER.Info.InspectorCountyAssociationInfo)) Then
                Throw New ArgumentException("Only InspectorCountyAssociations updated in a InspectorCountyAssociation collection!", "value")
            End If
        End Sub

        Protected Overloads Sub OnValidate(ByVal Key As Object, ByVal value As Object)
            If Not value.GetType() Is (GetType(MUSTER.Info.InspectorCountyAssociationInfo)) Then
                Throw New ArgumentException("Only InspectorCountyAssociations may be validated in a InspectorCountyAssociation collection!", "value")
            End If
        End Sub
#End Region
    End Class
