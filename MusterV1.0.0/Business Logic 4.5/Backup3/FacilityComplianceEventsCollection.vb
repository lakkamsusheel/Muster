'-------------------------------------------------------------------------------
' MUSTER.Info.FacilityComplianceEventsCollection
...
Namespace MUSTER.Info
    Public Class FacilityComplianceEventsCollection
        Inherits DictionaryBase
#Region "Public Events"
        Public Event FCEColChanged(ByVal bolValue As Boolean)
#End Region
#Region "Exposed Operations"
        Default Public Property Item(ByVal index As String) As MUSTER.Info.FacilityComplianceEventInfo
            Get
                Return CType(MyBase.Dictionary.Item(index), MUSTER.Info.FacilityComplianceEventInfo)
            End Get
            Set(ByVal Value As MUSTER.Info.FacilityComplianceEventInfo)
                If Not MyBase.Dictionary.Contains(Integer.Parse(index)) Then
                    MyBase.Dictionary.Add(Value.ID.ToString, Value)
                    RaiseEvent FCEColChanged(True)
                Else
        ...
        Public ReadOnly Property GetKeys() As String()
            ...
            End Get
        End Property
        Public Sub Add(ByVal value As MUSTER.Info.FacilityComplianceEventInfo)
            Me.Item(value.ID.ToString) = value
        End Sub
        Public Function Contains(ByVal value As MUSTER.Info.FacilityComplianceEventInfo) As Boolean
            Return MyBase.Dictionary.Contains(value.ID.ToString)
        End Function
        Public Function Contains(ByVal Key As String) As Boolean
            Return MyBase.Dictionary.Contains(Key)
        End Function
        Public Sub Remove(ByVal value As MUSTER.Info.FacilityComplianceEventInfo)
...
#Region "Overloaded Operators"
        Protected Overloads Sub OnInsert(ByVal Key As Object, ByVal value As Object)
            If Not value.GetType() Is (GetType(MUSTER.Info.FacilityComplianceEventInfo)) Then
                Throw New ArgumentException("Only FacilityComplianceEvents may be inserted into a FacilityComplianceEvent collection!", "value")
            End If
        End Sub

        Protected Overloads Sub OnRemove(ByVal Key As Object, ByVal value As Object)
            If Not value.GetType() Is (GetType(MUSTER.Info.FacilityComplianceEventInfo)) Then
                Throw New ArgumentException("Only FacilityComplianceEvents may be removed from a FacilityComplianceEvent collection!", "value")
            End If
        End Sub

        Protected Overloads Sub OnSet(ByVal Key As Object, ByVal oldvalue As Object, ByVal newvalue As Object)
            If Not newvalue.GetType() Is (GetType(MUSTER.Info.FacilityComplianceEventInfo)) Then
                Throw New ArgumentException("Only FacilityComplianceEvents updated in a FacilityComplianceEvent collection!", "value")
            End If
        End Sub

        Protected Overloads Sub OnValidate(ByVal Key As Object, ByVal value As Object)
            If Not value.GetType() Is (GetType(MUSTER.Info.FacilityComplianceEventInfo)) Then
                Throw New ArgumentException("Only FacilityComplianceEvents may be validated in a FacilityComplianceEvent collection!", "value")
            End If
        End Sub
#End Region
    End Class
